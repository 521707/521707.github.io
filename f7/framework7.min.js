...
! function(e, t) {
	...
	var Template7Context = t7ctx,
		Template7Utils = {
				...
				for(t = 0; t < r.length; t += 1) {
					...
					if("" !== i)
						if(i.indexOf("{{") < 0) n.push({
							...
							} else 0 < i.indexOf(" ") && (l && (s = "_partial", p[0] && (0 === p[0].indexOf("[") ? p[0] = p[0].replace(/[[\]]/g, "") : p[0] = '"' + p[0].replace(/"|'/g, "") + '"')), n.push({
								type: "helper",
								helperName: s,
								contextName: p,
								hash: c
			...
			parseJsVariable: function(e, a, n) {
				return e.split(/([+ \-*/^])/g).map(function(e) {
					...
					return 0 <= e.indexOf(a + ".") && e.split(a + ".")[1].split(".").forEach(function(e) {
						t = e in t ? t[e] : void 0
					}), "string" == typeof t && (t = JSON.stringify(t)), void 0 === t && (t = "undefined"), t
				}).join("")
			},
			...
			getCompileVar: function(e, t, a) {
				...
				var n, r, i = t,
					o = 0;
				0 === e.indexOf("../") ? (o = e.split("../").length - 1, i = "ctx_" + (1 <= (r = i.split("_")[1] - o) ? r : 1), n = e.split("../")[o].split(".")) : 0 === e.indexOf("@global") ? (i = "Template7.global", n = e.split("@global.")[1].split(".")) : 0 === e.indexOf("@root") ? (i = "root", n = e.split("@root.")[1].split(".")) : n = e.split(".");
	...
	function val(e) {
		...
		if(t[0]) {
			if(t[0].multiple && "select" === t[0].nodeName.toLowerCase()) {
				for(var i = [], o = 0; o < t[0].selectedOptions.length; o += 1) i.push(t[0].selectedOptions[o].value);
				return i
			}
			return t[0].value
		}
	...
	function on() {
		...
		function s(e) {
			...
			if(t) {
				...
				if(a.indexOf(e) < 0 && a.unshift(e), $$1(t).is(i)) o.apply(t, a);
				else
					for(var n = $$1(t).parents(), r = 0; r < n.length; r += 1) $$1(n[r]).is(i) && o.apply(n[r], a)
			}
		}
	...
	function prepend(e) {
		...
		for(t = 0; t < this.length; t += 1)
			if("string" == typeof e) {
				...
				for(r.innerHTML = e, a = r.childNodes.length - 1; 0 <= a; a -= 1) n[t].insertBefore(r.childNodes[a], n[t].childNodes[0])
			} else if(e instanceof Dom7)
			for(a = 0; a < e.length; a += 1) n[t].insertBefore(e[a], n[t].childNodes[0]);
	...
	function insertBefore(e) {
		for(var t = $$1(e), a = 0; a < this.length; a += 1)
	...
	function next(e) {
		return 0 < this.length ? e ? this[0].nextElementSibling && $$1(this[0].nextElementSibling).is(e) ? new Dom7([this[0].nextElementSibling]) : new Dom7([]) : this[0].nextElementSibling ? new Dom7([this[0].nextElementSibling]) : new Dom7([]) : new Dom7([])
	}
	...
	function prev(e) {
		if(0 < this.length) {
			var t = this[0];
			return e ? t.previousElementSibling && $$1(t.previousElementSibling).is(e) ? new Dom7([t.previousElementSibling]) : new Dom7([]) : t.previousElementSibling ? new Dom7([t.previousElementSibling]) : new Dom7([])
		}
		return new Dom7([])
	}
	...
	function parent(e) {
		for(var t = [], a = 0; a < this.length; a += 1) null !== this[a].parentNode && (e ? $$1(this[a].parentNode).is(e) && t.push(this[a].parentNode) : t.push(this[a].parentNode));
		return $$1(unique(t))
	}

	function parents(e) {
		for(var t = [], a = 0; a < this.length; a += 1)
			for(var n = this[a].parentNode; n;) e ? $$1(n).is(e) && t.push(n) : t.push(n), n = n.parentNode;
		return $$1(unique(t))
	}
	...
	function children(e) {
		for(var t = [], a = 0; a < this.length; a += 1)
			for(var n = this[a].childNodes, r = 0; r < n.length; r += 1) e ? 1 === n[r].nodeType && $$1(n[r]).is(e) && t.push(n[r]) : 1 === n[r].nodeType && t.push(n[r]);
	...
	function animate(e, t) {
		var a, n = this,
			g = {
				...
				stop: function() {
					g.frameId && cancelAnimationFrame(g.frameId), g.animating = !1, g.elements.each(function(e, t) {
						delete t.dom7AnimateInstance
					}), g.que = []
				},
				done: function(e) {
					if(g.animating = !1, g.elements.each(function(e, t) {
							delete t.dom7AnimateInstance
						}), e && e(n), 0 < g.que.length) {
						var t = g.que.shift();
						g.animate(t[0], t[1])
					}
				},
				animate: function(p, c) {
					...
					g.elements.each(function(t, a) {
						var n, r, i, o, s;
						a.dom7AnimateInstance || (g.elements[t].dom7AnimateInstance = g), d[t] = {
							container: a
						}, Object.keys(p).forEach(function(e) {
							n = win.getComputedStyle(a, null).getPropertyValue(e).replace(",", "."), r = parseFloat(n), i = n.replace(r, ""), o = parseFloat(p[e]), s = p[e] + i, d[t][e] = {
								initialFullValue: n,
								initialValue: r,
								unit: i,
								finalValue: o,
	...
	function eventShortcut(e) {
		for(var t, a = [], n = arguments.length - 1; 0 < n--;) a[n] = arguments[n + 1];
		if(void 0 === a[0]) {
			for(var r = 0; r < this.length; r += 1) noTrigger.indexOf(e) < 0 && (e in this[r] ? this[r][e]() : $$1(this[r]).trigger(e));
			return this
		}
	...
	function binarySubdivide(e, t, a, n, r) {
		for(var i, o, s = 0; 0 < (i = calcBezier(o = t + (a - t) / 2, n, r) - e) ? a = o : t = o, Math.abs(i) > SUBDIVISION_PRECISION && ++s < SUBDIVISION_MAX_ITERATIONS;);
		return o
	}
	...
	var createPromise = function(e) {
			var a, n, r = !1,
				...
				t = {
					then: function(e) {
						return r ? e.apply(void 0, a) : o.then = e, t
					},
					catch: function(e) {
						return i ? e.apply(void 0, n) : o.catch = e, t
					}
				};
			return e(function() {
				for(var e = [], t = arguments.length; t--;) e[t] = arguments[t];
		...
		Utils = {
			...
			eventNameToColonCase: function(e) {
				...
				return e.split("").map(function(e, t) {
					return e.match(/[A-Z]/) && 0 !== t && !a ? (a = !0, ":" + e.toLowerCase()) : e.toLowerCase()
				}).join("")
			},
			...
			getTranslate: function(e, t) {
				...
				return win.WebKitCSSMatrix ? (6 < (n = i.transform || i.webkitTransform).split(",").length && (n = n.split(", ").map(function(e) {
					return e.replace(",", ".")
				}).join(", ")), r = new win.WebKitCSSMatrix("none" === n ? "" : n)) : a = (r = i.MozTransform || i.OTransform || i.MsTransform || i.msTransform || i.transform || i.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","), "x" === t && (n = win.WebKitCSSMatrix ? r.m41 : 16 === a.length ? parseFloat(a[12]) : parseFloat(a[4])), "y" === t && (n = win.WebKitCSSMatrix ? r.m42 : 16 === a.length ? parseFloat(a[13]) : parseFloat(a[5])), n || 0
			},
			serializeObject: function(n, r) {
				...
				function s(e) {
					if(0 < r.length) {
						for(var t = "", a = 0; a < r.length; a += 1) t += 0 === a ? r[a] : "[" + encodeURIComponent(r[a]) + "]";
			...
			extend: function() {
				for(var e = [], t = arguments.length; t--;) e[t] = arguments[t];
				var a, n, r = !0;
				"boolean" == typeof e[0] ? (r = e[0], a = e[1], e.splice(0, 2)) : (a = e[0], e.splice(0, 1)), n = e;
		...
		Device = function() {
			var e = win.navigator.platform,
				...
				l = s && 375 === win.screen.width && 812 === win.screen.height,
				p = 0 <= t.indexOf("MSIE ") || 0 <= t.indexOf("Trident/"),
				c = 0 <= t.indexOf("Edge/"),
				d = 0 <= t.indexOf("Gecko/") && 0 <= t.indexOf("Firefox/"),
				u = "MacIntel" === e,
				h = "Win32" === e;
			if(a.ie = p, a.edge = c, a.firefox = d, n && (a.os = "windows", a.osVersion = h[2], a.windowsPhone = !0), r && !h && (a.os = "android", a.osVersion = r[2], a.android = !0, a.androidChrome = 0 <= t.toLowerCase().indexOf("chrome")), (i || s || o) && (a.os = "ios", a.ios = !0), s && !o && (a.osVersion = s[2].replace(/_/g, "."), a.iphone = !0, a.iphoneX = l), i && (a.osVersion = i[2].replace(/_/g, "."), a.ipad = !0), o && (a.osVersion = o[3] ? o[3].replace(/_/g, ".") : null, a.iphone = !0), a.ios && a.osVersion && 0 <= t.indexOf("Version/") && "10" === a.osVersion.split(".")[0] && (a.osVersion = t.toLowerCase().split("version/")[1].split(" ")[0]), a.webView = (s || i || o) && (t.match(/.*AppleWebKit(?!.*Safari)/i) || win.navigator.standalone), a.webview = a.webView, a.desktop = !(a.os || a.android || a.webView), a.desktop && (a.macos = u, a.windows = h), a.os && "ios" === a.os) {
				var f = a.osVersion.split("."),
					m = doc.querySelector('meta[name="viewport"]');
				a.minimalUi = !a.webView && (o || s) && (1 * f[0] == 7 ? 1 <= 1 * f[1] : 7 < 1 * f[0]) && m && 0 <= m.getAttribute("content").indexOf("minimal-ui")
			}
	...
	Framework7Class.prototype.on = function(e, t, a) {
		...
		return r.eventsListeners && e.split(" ").forEach(function(a) {
			void 0 === n ? r.eventsListeners[a] = [] : r.eventsListeners[a].forEach(function(e, t) {
		...
		"string" == typeof e[0] || Array.isArray(e[0]) ? (a = e[0], n = e.slice(1, e.length), i = (r = o).eventsParents) : (a = e[0].events, n = e[0].data, r = e[0].context || o, i = e[0].local ? [] : e[0].parents || o.eventsParents);
		...
		r.modules && Object.keys(r.modules).forEach(function(e) {
			...
			n.instance && Object.keys(n.instance).forEach(function(e) {
				...
				r.on(e, n.on[e])
			}), n.vnode && (r.vnodeHooks || (r.vnodeHooks = {}), Object.keys(n.vnode).forEach(function(a) {
				Object.keys(n.vnode[a]).forEach(function(e) {
					var t = n.vnode[a][e];
					r.vnodeHooks[e] || (r.vnodeHooks[e] = {}), r.vnodeHooks[e][a] || (r.vnodeHooks[e][a] = []), r.vnodeHooks[e][a].push(t.bind(r))
				})
	...
	var Framework7 = function(i) {
			function e(e) {
				...
				return Utils.extend(a, {
					...
					passedParams: t
				}), a.root && a.root[0] && (a.root[0].f7 = a), a.useModules(), a.params.init && (Device.cordova && a.params.initOnDeviceReady ? $$1(doc).on("deviceready", function() {
					a.init()
				}) : a.init()), a
			}
			i && (e.__proto__ = i);
			...
			return((e.prototype = Object.create(i && i.prototype)).constructor = e).prototype.init = function() {
				...
				return i
			}, Object.defineProperties(e.prototype, t), Object.defineProperties(e, a), e
		}(Framework7Class),
		DeviceModule = {
			name: "device",
			proto: {
		...
		Support = (kp = !1, lp = doc.createElement("div"), "sticky -webkit-sticky -moz-sticky".split(" ").forEach(function(e) {
			kp || (lp.style.position = e, lp.style.position === e && (kp = !0))
		}), hp = kp, ip = doc.createElement("div"), {
			positionSticky: hp,
			touch: !!("ontouchstart" in win || win.DocumentTouch && doc instanceof win.DocumentTouch),
			pointerEvents: !(!win.navigator.pointerEnabled && !win.PointerEvent),
			prefixedPointerEvents: !!win.navigator.msPointerEnabled,
			transition: (pp = ip.style, "transition" in pp || "webkitTransition" in pp || "MozTransition" in pp),
			transforms3d: win.Modernizr && !0 === win.Modernizr.csstransforms3d || (rp = ip.style, "webkitPerspective" in rp || "MozPerspective" in rp || "OPerspective" in rp || "MsPerspective" in rp || "perspective" in rp),
			flexbox: function() {
		...
		kp, lp, rp, pp, hp, ip, SupportModule = {
			name: "support",
			proto: {
				support: Support
			},
			...
			on: {
				init: function() {
					...
					if(t) {
						var e = [];
						Support.positionSticky && e.push("support-position-sticky"), e.forEach(function(e) {
							t.classList.add(e)
						})
					}
				}
	...
	function Request(e) {
		...
		function n(e) {
			...
			return globals[e] && (t = globals[e].apply(globals, n)), i[e] && (a = i[e].apply(i, n)), "boolean" != typeof t && (t = !0), "boolean" != typeof a && (a = !0), t && a
		}
		if(!1 !== n("beforeCreate", i)) {
			...
			if("json" === i.dataType && 0 <= i.url.indexOf("callback=")) {
				...
				}, doc.querySelector("head").appendChild(h), void(0 < i.timeout && (l = setTimeout(function() {
					h.parentNode.removeChild(h), n("error", h = null, "timeout")
				}, i.timeout)))
			}
			...
			return i.headers && Object.keys(i.headers).forEach(function(e) {
			...
			}), void 0 === i.crossDomain && (i.crossDomain = /^([\w-]+:)?\/\/([^\/]+)/.test(i.url) && RegExp.$2 !== win.location.host), i.crossDomain || f.setRequestHeader("X-Requested-With", "XMLHttpRequest"), i.xhrFields && Utils.extend(f, i.xhrFields), f.onload = function() {
				var e;
				...
				m && clearTimeout(m), n("error", f, f.status), n("complete", f, "error")
			}, 0 < i.timeout && (f.onabort = function() {
				m && clearTimeout(m)
			}, m = setTimeout(function() {
				f.abort(), n("error", f, "timeout"), n("complete", f, "timeout")
			}, i.timeout)), !1 === n("beforeSend", f, i) ? f : (f.send(v), f)
		}
	}
	...
	function initTouch() {
		var s, l, p, c, d, u, h, f, m, v, g, b, y, w, $, n, t, a, o = this,
			C = o.params.touch,
			x = "md" === o.theme && C.materialRipple;

		function E(e) {
			var t, a = $$1(e),
				n = a.parents(C.activeStateElements);
			return a.is(C.activeStateElements) && (t = a), 0 < n.length && (t = t ? t.add(n) : n), t || a
		}

		function k(e) {
			var t = e.parents(".page-content, .panel");
			return 0 !== t.length && ("yes" !== t.prop("scrollHandlerSet") && (t.on("scroll", function() {
				clearTimeout(y), clearTimeout(a)
		...
		function S() {
			b && (b.removeClass("active-state"), b = null)
		}
		...
		function e() {
			n && (n.remove(), t = n = void 0)
		}

		function M(e) {
			(t = function(e) {
				var t = C.materialRippleElements,
					a = $$1(e);
				...
				return !1
			}(e)) && 0 !== t.length ? k(t) ? a = setTimeout(function() {
				r(t, s, l)
			}, 80) : r(t, s, l) : t = void 0
		}
		...
		function P() {
			n ? e() : t && !m ? (clearTimeout(a), r(t, s, l), setTimeout(e, 0)) : e()
		}
		...
		doc.addEventListener("click", function(e) {
			O("click", e)
		}, !0), Support.passiveListener ? (doc.addEventListener(o.touchEvents.start, D, H), doc.addEventListener(o.touchEvents.move, I, H), doc.addEventListener(o.touchEvents.end, L, H), doc.addEventListener(o.touchEvents.start, A, R), doc.addEventListener(o.touchEvents.move, z, R), doc.addEventListener(o.touchEvents.end, B, R)) : (doc.addEventListener(o.touchEvents.start, function(e) {
			D(e), A(e)
		}, !1), doc.addEventListener(o.touchEvents.move, function(e) {
			I(e), z(e)
		}, !1), doc.addEventListener(o.touchEvents.end, function(e) {
			L(e), B(e)
		}, !1)), Support.touch ? (o.on("click", function(e) {
			var t, a, n, r, i = !1;
			return d ? (c = null, !(d = !1)) : "submit" === e.target.type && 0 === e.detail || "file" === e.target.type || (c || (t = e.target, a = "input select textarea label".split(" "), t.nodeName && 0 <= a.indexOf(t.nodeName.toLowerCase()) || (i = !0)), w || (i = !0), doc.activeElement === c && (i = !0), e.forwardedTouchEvent && (i = !0), e.cancelable || (i = !0), C.tapHold && C.tapHoldPreventClicks && v && (i = !1), i || (e.stopImmediatePropagation(), e.stopPropagation(), c ? (n = $$1(c), r = !0, (n.is("label") || 0 < n.parents("label").length) && (r = !Device.android && !(!Device.ios || !n.is("input"))), (r || m) && e.preventDefault()) : e.preventDefault(), c = null), $ = setTimeout(function() {
				w = !1
			}, Device.ios || Device.androidChrome ? 100 : 400), C.tapHold && (g = setTimeout(function() {
				v = !1
			}, Device.ios || Device.androidChrome ? 100 : 400)), i)
		}), o.on("touchstart", function(e) {
			var t, a, n, r, i = this;
			if(v = m = !1, 1 < e.targetTouches.length) return b && S(), !0;
			if(1 < e.touches.length && b && S(), C.tapHold && (g && clearTimeout(g), g = setTimeout(function() {
					e && e.touches && 1 < e.touches.length || (v = !0, e.preventDefault(), $$1(e.target).trigger("taphold"))
				}, C.tapHoldDelay)), $ && clearTimeout($), t = e.target, a = $$1(t), !(w = !("input" === t.nodeName.toLowerCase() && ("file" === t.type || "range" === t.type) || "select" === t.nodeName.toLowerCase() && Device.android || a.hasClass("no-fastclick") || 0 < a.parents(".no-fastclick").length || C.fastClicksExclude && a.is(C.fastClicksExclude)))) return !(d = !1);
			...
			if(doc.activeElement === e.target) return C.activeState && S(), x && P(), !0;
			if(u || e.preventDefault(), i - f < C.fastClicksDelayBetweenClicks) return setTimeout(S, 0), !0;
			if(f = i, d = !1, Device.ios && h && h.scrollTop !== h.f7ScrollTop) return !1;
			if(C.activeState && (T(), setTimeout(S, 0)), x && P(), function(e) {
			...
			return doc.activeElement && c !== doc.activeElement && doc.activeElement !== doc.body && "label" !== c.nodeName.toLowerCase() && doc.activeElement.blur(), e.preventDefault(), C.tapHoldPreventClicks && v || (a = (t = e).changedTouches[0], n = doc.createEvent("MouseEvents"), r = "click", Device.android && "select" === c.nodeName.toLowerCase() && (r = "mousedown"), n.initMouseEvent(r, !0, !0, win, 1, a.screenX, a.screenY, a.clientX, a.clientY, !1, !1, !1, !1, 0, null), n.forwardedTouchEvent = !0, o.device.ios && win.navigator.standalone ? setTimeout(function() {
			...
			d = !1, c = null, clearTimeout(y), clearTimeout(g), C.activeState && S(), x && P()
		}, {
			passive: !0
		})) : C.activeState && (o.on("touchstart", function(e) {
			E(e.target).addClass("active-state"), "which" in e && 3 === e.which && setTimeout(function() {
				$$1(".active-state").removeClass("active-state")
			}, 0), x && (s = e.pageX, l = e.pageY, M(e.target, e.pageX, e.pageY))
		}), o.on("touchmove", function() {
			$$1(".active-state").removeClass("active-state"), x && i()
		}), o.on("touchend", function() {
			$$1(".active-state").removeClass("active-state"), x && P()
		})), doc.addEventListener("contextmenu", function(e) {
			C.disableContextMenu && (Device.ios || Device.android || Device.cordova) && e.preventDefault(), x && (b && S(), P())
		})
	}
	var TouchModule = {
			name: "touch",
		...
		for(var a, n = [], r = 0, i = 0, o = "", s = t && t.delimiter || DEFAULT_DELIMITER, l = t && t.delimiters || DEFAULT_DELIMITERS, p = !1; null !== (a = PATH_REGEXP.exec(e));) {
			...
			if(o += e.slice(i, u), i = u + c.length, d) o += d[1], p = !0;
				...
				var h = "",
					...
					b = a[5];
				if(!p && o.length) {
					var y = o.length - 1; - 1 < l.indexOf(o[y]) && (h = o[y], o = o.slice(0, y))
				}
				o && (n.push(o), o = "", p = !1);
	...
	function tokensToRegExp(e, t, a) {
		for(var n = (a = a || {}).strict, r = !1 !== a.end, i = escapeString(a.delimiter || DEFAULT_DELIMITER), o = a.delimiters || DEFAULT_DELIMITERS, s = [].concat(a.endsWith || []).map(escapeString).concat("$").join("|"), l = "", p = 0 === e.length, c = 0; c < e.length; c++) {
			var d = e[c];
			if("string" == typeof d) l += escapeString(d), p = c === e.length - 1 && -1 < o.indexOf(d[d.length - 1]);
			else {
	...
	var History = {
			...
			if(!History.blockPopstate) {
				...
				History.previousState = History.state, History.state = i, History.allowChange = !0, History.clearQueue(), (i = History.state) || (i = {}), this.views.forEach(function(e) {
					...
					if(!a && e.params.pushState && (a = {
						...
						var n = a.url || void 0,
							r = t.params.animate;
						!1 === t.params.pushStateAnimate && (r = !1), n !== t.url && (0 <= t.history.indexOf(n) ? t.allowPageChange ? t.back({
							animate: r,
							pushState: !1
		...
		init: function(e) {
			...
			}), doc.readyState && "complete" === doc.readyState && (History.blockPopstate = !1), $$1(win).on("popstate", History.handle.bind(e))
		}
	};

	function SwipeBack(e) {
		var d, u, h, a, f, m, v, g, b, y, w, $, C, x, t, E = e,
			k = E.$el,
			T = E.$navbarEl,
			S = E.app,
			M = E.params,
			...
			A = [],
			z = [],
			B = M[S.theme + "SwipeBackAnimateShadow"],
			R = M[S.theme + "SwipeBackAnimateOpacity"],
			H = M[S.theme + "SwipeBackActiveArea"],
			U = M[S.theme + "SwipeBackThreshold"];

		function r(e) {
			var t = M[S.theme + "SwipeBack"];
			!n || !t || P || S.swipeout && S.swipeout.el || !E.allowPageChange || 0 < $$1(e.target).closest(".range-slider, .calendar-months").length || (P = !(O = !1), d = void 0, D.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, D.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, a = Utils.now(), y = E.dynamicNavbar, w = E.separateNavbar)
		}
		...
		function i(e) {
			if(P) {
				...
				if(void 0 === d && (d = !!(d || Math.abs(a - D.y) > Math.abs(t - D.x)) || t < D.x), d || e.f7PreventSwipeBack || S.preventSwipeBack) P = !1;
				else {
					if(!O) {
						var n = !1,
							r = $$1(e.target),
							i = r.closest(".swipeout");
						0 < i.length && (!S.rtl && 0 < i.find(".swipeout-actions-left").length && (n = !0), S.rtl && 0 < i.find(".swipeout-actions-right").length && (n = !0)), ((I = r.closest(".page")).hasClass("no-swipeback") || 0 < r.closest(".no-swipeback").length) && (n = !0), L = k.find(".page-previous:not(.stacked)");
						D.x, k.offset().left;
						if(u = k.width(), (S.rtl ? D.x < k.offset().left - k[0].scrollLeft + (u - H) : D.x - k.offset().left > H) && (n = !0), 0 !== L.length && 0 !== I.length || (n = !0), n) return void(P = !1);
						B && 0 === ($ = I.find(".page-shadow-effect")).length && ($ = $$1('<div class="page-shadow-effect"></div>'), I.append($)), R && 0 === (C = L.find(".page-opacity-effect")).length && (C = $$1('<div class="page-opacity-effect"></div>'), L.append(C)), y && (w ? (A = T.find(".navbar-current:not(.stacked)"), z = T.find(".navbar-previous:not(.stacked)")) : (A = I.children(".navbar").children(".navbar-inner"), z = L.children(".navbar").children(".navbar-inner")), x = T[0].offsetWidth, f = A.children(".left, .title, .right, .subnavbar, .fading"), m = z.children(".left, .title, .right, .subnavbar, .fading"), M.iosAnimateNavbarBackIcon && (A.hasClass("sliding") ? (v = A.children(".left").find(".back .icon"), g = A.children(".left").find(".back span").eq(0)) : (v = A.children(".left.sliding").find(".back .icon"), g = A.children(".left.sliding").find(".back span").eq(0)), b = z.hasClass("sliding") ? z.children(".left").find(".back .icon") : z.children(".left.sliding").find(".back .icon"))), 0 < $$1(".sheet.modal-in").length && S.sheet && S.sheet.close($$1(".sheet.modal-in"))
					}
					e.f7PreventPanelSwipe = !0, O = !0, S.preventSwipePanelBySwipeBack = !0, e.preventDefault();
					var o = S.rtl ? -1 : 1;
					(h = (t - D.x - U) * o) < 0 && (h = 0);
					var s = h / u,
						l = {
							...
							previousPageEl: L[0],
							currentNavbarEl: A[0],
							previousNavbarEl: z[0]
						};
					k.trigger("swipeback:move", l), E.emit("swipebackMove", l);
					var p = h * o,
						c = (h / 5 - u / 5) * o;
					1 === Device.pixelRatio && (p = Math.round(p), c = Math.round(c)), I.transform("translate3d(" + p + "px,0,0)"), B && ($[0].style.opacity = 1 - 1 * s), "md" !== S.theme && L.transform("translate3d(" + c + "px,0,0)"), R && (C[0].style.opacity = 1 - 1 * s), y && (f.each(function(e, t) {
						var a = $$1(t);
						if(a.is(".subnavbar") || (a[0].style.opacity = 1 - Math.pow(s, .33)), 0 <= a[0].className.indexOf("sliding") || A.hasClass("sliding")) {
							var n = s * a[0].f7NavbarRightOffset;
							if(1 === Device.pixelRatio && (n = Math.round(n)), a.transform("translate3d(" + n + "px,0,0)"), M.iosAnimateNavbarBackIcon && 0 <= a[0].className.indexOf("left") && 0 < v.length) {
								var r = -n;
								w || (r -= x * s), v.transform("translate3d(" + r + "px,0,0)")
							}
						}
					}), m.each(function(e, t) {
						var a = $$1(t);
						if(a.is(".subnavbar") || (a[0].style.opacity = Math.pow(s, 3)), 0 <= a[0].className.indexOf("sliding") || z.hasClass("sliding")) {
							var n = a[0].f7NavbarLeftOffset * (1 - s);
							if(n = 0 <= a[0].className.indexOf("title") && v && v.length && g.length ? (a[0].f7NavbarLeftOffset + g[0].offsetLeft) * (1 - s) : a[0].f7NavbarLeftOffset * (1 - s), 1 === Device.pixelRatio && (n = Math.round(n)), a.transform("translate3d(" + n + "px,0,0)"), M.iosAnimateNavbarBackIcon && 0 <= a[0].className.indexOf("left") && 0 < b.length) {
								var r = -n;
								w || (r += x / 5 * (1 - s)), b.transform("translate3d(" + r + "px,0,0)")
							}
						}
					}))
				}
		...
		function o() {
			if(S.preventSwipePanelBySwipeBack = !1, P && O) {
				if(O = P = !1, 0 === h) return $$1([I[0], L[0]]).transform(""), $ && 0 < $.length && $.remove(), C && 0 < C.length && C.remove(), void(y && (f.transform("").css({
					opacity: ""
				}), m.transform("").css({
					opacity: ""
				}), v && 0 < v.length && v.transform(""), b && 0 < v.length && b.transform("")));
				var e = Utils.now() - a,
					i = !1;
				(e < 300 && 10 < h || 300 <= e && u / 2 < h) && (I.removeClass("page-current").addClass("page-next" + ("md" === S.theme ? " page-next-on-right" : "")), L.removeClass("page-previous").addClass("page-current").removeAttr("aria-hidden"), $ && ($[0].style.opacity = ""), C && (C[0].style.opacity = ""), y && (A.removeClass("navbar-current").addClass("navbar-next"), z.removeClass("navbar-previous").addClass("navbar-current").removeAttr("aria-hidden")), i = !0), $$1([I[0], L[0]]).addClass("page-transitioning page-transitioning-swipeback").transform(""), y && (f.css({
					opacity: ""
				}).each(function(e, t) {
					var a = i ? t.f7NavbarRightOffset : 0,
						n = $$1(t),
						r = i ? -a : 0;
					!w && i && (r -= x), n.transform("translate3d(" + a + "px,0,0)"), M.iosAnimateNavbarBackIcon && n.hasClass("left") && 0 < v.length && v.addClass("navbar-transitioning").transform("translate3d(" + r + "px,0,0)")
				}).addClass("navbar-transitioning"), m.transform("").css({
					opacity: ""
				}).each(function(e, t) {
					var a = i ? 0 : t.f7NavbarLeftOffset,
						n = $$1(t),
						r = i ? 0 : -a;
					w || i || (r += x / 5), n.transform("translate3d(" + a + "px,0,0)"), M.iosAnimateNavbarBackIcon && n.hasClass("left") && 0 < b.length && b.addClass("navbar-transitioning").transform("translate3d(" + r + "px,0,0)")
				}).addClass("navbar-transitioning")), n = !1, E.allowPageChange = !1;
				var t = {
					currentPage: I[0],
					previousPage: L[0],
					currentNavbar: A[0],
				...
				i ? (E.currentRoute = L[0].f7Page.route, E.currentPage = L[0], E.pageCallback("beforeOut", I, A, "current", "next", {
					route: I[0].f7Page.route,
					swipeBack: !0
				}), E.pageCallback("beforeIn", L, z, "previous", "current", {
					route: L[0].f7Page.route,
					swipeBack: !0
				}), k.trigger("swipeback:beforechange", t), E.emit("swipebackBeforeChange", t)) : (k.trigger("swipeback:beforereset", t), E.emit("swipebackBeforeReset", t)), I.transitionEnd(function() {
					$$1([I[0], L[0]]).removeClass("page-transitioning page-transitioning-swipeback"), y && (f.removeClass("navbar-transitioning").css({
						opacity: ""
					}).transform(""), m.removeClass("navbar-transitioning").css({
						opacity: ""
					}).transform(""), v && 0 < v.length && v.removeClass("navbar-transitioning"), b && 0 < b.length && b.removeClass("navbar-transitioning")), n = !0, E.allowPageChange = !0, i ? (1 === E.history.length && E.history.unshift(E.url), E.history.pop(), E.saveHistory(), M.pushState && History.back(), E.pageCallback("afterOut", I, A, "current", "next", {
						route: I[0].f7Page.route,
						swipeBack: !0
					}), E.pageCallback("afterIn", L, z, "previous", "current", {
						route: L[0].f7Page.route,
						swipeBack: !0
					}), M.stackPages && 0 <= E.initialPages.indexOf(I[0]) ? (I.addClass("stacked"), w && A.addClass("stacked")) : (E.pageCallback("beforeRemove", I, A, "next", {
						swipeBack: !0
					}), E.removePage(I), w && E.removeNavbar(A)), k.trigger("swipeback:afterchange", t), E.emit("swipebackAfterChange", t), E.emit("routeChanged", E.currentRoute, E.previousRoute, E), M.preloadPreviousPage && E.back(E.history[E.history.length - 2], {
						preload: !0
					})) : (k.trigger("swipeback:afterreset", t), E.emit("swipebackAfterReset", t)), $ && 0 < $.length && $.remove(), C && 0 < C.length && C.remove()
				})
			} else O = P = !1
		}
		t = !("touchstart" !== S.touchEvents.start || !Support.passiveListener) && {
			passive: !0,
			capture: !1
		}, k.on(S.touchEvents.start, r, t), S.on("touchmove:active", i), S.on("touchend:passive", o), E.on("routerDestroy", function() {
			var e = !("touchstart" !== S.touchEvents.start || !Support.passiveListener) && {
				passive: !0,
				capture: !1
			};
			k.off(S.touchEvents.start, r, e), S.off("touchmove:active", i), S.off("touchend:passive", o)
		})
	}
	...
	function redirect(a, e, n) {
		var r = this,
			t = e.route.redirect;
		if(n.initial && r.params.pushState && (n.replaceState = !0, n.history = !0), "function" == typeof t) {
			r.allowPageChange = !1;
			var i = t.call(r, e, function(e, t) {
				void 0 === t && (t = {}), r.allowPageChange = !0, r[a](e, Utils.extend({}, n, t))
			}, function() {
				r.allowPageChange = !0
			});
	...
	function processRouteQueue(e, t, a, n) {
		...
		function i() {
			e && e.route && (r.params.routesBeforeEnter || e.route.beforeEnter) ? (r.allowPageChange = !1, processQueue(r, r.params.routesBeforeEnter, e.route.beforeEnter, e, t, function() {
				r.allowPageChange = !0, a()
			}, function() {
				n()
			})) : a()
		}
		t && t.route && (r.params.routesBeforeLeave || t.route.beforeLeave) ? (r.allowPageChange = !1, processQueue(r, r.params.routesBeforeLeave, t.route.beforeLeave, e, t, function() {
			r.allowPageChange = !0, i()
		}, function() {
			n()
		})) : i()
	}
	...
	function forward(e, t) {
		...
		if(h.length && o.removeThemeElements(h), c && (r = h.children(".navbar").children(".navbar-inner"), d && (a = o.$navbarEl, 0 < r.length && h.children(".navbar").remove(), 0 === r.length && h[0].f7Page && (r = h[0].f7Page.$navbarEl))), o.allowPageChange = !1, 0 === h.length) return o.allowPageChange = !0, o;
		var m, v = u.children(".page:not(.stacked)").filter(function(e, t) {
			return t !== h[0]
		});
		if(d && (m = a.children(".navbar-inner:not(.stacked)").filter(function(e, t) {
				return t !== r[0]
			})), p.reloadPrevious && v.length < 2) return o.allowPageChange = !0, o;
		var g = "next";
		if(p.reloadCurrent || p.reloadAll ? g = "current" : p.reloadPrevious && (g = "previous"), h.addClass("page-" + g).removeClass("stacked"), c && r.length && r.addClass("navbar-" + g).removeClass("stacked"), p.reloadCurrent) n = v.eq(v.length - 1), d && (i = $$1(s.navbar.getElByPage(n)));
		else if(p.reloadPrevious) n = v.eq(v.length - 2), d && (i = $$1(s.navbar.getElByPage(n)));
		else if(p.reloadAll) n = v.filter(function(e, t) {
			return t !== h[0]
			...
			if(1 < v.length) {
				...
				for(b = 0; b < v.length - 1; b += 1) {
					var y = s.navbar.getElByPage(v.eq(b));
					o.params.stackPages ? (v.eq(b).addClass("stacked"), d && $$1(y).addClass("stacked")) : (o.pageCallback("beforeRemove", v[b], m && m[b], "previous", void 0, p), o.removePage(v[b]), d && y && o.removeNavbar(y))
				}
			}
			n = u.children(".page:not(.stacked)").filter(function(e, t) {
				return t !== h[0]
			}), d && (i = a.children(".navbar-inner:not(.stacked)").filter(function(e, t) {
				return t !== r[0]
			}))
		}
		if(c && !d && (i = n.children(".navbar").children(".navbar-inner")), o.params.pushState && (p.pushState || p.replaceState) && !p.reloadPrevious) {
			var w = o.params.pushStateRoot || "";
			History[p.reloadCurrent || p.reloadAll || p.replaceState ? "replace" : "push"](l.id, {
				url: p.route.url
		...
		var $ = p.route.url;
		p.history && (0 < (p.reloadCurrent && o.history.length) || p.replaceState ? o.history[o.history.length - (p.reloadPrevious ? 2 : 1)] = $ : p.reloadPrevious ? o.history[o.history.length - 2] = $ : p.reloadAll ? o.history = [$] : o.history.push($)), o.saveHistory();
		var C = 0 < h.parents(doc).length,
			x = h[0].f7Component;
		if(p.reloadPrevious ? (x && !C ? x.$mount(function(e) {
				$$1(e).insertBefore(n)
			}) : h.insertBefore(n), d && r.length && (i.length ? r.insertBefore(i) : (o.$navbarEl.parents(doc).length || o.$el.prepend(o.$navbarEl), a.append(r)))) : (n.next(".page")[0] !== h[0] && (x && !C ? x.$mount(function(e) {
				u.append(e)
			}) : u.append(h[0])), d && r.length && (o.$navbarEl.parents(doc).length || o.$el.prepend(o.$navbarEl), a.append(r[0]))), C || o.pageCallback("mounted", h, r, g, f ? g : "current", p, n), p.reloadCurrent && 0 < n.length ? o.params.stackPages && 0 <= o.initialPages.indexOf(n[0]) ? (n.addClass("stacked"), d && i.addClass("stacked")) : (o.pageCallback("beforeRemove", n, i, "previous", void 0, p), o.removePage(n), d && i && i.length && o.removeNavbar(i)) : p.reloadAll ? n.each(function(e, t) {
				var a = $$1(t),
					n = $$1(s.navbar.getElByPage(a));
				o.params.stackPages && 0 <= o.initialPages.indexOf(a[0]) ? (a.addClass("stacked"), d && n.addClass("stacked")) : (o.pageCallback("beforeRemove", a, i && i.eq(e), "previous", void 0, p), o.removePage(a), d && n.length && o.removeNavbar(n))
			}) : p.reloadPrevious && (o.params.stackPages && 0 <= o.initialPages.indexOf(n[0]) ? (n.addClass("stacked"), d && i.addClass("stacked")) : (o.pageCallback("beforeRemove", n, i, "previous", void 0, p), o.removePage(n), d && i && i.length && o.removeNavbar(i))), p.route.route.tab && o.tabLoad(p.route.route.tab, Utils.extend({}, p, {
				history: !1,
				pushState: !1
			})), o.pageCallback("init", h, r, g, f ? g : "current", p, n), p.reloadCurrent || p.reloadAll) return o.allowPageChange = !0, o.pageCallback("beforeIn", h, r, g, "current", p), o.pageCallback("afterIn", h, r, g, "current", p), p.reloadCurrent && p.clearPreviousHistory && o.clearPreviousHistory(), o;
		...
		function E() {
			...
			h.removeClass(e).addClass("page-current").removeAttr("aria-hidden"), n.removeClass(e).addClass("page-previous").attr("aria-hidden", "true"), c && (r.removeClass(t).addClass("navbar-current").removeAttr("aria-hidden"), i.removeClass(t).addClass("navbar-previous").attr("aria-hidden", "true")), o.allowPageChange = !0, o.pageCallback("afterIn", h, r, "next", "current", p), o.pageCallback("afterOut", n, i, "current", "previous", p);
			var a = "ios" === s.theme ? o.params.preloadPreviousPage || o.params.iosSwipeBack : o.params.preloadPreviousPage;
			a || (h.hasClass("smart-select-page") || h.hasClass("photo-browser-page") || h.hasClass("autocomplete-page")) && (a = !0), a || (o.params.stackPages ? (n.addClass("stacked"), d && i.addClass("stacked")) : h.attr("data-name") && "smart-select-page" === h.attr("data-name") || (o.pageCallback("beforeRemove", n, i, "previous", void 0, p), o.removePage(n), d && i.length && o.removeNavbar(i))), p.clearPreviousHistory && o.clearPreviousHistory(), o.emit("routeChanged", o.currentRoute, o.previousRoute, o), o.params.pushState && History.clearRouterQueue()
		}

		function k() {
			var e = "page-previous page-current page-next",
				t = "navbar-previous navbar-current navbar-next";
			n.removeClass(e).addClass("page-current").removeAttr("aria-hidden"), h.removeClass(e).addClass("page-next").removeAttr("aria-hidden"), c && (i.removeClass(t).addClass("navbar-current").removeAttr("aria-hidden"), r.removeClass(t).addClass("navbar-next").removeAttr("aria-hidden"))
		}
		if(o.pageCallback("beforeIn", h, r, "next", "current", p), o.pageCallback("beforeOut", n, i, "current", "previous", p), p.animate) {
			var T = "md" === o.app.theme ? o.params.materialPageLoadDelay : o.params.iosPageLoadDelay;
			T ? setTimeout(function() {
				k(), o.animate(n, h, i, r, "forward", function() {
					E()
				})
			}, T) : (k(), o.animate(n, h, i, r, "forward", function() {
				E()
			}))
		} else E();
		return o
	...
	function load(e, t, a) {
		...
		if(!i.route && o && (i.route = n.parseRouteUrl(o), Utils.extend(i.route, {
			...
			})), (o || d || h) && (n.allowPageChange = !1), s) n.forward(n.getPageEl(s), i);
		else if(c || d) try {
	...
	function navigate(e, t) {
		...
		var r = i.app;
		if(!i.view) return r.views.main && r.views.main.router.navigate(a, t), i;
		if("#" === a || "" === a) return i;
		var o, s = a.replace("./", "");
		if("/" !== s[0] && 0 !== s.indexOf("#")) {
			var l = i.currentRoute.parentPath || i.currentRoute.path;
			s = ((l ? l + "/" : "/") + s).replace("///", "/").replace("//", "/")
		}
		if(!(o = n ? Utils.extend(i.parseRouteUrl(s), {
				route: Utils.extend({}, n)
			}) : i.findMatchingRoute(s))) return i;
		if(o.route.redirect) return redirect.call(i, "navigate", o, t);
		var p = {};
		return o.route.options ? Utils.extend(p, o.route.options, t, {
			route: o
		}) : Utils.extend(p, t, {
			route: o
		}), p && p.context && (o.context = p.context, p.route.context = p.context), processRouteQueue.call(i, o, i.currentRoute, function() {
			var a;
			a = !1, "popup popover sheet loginScreen actions customModal".split(" ").forEach(function(e) {
				o.route[e] && !a && (a = !0, i.modalLoad(e, o, p))
			}), "url content component pageName el componentUrl template templateUrl".split(" ").forEach(function(e) {
				var t;
				o.route[e] && !a && (a = !0, i.load(((t = {})[e] = o.route[e], t), p))
			}), a || o.route.async && (i.allowPageChange = !1, o.route.async.call(i, o, i.currentRoute, function(a, n) {
				var r = i.allowPageChange = !1;
				n && n.context && (o.context ? o.context = Utils.extend({}, o.context, n.context) : o.context = n.context, p.route.context = o.context), "popup popover sheet loginScreen actions customModal".split(" ").forEach(function(e) {
					if(a[e]) {
						r = !0;
						var t = Utils.extend({}, o, {
							route: a
						});
						i.allowPageChange = !0, i.modalLoad(e, t, Utils.extend(p, n))
					}
				}), r || i.load(a, Utils.extend(p, n), !0)
			}, function() {
				i.allowPageChange = !0
			}))
		}, function() {
	...
	function tabLoad(d, e) {
		...
		n.route && (n.preload || n.route === u.currentRoute || (a = u.previousRoute, u.currentRoute = n.route), n.preload ? (t = n.route, a = u.currentRoute) : (t = u.currentRoute, a || (a = u.previousRoute)), u.params.pushState && n.pushState && !n.reloadPrevious && History.replace(u.view.id, {
			url: n.route.url
		}, (u.params.pushStateRoot || "") + u.params.pushStateSeparator + n.route.url), n.history && (u.history[Math.max(u.history.length - 1, 0)] = n.route.url, u.saveHistory()));
		var r, i = $$1(n.parentPageEl || u.currentPageEl);
		...
		if(!u.params.unloadTabContent && h[0].f7RouterTabLoaded) return f && f.length && (m ? v(function() {
			u.emit("routeChanged", u.currentRoute, u.previousRoute, u)
		}) : u.emit("routeChanged", u.currentRoute, u.previousRoute, u)), u;
		...
		function l(e, t) {
			...
			function p(e) {
				u.allowPageChange = !0, e && ("string" == typeof e ? h.html(e) : (h.html(""), e.f7Component ? e.f7Component.$mount(function(e) {
					h.append(e)
				}) : h.append(e)), u.params.unloadTabContent || (h[0].f7RouterTabLoaded = !0), function(e) {
					u.removeThemeElements(h);
					var t = h;
					"string" != typeof e && (t = $$1(e)), t.trigger("tab:init tab:mounted", d), u.emit("tabInit tabMounted", h[0], d), f && (m ? v(function() {
						f.length && u.emit("routeChanged", u.currentRoute, u.previousRoute, u), u.params.unloadTabContent && u.tabRemove(f, h, d)
					}) : (f.length && u.emit("routeChanged", u.currentRoute, u.previousRoute, u), u.params.unloadTabContent && u.tabRemove(f, h, d)))
				}(e))
			}

			function c() {
				return u.allowPageChange = !0, u
			}
			if(n) p(n);
			else if(i || o) try {
					u.tabTemplateLoader(i, o, t, p, c)
				} catch(e) {
					throw u.allowPageChange = !0, e
				} else if(r) p(r);
				else if(s || l) try {
				u.tabComponentLoader(h[0], s, l, t, p, c)
			} catch(e) {
				throw u.allowPageChange = !0, e
			} else a && (u.xhr && (u.xhr.abort(), u.xhr = !1), u.xhrRequest(a, t).then(function(e) {
				p(e)
			}).catch(function() {
				u.allowPageChange = !0
			}))
	...
	function tabRemove(e, t, a) {
		...
		e.children().each(function(e, t) {
			t.f7Component && (n = !0, $$1(t).trigger("tab:beforeremove", a), t.f7Component.$destroy())
		}), n || e.trigger("tab:beforeremove", a), this.emit("tabBeforeRemove", e[0], t[0], a), this.removeTabContent(e[0], a)
	}
	...
	function modalLoad(n, r, e) {
		...
		function h() {
			var t = d[n].create(u),
				e = (o.modalInstance = t).el;

			function a() {
				t.close()
			}
			t.on("modalOpen", function() {
				e || (c.removeThemeElements(t.el), t.$el.trigger(n.toLowerCase() + ":init " + n.toLowerCase() + ":mounted", r, t), c.emit("modalInit " + n + "Init " + n + "Mounted", t.el, r, t)), c.once("swipeBackMove", a)
			}), t.on("modalClose", function() {
				c.off("swipeBackMove", a), t.closeByRouter || c.back()
			}), t.on("modalClosed", function() {
				t.$el.trigger(n.toLowerCase() + ":beforeremove", r, t), t.emit("modalBeforeRemove " + n + "BeforeRemove", t.el, r, t);
				var e = t.el.f7Component;
				e && e.$destroy(), Utils.nextTick(function() {
					(e || u.component) && c.removeModal(t.el), t.destroy(), delete o.modalInstance
				})
			}), i.route && (c.params.pushState && i.pushState && History.push(c.view.id, {
				url: i.route.url,
				modal: n
			}, (c.params.pushStateRoot || "") + c.params.pushStateSeparator + i.route.url), i.route !== c.currentRoute && (c.currentRoute = Utils.extend(i.route, {
				modal: t
			})), i.history && (c.history.push(i.route.url), c.saveHistory())), e && (c.removeThemeElements(t.el), t.$el.trigger(n.toLowerCase() + ":init " + n.toLowerCase() + ":mounted", r, t), c.emit("modalInit " + n + "Init " + n + "Mounted", t.el, r, t)), t.open()
		}
		...
		function s(e, t) {
			...
			function l(e) {
				e && ("string" == typeof e ? u.content = e : e.f7Component ? e.f7Component.$mount(function(e) {
					u.el = e, d.root.append(e)
				}) : u.el = e, h())
			}

			function p() {
				return c.allowPageChange = !0, c
			}
			if(n) l(n);
			else if(r || i) try {
				c.modalTemplateLoader(r, i, t, l, p)
			} catch(e) {
				throw c.allowPageChange = !0, e
			} else if(o || s) try {
				c.modalComponentLoader(d.root[0], o, s, t, l, p)
			} catch(e) {
				throw c.allowPageChange = !0, e
			} else a ? (c.xhr && (c.xhr.abort(), c.xhr = !1), c.xhrRequest(a, t).then(function(e) {
				u.content = e, h()
			}).catch(function() {
				c.allowPageChange = !0
			})) : h()
		...
		return "url content component el componentUrl template templateUrl".split(" ").forEach(function(e) {
			var t;
			u[e] && !a && (a = !0, s(((t = {})[e] = u[e], t), i))
		}), a || "actions" !== n || h(), u.async && u.async.call(c, i.route, c.currentRoute, function(e, t) {
			s(e, Utils.extend(i, t))
		}, function() {
			c.allowPageChange = !0
		}), c
	}
	...
	function backward(e, t) {
		...
		if(u.length && o.removeThemeElements(u), c && (n = u.children(".navbar").children(".navbar-inner"), d ? (a = o.$navbarEl, 0 < n.length && u.children(".navbar").remove(), 0 === n.length && u[0].f7Page && (n = u[0].f7Page.$navbarEl), r = a.find(".navbar-current")) : r = h.children(".navbar").children(".navbar-inner")), o.allowPageChange = !1, 0 === u.length || 0 === h.length) return o.allowPageChange = !0, o;
		if(o.removeThemeElements(u), u.addClass("page-previous").removeClass("stacked").removeAttr("aria-hidden"), c && 0 < n.length && n.addClass("navbar-previous").removeClass("stacked").removeAttr("aria-hidden"), p.force && (0 < h.prev(".page-previous:not(.stacked)").length || 0 === h.prev(".page-previous").length))
			if(0 <= o.history.indexOf(p.route.url) ? (i = o.history.length - o.history.indexOf(p.route.url) - 1, o.history = o.history.slice(0, o.history.indexOf(p.route.url) + 2), l.history = o.history) : o.history[[o.history.length - 2]] ? o.history[o.history.length - 2] = p.route.url : o.history.unshift(o.url), i && o.params.stackPages) h.prevAll(".page-previous").each(function(e, t) {
				var a, n = $$1(t);
				d && (a = $$1(s.navbar.getElByPage(n))), n[0] !== u[0] && n.index() > u.index() && (0 <= o.initialPages.indexOf(n[0]) ? (n.addClass("stacked"), d && a.addClass("stacked")) : (o.pageCallback("beforeRemove", n, a, "previous", void 0, p), o.removePage(n), d && 0 < a.length && o.removeNavbar(a)))
			});
			else {
				var f, m = h.prev(".page-previous:not(.stacked)");
				d && (f = $$1(s.navbar.getElByPage(m))), o.params.stackPages && 0 <= o.initialPages.indexOf(m[0]) ? (m.addClass("stacked"), f.addClass("stacked")) : 0 < m.length && (o.pageCallback("beforeRemove", m, f, "previous", void 0, p), o.removePage(m), d && f.length && o.removeNavbar(f))
			}
		...
		function w() {
			0 === u.next(h).length && (!b && y ? y.$mount(function(e) {
				$$1(e).insertBefore(h)
			}) : u.insertBefore(h)), d && n.length && (n.insertBefore(r), 0 < r.length ? n.insertBefore(r) : (o.$navbarEl.parents(doc).length || o.$el.prepend(o.$navbarEl), a.append(n))), b || o.pageCallback("mounted", u, n, "previous", "current", p, h)
		}
		if(p.preload) return w(), p.route.route.tab && o.tabLoad(p.route.route.tab, Utils.extend({}, p, {
			history: !1,
			pushState: !1,
			preload: !0
		})), o.pageCallback("init", u, n, "previous", "current", p, h), 0 < u.prevAll(".page-previous:not(.stacked)").length && u.prevAll(".page-previous:not(.stacked)").each(function(e, t) {
			var a, n = $$1(t);
			d && (a = $$1(s.navbar.getElByPage(n))), o.params.stackPages && 0 <= o.initialPages.indexOf(t) ? (n.addClass("stacked"), d && a.addClass("stacked")) : (o.pageCallback("beforeRemove", n, a, "previous", void 0), o.removePage(n), d && a.length && o.removeNavbar(a))
	...
	function back() {
		...
		"object" == typeof n[0] ? a = n[0] || {} : (t = n[0], a = n[1] || {});
		var i = this,
			o = i.app;
		if(!i.view) return(e = o.views.main.router).back.apply(e, n), i;
		var s, l = i.currentRoute.modal;
		if(l || "popup popover sheet loginScreen actions customModal".split(" ").forEach(function(e) {
				i.currentRoute.route[e] && (l = !0, s = e)
			}), l) {
			var p = i.currentRoute.modal || i.currentRoute.route.modalInstance || o[s].get(),
				c = i.history[i.history.length - 2],
				d = i.findMatchingRoute(c);
			return !d && c && (d = {
				url: c,
				path: c.split("?")[0],
				query: Utils.parseUrlQuery(c),
				route: {
					path: c.split("?")[0],
					url: c
				}
			}), d && p ? (i.params.pushState && !1 !== a.pushState && History.back(), i.currentRoute = d, i.history.pop(), i.saveHistory(), i.modalRemove(p), i) : i
		}
		var u = i.$el.children(".page-current").prevAll(".page-previous").eq(0);
		if(!a.force && 0 < u.length) {
			if(i.params.pushState && u[0].f7Page && i.history[i.history.length - 2] !== u[0].f7Page.route.url) return i.back(i.history[i.history.length - 2], Utils.extend(a, {
				force: !0
			})), i;
			var h = u[0].f7Page.route;
			return processRouteQueue.call(i, h, i.currentRoute, function() {
				i.loadBack({
					el: u
				}, Utils.extend(a, {
					route: h
		...
		"#" === t && (t = void 0), t && "/" !== t[0] && 0 !== t.indexOf("#") && (t = ((i.path || "/") + t).replace("//", "/")), !t && 1 < i.history.length && (t = i.history[i.history.length - 2]);
		var f = i.findMatchingRoute(t);
		if(f || t && (f = {
				url: t,
				path: t.split("?")[0],
				query: Utils.parseUrlQuery(t),
				route: {
					path: t.split("?")[0],
					url: t
				}
			}), !f) return i;
		if(f.route.redirect) return redirect.call(i, "back", f, a);
		var m, v = {};
		if(f.route.options ? Utils.extend(v, f.route.options, a, {
				route: f
			}) : Utils.extend(v, a, {
				route: f
			}), v && v.context && (f.context = v.context, v.route.context = v.context), v.force && i.params.stackPages && (i.$el.children(".page-previous.stacked").each(function(e, t) {
				t.f7Page && t.f7Page.route && t.f7Page.route.url === f.url && (m = !0, i.loadBack({
					el: t
				}, v))
			}), m)) return i;
		...
		function g() {
			...
			"url content component pageName el componentUrl template templateUrl".split(" ").forEach(function(e) {
				var t;
				f.route[e] && !a && (a = !0, i.loadBack(((t = {})[e] = f.route[e], t), v))
			}), a || f.route.async && (i.allowPageChange = !1, f.route.async.call(i, f, i.currentRoute, function(e, t) {
				i.allowPageChange = !1, t && t.context && (f.context ? f.context = Utils.extend({}, f.context, t.context) : f.context = t.context, v.route.context = f.context), i.loadBack(e, Utils.extend(v, t), !0)
			}, function() {
				i.allowPageChange = !0
			}))
		}
		return v.preload ? g() : processRouteQueue.call(i, f, i.currentRoute, function() {
			g()
		}, function() {
			i.allowPageChange = !0
		}), i
	...
	var Router = function(i) {
			function e(e, t) {
				...
				var a = this;
				a.isAppRouter = void 0 === t, a.isAppRouter ? Utils.extend(!1, a, {
					app: e,
				...
				return Object.defineProperty(a, "currentRoute", {
					...
					configurable: !0,
					set: function(e) {
						void 0 === e && (e = {}), r = Utils.extend({}, n), (n = e) && (a.url = n.url, a.emit("routeChange", e, r, a))
					},
					get: function() {
						return n
					}
			...
			return i && (e.__proto__ = i), ((e.prototype = Object.create(i && i.prototype)).constructor = e).prototype.animatableNavElements = function(a, n) {
				...
				return e && (o = [], s = [], a.children(".left, .right, .title, .subnavbar").each(function(e, t) {
					o.push(r(t, a))
				...
				m && (d = $$1('<div class="page-shadow-effect"></div>'), u = $$1('<div class="page-opacity-effect"></div>'), "forward" === s ? (o.append(d), i.append(u)) : (o.append(u), i.append(d)));
				var $ = Utils.bezier(.25, .1, .25, 1);
				h.$el.addClass(g), Utils.nextFrame(function e() {
					var t = Utils.now();
					b || (b = t);
					...
					1 <= a && (y = !0);
					var r = h.app.rtl ? -1 : 1;
					if(m ? ("forward" === s ? (o.transform("translate3d(" + 100 * (1 - n) * r + "%,0,0)"), i.transform("translate3d(" + 20 * -n * r + "%,0,0)"), d[0].style.opacity = n, u[0].style.opacity = n) : (o.transform("translate3d(" + 20 * -(1 - n) * r + "%,0,0)"), i.transform("translate3d(" + 100 * n * r + "%,0,0)"), d[0].style.opacity = 1 - n, u[0].style.opacity = 1 - n), f && (p.forEach(function(e) {
							var t = e.$el,
						...
						}))) : "forward" === s ? (o.transform("translate3d(0, " + 56 * (1 - n) + "px,0)"), o.css("opacity", n)) : (i.transform("translate3d(0, " + 56 * n + "px,0)"), i.css("opacity", 1 - n)), y) return o.transform("").css("opacity", ""), i.transform("").css("opacity", ""), m && (d.remove(), u.remove(), f && (p.forEach(function(e) {
						e.$el.transform(""), e.$el.css("opacity", "")
					}), c.forEach(function(e) {
						e.$el.transform(""), e.$el.css("opacity", "")
					}), p = [], c = [])), h.$el.removeClass(g), void(l && l());
					Utils.nextFrame(e)
				})
				...
				if(e) {
					...
					0 !== t.length && (t.find(".tab").each(function(e, t) {
						$$1(t).children().each(function(e, t) {
							t.f7Component && ($$1(t).trigger("tab:beforeremove"), t.f7Component.$destroy())
						})
				...
				var s = i.find(o).filter(function(e, t) {
					return 0 === $$1(t).parents(".popup, .dialog, .popover, .actions-modal, .sheet-modal, .login-screen, .page").length
				});
				return 1 < s.length && ("string" == typeof n.selector && (s = i.find(n.selector + " " + o)), 1 < s.length && (s = i.find("." + r.params.viewMainClass + " " + o))), 1 === s.length ? s : (a || (s = this.findElement(o, i, !0)), s && 1 === s.length ? s : s && 1 < s.length ? $$1(s[0]) : void 0)
				...
				return e.forEach(function(a) {
					if("routes" in a) {
						var e = a.routes.map(function(e) {
							var t = Utils.extend({}, e);
							return t.path = (a.path + "/" + t.path).replace("///", "/").replace("//", "/"), t
						});
						r = r.concat(a, n.flattenRoutes(e))
					} else if("tabs" in a && a.tabs) {
						var t = a.tabs.map(function(e) {
							...
							return delete t.tabs, t
						});
						r = r.concat(n.flattenRoutes(t))
					} else r.push(a)
				}), r
					...
					return t.forEach(function(e) {
						if(!o) {
							...
							if(e.alias && ("string" == typeof e.alias ? r.push(e.alias) : Array.isArray(e.alias) && e.alias.forEach(function(e) {
								...
								}), n) a.forEach(function(e, t) {
								if("number" != typeof e.name) {
									var a = n[t + 1];
									c[e.name] = a
								}
							}), e.parentPath && (t = s.split("/").slice(0, e.parentPath.split("/").length - 1).join("/")), o = {
								query: l,
								hash: p,
								params: c,
								url: i,
				...
				var i = this,
					...
					l = e,
					t = 0 <= l.indexOf("?");
				return o.passRouteQueryToRequest && r && r.route && r.route.query && Object.keys(r.route.query).length && (l += (t ? "&" : "?") + Utils.serializeObject(r.route.query), t = !0), o.passRouteParamsToRequest && r && r.route && r.route.params && Object.keys(r.route.params).length && (l += (t ? "&" : "?") + Utils.serializeObject(r.route.params), t = !0), 0 <= l.indexOf("{{") && r && r.route && r.route.params && Object.keys(r.route.params).length && Object.keys(r.route.params).forEach(function(e) {
					var t = new RegExp("{{" + e + "}}", "g");
					l = l.replace(t, r.route.params[e] || "")
				}), o.xhrCacheIgnoreGetParameters && 0 <= l.indexOf("?") && (l = l.split("?")[0]), Utils.promise(function(a, n) {
					if(o.xhrCache && !s && l.indexOf("nocache") < 0 && o.xhrCacheIgnore.indexOf(l) < 0)
						for(var e = 0; e < i.cache.xhr.length; e += 1) {
							var t = i.cache.xhr[e];
							if(t.url === l && Utils.now() - t.time < o.xhrCacheDuration) return void a(t.content)
						}
					i.xhr = i.app.request({
						url: l,
						method: "GET",
						...
						complete: function(e, t) {
							i.emit("routerAjaxComplete", e), "error" !== t && "timeout" !== t && 200 <= e.status && e.status < 300 || 0 === e.status ? (o.xhrCache && "" !== e.responseText && (i.removeFromXhrCache(l), i.cache.xhr.push({
								url: l,
								time: Utils.now(),
								content: e.responseText
							})), i.emit("routerAjaxSuccess", e, r), a(e.responseText)) : (i.emit("routerAjaxError", e, r), n(e))
						},
						error: function(e) {
							i.emit("routerAjaxError", e, r), n(e)
						}
					})
				})
			}, e.prototype.removeThemeElements = function(e) {
				var t = this.app.theme;
				$$1(e).find("." + ("md" === t ? "ios" : "md") + "-only, .if-" + ("md" === t ? "ios" : "md")).remove()
				...
				t ? (o.xhr && (o.xhr.abort(), o.xhr = !1), o.xhrRequest(t, n).then(function(e) {
					a(e)
				}).catch(function() {
					i()
				})) : a(e)
				...
				a ? (s.xhr && (s.xhr.abort(), s.xhr = !1), s.xhrRequest(a, r).then(function(e) {
					n(l.component.parse(e))
				}).catch(function(e) {
					throw o(), e
				})) : n(e)
				...
				if(void 0 === i && (i = {}), t) {
					...
					if(l.length) {
						...
						if(void 0 === v && (v = {}), i.on && Utils.extend(m, i.on), i.once && Utils.extend(v, i.once), "mounted" === e && y(), "init" === e) {
							if(c && ("previous" === n || !n) && "current" === r && s.scrollHistory[h.route.url] && !l.hasClass("no-restore-scroll")) {
								...
								0 < g.length && (g = g.filter(function(e, t) {
									return 0 === $$1(t).parents(".tab:not(.tab-active)").length && !$$1(t).is(".tab:not(.tab-active)")
						...
						c && "beforeOut" === e && "current" === n && "next" === r && delete s.scrollHistory[h.route.url], l.trigger(u, h), s.emit(d, h), "beforeRemove" === e && (l[0].f7RouteEventsAttached && (l[0].f7RouteEventsOn && Object.keys(l[0].f7RouteEventsOn).forEach(function(e) {
				...
				function y() {
					l[0].f7RouteEventsAttached || (l[0].f7RouteEventsAttached = !0, m && 0 < Object.keys(m).length && (l[0].f7RouteEventsOn = m, Object.keys(m).forEach(function(e) {
						m[e] = m[e].bind(s), l.on(Utils.eventNameToColonCase(e), m[e])
					})), v && 0 < Object.keys(v).length && (l[0].f7RouteEventsOnce = v, Object.keys(v).forEach(function(e) {
				...
				(win.cordova && p && !d && !h && doc.location.pathname.indexOf("index.html") && (console.warn("Framework7: wrong or not complete pushState configuration, trying to guess pushStateRoot"), h = doc.location.pathname.split("index.html")[0]), p && c ? (h && 0 <= s.indexOf(h) && "" === (s = s.split(h)[1]) && (s = "/"), r = 0 < d.length && 0 <= s.indexOf(d) ? s.split(d)[1] : s, i.restoreHistory(), 0 <= i.history.indexOf(r) ? i.history = i.history.slice(0, i.history.indexOf(r) + 1) : i.params.url === r ? i.history = [r] : History.state && History.state[t.id] && History.state[t.id].url === i.history[i.history.length - 1] ? r = i.history[i.history.length - 1] : i.history = [s.split(d)[0] || "/", r], 1 < i.history.length ? a = !0 : i.history = [], i.saveHistory()) : (r || (r = s), doc.location.search && r.indexOf("?") < 0 && (r += doc.location.search), doc.location.hash && r.indexOf("#") < 0 && (r += doc.location.hash)), 1 < i.history.length ? (n = i.findMatchingRoute(i.history[0])) || (n = Utils.extend(i.parseRouteUrl(i.history[0]), {
					...
					reloadCurrent: !0,
					pushState: !1
				}): (i.currentRoute = n, i.$el.children(".page:not(.stacked)").each(function(e, t) {
					var a, n = $$1(t);
				...
				}), a || o || (i.history.push(r), i.saveHistory()));
				!(r && p && c) || History.state && History.state[t.id] || History.initViewState(t.id, {
					url: r
				}), i.emit("local::init routerInit", i)
			}, e.prototype.destroy = function() {
				var t = this;
				t.emit("local::destroy routerDestroy", t), Object.keys(t).forEach(function(e) {
					t[e] = null, delete t[e]
				}), t = null
			}, e
		}(Framework7Class),
		...
		View = function(p) {
			function e(e, t, a) {
				...
				return l.params = Utils.extend({
					...
					history: [],
					scrollHistory: {}
				}), (s[0].f7View = l).useModules(), o.views.push(l), l.main && (o.views.main = l), l.name && (o.views[l.name] = l), l.index = o.views.indexOf(l), i = l.name ? "view_" + l.name : l.main ? "view_main" : "view_" + l.index, l.id = i, o.initialized ? l.init() : o.on("init", function() {
					l.init()
				}), l
			}
	...
	function initClicks(d) {
		if(d.on("click", function(e) {
				var n = $$1(e.target),
					t = n.closest("a"),
					a = 0 < t.length,
					r = a && t.attr("href"),
					i = a && t.hasClass("tab-link") && (t.attr("data-tab") || r && 0 === r.indexOf("#"));
				if(a && (t.is(d.params.clicks.externalLinks) || r && 0 <= r.indexOf("javascript:"))) {
					var o = t.attr("target");
					...
					Object.keys(d.modules).forEach(function(e) {
						var a = d.modules[e].clicks;
						a && Object.keys(a).forEach(function(e) {
							var t = n.closest(e).eq(0);
							0 < t.length && a[e].call(d, t, t.dataset())
						})
					});
					var s = {};
					a && (e.preventDefault(), s = t.dataset());
					var l = r && 0 < r.length && "#" !== r && !i,
						p = s.template;
					if(l || t.hasClass("back") || p) {
						var c;
						if(s.view ? c = $$1(s.view)[0].f7View : (c = n.parents(".view")[0] && n.parents(".view")[0].f7View, !t.hasClass("back") && c && c.params.linksView && ("string" == typeof c.params.linksView ? c = $$1(c.params.linksView)[0].f7View : c.params.linksView instanceof View && (c = c.params.linksView))), c || d.views.main && (c = d.views.main), !c || !c.router) return;
						if(s.context && "string" == typeof s.context) try {
							s.context = JSON.parse(s.context)
						} catch(e) {}
						t.hasClass("back") ? c.router.back(r, s) : c.router.navigate(r, s)
					}
				}
			...
			$$1(doc).on(d.params.touch.fastClicks ? "touchstart" : "touchmove", ".panel-backdrop, .dialog-backdrop, .preloader-backdrop, .popup-backdrop, .searchbar-backdrop", function(e) {
				e.preventDefault()
			}, e)
		}
	}
	...
	var ClicksModule = {
		...
		Storage = {
			...
			set: function(a, n) {
				return Utils.promise(function(e, t) {
					try {
						win.localStorage.setItem("" + keyPrefix + a, JSON.stringify(n)), e()
					} catch(e) {
						t(e)
					}
				})
			...
			remove: function(a) {
				return Utils.promise(function(e, t) {
					try {
						win.localStorage.removeItem("" + keyPrefix + a), e()
					} catch(e) {
						t(e)
					}
				})
	...
	var selfClosing = "area base br col command embed hr img input keygen link menuitem meta param source track wbr".split(" "),
		propsAttrs = "hidden value checked disabled readonly selected".split(" "),
		tempDom = doc.createElement("div");

	function getHooks(e, t, a, n) {
		if(!e || !e.attrs || !e.attrs.class) return null;
		var r = e.attrs.class,
			i = {},
			o = [],
			s = [],
		...
		return r.split(" ").forEach(function(e) {
			a || o.push.apply(o, t.getVnodeHooks("insert", e)), s.push.apply(s, t.getVnodeHooks("destroy", e)), l.push.apply(l, t.getVnodeHooks("update", e)), p.push.apply(p, t.getVnodeHooks("postpatch", e))
		}), n && !a && p.push(function(e, t) {
			var a = t || e;
			a && a.data && a.data.context && a.data.context.$options.updated && a.data.context.$options.updated()
		}), 0 === o.length && 0 === s.length && 0 === l.length && 0 === p.length ? null : (o.length && (i.insert = function(t) {
			o.forEach(function(e) {
				return e(t)
			})
		}), s.length && (i.destroy = function(t) {
			s.forEach(function(e) {
				return e(t)
			})
	...
	function getData(e, s, t, a, n) {
		...
		Array.prototype.forEach.call(r, function(e) {
			var t = e.name,
				a = e.value;
			if(0 <= propsAttrs.indexOf(t)) l.props || (l.props = {}), l.props[t] = a;
			else if("key" === t) l.key = t;
			else if(0 === t.indexOf("@")) {
				l.on || (l.on = {});
				var n = t.substr(1),
					r = !1,
				...
				0 <= n.indexOf(".") && n.split(".").forEach(function(e, t) {
					0 === t ? n = e : ("stop" === e && (r = !0), "prevent" === e && (i = !0), "once" === e && (o = !0))
				}), l.on[n] = getEventHandler(a, s, {
					stop: r,
					prevent: i,
					once: o
				})
			} else l.attrs || (l.attrs = {}), l.attrs[t] = a, "id" !== t || l.key || (l.key = a)
		});
		var i = getHooks(l, t, a, n);
		return i && (l.hook = i), l
	}
	...
	function vdom(e, t, a, n) {
		...
		var r = elementToVNode(tempDom.childNodes[0], t, a, n, !0);
		return tempDom.innerHTML = "", r
	}
	...
	function createKeyToOldIdx(e, t, a) {
		var n, r, i, o = {};
		for(n = t; n <= a; ++n) null != (i = e[n]) && void 0 !== (r = i.key) && (o[r] = n);
		return o
	}
	...
	function init$1(e, t) {
		...
		return function(e, t) {
			var a, n, r, i, o, s, l = [];
			for(a = 0; a < h.pre.length; ++a) h.pre[a]();
			for(isVnode(e) || (o = (i = e).id ? "#" + i.id : "", s = i.className ? "." + i.className.split(" ").join(".") : "", e = vnode(m.tagName(i).toLowerCase() + o + s, {}, [], void 0, i)), sameVnode(e, t) ? y(e, t, l) : (n = e.elm, r = m.parentNode(n), v(t, l), null !== r && (m.insertBefore(r, t.elm, m.nextSibling(n)), b(r, [e], 0, 0))), a = 0; a < l.length; ++a) l[a].data.hook.insert(l[a]);
			for(a = 0; a < h.post.length; ++a) h.post[a]();
			return t
		}
	}
	...
	function updateProps(e, t) {
		var a, n, r = t.elm,
			...
			o = t.data.props;
		if((i || o) && i !== o) {
			for(a in o = o || {}, i = i || {}) o[a] || delete r[a];
			for(a in o) n = o[a], i[a] === n || "value" === a && r[a] === n || (r[a] = n)
		}
	}
	var propsModule = {
		create: updateProps,
	...
	function updateEvents(e, t) {
		...
		if(a !== i && (a && n && (i ? Object.keys(a).forEach(function(e) {
			...
			(t.listener = s).vnode = t, a ? Object.keys(i).forEach(function(e) {
				a[e] || $$1(o).on(e, s)
	...
	var eventListenersModule = {
		...
		patch = init$1([attributesModule, propsModule, eventListenersModule]),
		counter = 0;

	function renderEsTemplate(e, t) {
		var a = "f7_component_es_template" + (t || (new Date).getTime()),
			n = "\n    window." + a + " = function () {\n      return `" + e + "`;\n    }\n  ",
			r = doc.createElement("script");
		r.innerHTML = n, $$1("head").append(r);
		var i = win[a];
		return $$1(r).remove(), delete win[a], i
	}
	var Framework7Component = function(n, e, t) {
		void 0 === t && (t = {});
		var a = "" + Utils.now() + counter,
			...
			i = r.$options;
		counter += 1, Object.defineProperty(r, "$root", {
			enumerable: !0,
			configurable: !0,
			get: function() {
				...
				return win && win.Proxy && (e = new win.Proxy(e, {
					...
					deleteProperty: function(e, t) {
						delete n.data[t], delete n.methods[t]
					},
					has: function(e, t) {
			...
			i[e] && (i[e] = i[e].bind(r))
		}), i.data && (i.data = i.data.bind(r), Utils.extend(r, i.data())), i.render && (i.render = i.render.bind(r)), i.methods && Object.keys(i.methods).forEach(function(e) {
		...
		var o = r.$render();
		return o && "string" == typeof o ? (o = o.trim(), r.$vnode = vdom(o, r, n, !0), r.el = doc.createElement("div"), patch(r.el, r.$vnode)) : o && (r.el = o), r.$el = $$1(r.el), i.style && (r.$styleEl = doc.createElement("style"), r.$styleEl.innerHTML = i.style, i.styleScoped && r.el.setAttribute("data-scope", i.id)), r.$attachEvents(), i.created && i.created(), r.el.f7Component = r
	};
	Framework7Component.prototype.$attachEvents = function() {
		...
		if(e.render) t = e.render();
			...
			if("string" == typeof e.template) {
				if("t7" === e.templateType || !e.templateType) try {
					t = Template7.compile(e.template)(this)
				} catch(e) {
					throw e
				}
				"es" === e.templateType && (e.render = renderEsTemplate(e.template, e.id).bind(this), t = e.render())
		...
		var t = this;
		t.$options.beforeMount && t.$options.beforeMount(), t.$styleEl && $$1("head").append(t.$styleEl), e && e(t.el), t.$options.mounted && t.$options.mounted()
	}, Framework7Component.prototype.$destroy = function() {
		var e = this;
		e.$options.beforeDestroy && e.$options.beforeDestroy(), e.$styleEl && $$1(e.$styleEl).remove(), e.$detachEvents(), e.$options.destroyed && e.$options.destroyed(), win["f7_component_es_template" + e.$options.id] && delete win["f7_component_es_template" + e.$options.id], e.el && e.el.f7Component && (e.el.f7Component = null, delete e.el.f7Component), e.$vnode && (e.$vnode = patch(e.$vnode, {
			sel: e.$vnode.sel,
			data: {}
		})), Utils.deleteProps(e)
	};
	...
	function parseComponent(e) {
		var t, a = "" + Utils.now() + counter$1,
			n = "f7_component_create_callback_" + a,
			r = e.match(/<template([ ]?)([a-z0-9-]*)>/),
			i = r[2] || "t7";
		r && (t = e.split(/<template[ ]?[a-z0-9-]*>/).filter(function(e, t) {
			return 0 < t
		...
		var o, s = null,
			l = !1;
		if(counter$1 += 1, 0 <= e.indexOf("<style>") ? s = e.split("<style>")[1].split("</style>")[0] : 0 <= e.indexOf("<style scoped>") && (l = !0, s = (s = e.split("<style scoped>")[1].split("</style>")[0]).split("\n").map(function(e) {
				return 0 <= e.indexOf("{") ? 0 <= e.indexOf("{{this}}") ? e.replace("{{this}}", '[data-scope="' + a + '"]') : '[data-scope="' + a + '"] ' + e.trim() : e
			}).join("\n")), 0 <= e.indexOf("<script>")) {
			var p = e.split("<script>");
			o = p[p.length - 1].split("<\/script>")[0].trim()
		} else o = "return {}";
		o = "window." + n + " = function () {" + o + "}";
		var c = doc.createElement("script");
		c.innerHTML = o, $$1("head").append(c);
		var d = win[n]();
		return $$1(c).remove(), win[n] = null, delete win[n], d.template || d.render || (d.template = t, d.templateType = i), s && (d.style = s, d.styleScoped = l), d.id = a, d
	}
	var ComponentModule = {
			name: "component",
			create: function() {
		...
		Statusbar = {
			hide: function() {
				$$1("html").removeClass("with-statusbar"), Device.cordova && win.StatusBar && win.StatusBar.hide()
			},
			show: function() {
				if(Device.cordova && win.StatusBar) return win.StatusBar.show(), void Utils.nextTick(function() {
					Device.needsStatusbarOverlay() && $$1("html").addClass("with-statusbar")
				});
				$$1("html").addClass("with-statusbar")
			},
			onClick: function() {
				var e;
				(e = 0 < $$1(".popup.modal-in").length ? $$1(".popup.modal-in").find(".page:not(.page-previous):not(.page-next):not(.cached)").find(".page-content") : 0 < $$1(".panel.panel-active").length ? $$1(".panel.panel-active").find(".page:not(.page-previous):not(.page-next):not(.cached)").find(".page-content") : 0 < $$1(".views > .view.tab-active").length ? $$1(".views > .view.tab-active").find(".page:not(.page-previous):not(.page-next):not(.cached)").find(".page-content") : 0 < $$1(".views").length ? $$1(".views").find(".page:not(.page-previous):not(.page-next):not(.cached)").find(".page-content") : this.root.children(".view").find(".page:not(.page-previous):not(.page-next):not(.cached)").find(".page-content")) && 0 < e.length && (e.hasClass("tab") && (e = e.parent(".tabs").children(".page-content.tab-active")), 0 < e.length && e.scrollTop(0, 300))
			},
			...
			setBackgroundColor: function(e) {
				$$1(".statusbar").css("background-color", e), Device.cordova && win.StatusBar && win.StatusBar.backgroundColorByHexString(e)
			},
			isVisible: function() {
				return !(!Device.cordova || !win.StatusBar) && win.StatusBar.isVisible
			},
			iosOverlaysWebView: function(e) {
				void 0 === e && (e = !0), Device.ios && Device.cordova && win.StatusBar && (win.StatusBar.overlaysWebView(e), e ? $$1("html").addClass("with-statusbar") : $$1("html").removeClass("with-statusbar"))
			},
			checkOverlay: function() {
				Device.needsStatusbarOverlay() ? $$1("html").addClass("with-statusbar") : $$1("html").removeClass("with-statusbar")
			},
			init: function() {
				var e = this,
					t = e.params.statusbar;
				t.enabled && ("auto" === t.overlay ? (Device.needsStatusbarOverlay() ? $$1("html").addClass("with-statusbar") : $$1("html").removeClass("with-statusbar"), Device.ios && (Device.cordova || Device.webView) && (0 === win.orientation && e.once("resize", function() {
					Statusbar.checkOverlay()
				}), $$1(doc).on("resume", function() {
					Statusbar.checkOverlay()
				}, !1), e.on(Device.ios ? "orientationchange" : "orientationchange resize", function() {
					Statusbar.checkOverlay()
				}))) : !0 === t.overlay ? $$1("html").addClass("with-statusbar") : !1 === t.overlay && $$1("html").removeClass("with-statusbar"), Device.cordova && win.StatusBar && (t.scrollTopOnClick && $$1(win).on("statusTap", Statusbar.onClick.bind(e)), t.iosOverlaysWebView ? win.StatusBar.overlaysWebView(!0) : win.StatusBar.overlaysWebView(!1), "white" === t.iosTextColor ? win.StatusBar.styleLightContent() : win.StatusBar.styleDefault()), t.iosBackgroundColor && "ios" === e.theme && Statusbar.setBackgroundColor(t.iosBackgroundColor), t.materialBackgroundColor && "md" === e.theme && Statusbar.setBackgroundColor(t.materialBackgroundColor))
			}
		},
		Statusbar$1 = {
			name: "statusbar",
	...
	function getCurrentView(e) {
		...
		if(0 < i.length) {
			...
			if(1 < i.length) return e.views.main
		}
	}
	var View$1 = {
			name: "view",
		...
		Navbar = {
			size: function(e) {
				...
				if("ios" === a.theme) {
					var t = $$1(e);
					if(t.hasClass("navbar")) t = t.children(".navbar-inner").each(function(e, t) {
						a.navbar.size(t)
					});
						...
						var n, r, i, o, s = t.parents(".view").eq(0),
							...
							C = 0,
							x = 0;
						0 < s.length && s[0].f7View && (r = (n = s[0].f7View.router) && n.dynamicNavbar, n && n.separateNavbar || (x = (C = b) / 5)), h && (i = y - v), u && (i = 0), u || h || (i = (y - m - v + f) / 2);
						var E = (y - v) / 2;
						v < y - f - m ? (E < f && (E = f), y - m < E + v && (E = y - m - v), o = E - i) : o = 0;
						var k = a.rtl ? -1 : 1;
						if(r) {
							if(c.hasClass("sliding") || 0 < c.length && $) {
								var T = -(i + o) * k + x,
									S = (y - i - o - v) * k - C;
								if(w && n && n.params.iosAnimateNavbarBackIcon) {
									var M = t.parent().find(".navbar-current").children(".left.sliding").find(".back .icon ~ span");
									0 < M.length && (T += M[0].offsetLeft)
								}
								c[0].f7NavbarLeftOffset = T, c[0].f7NavbarRightOffset = S
							}
							u || !l.hasClass("sliding") && !$ || (a.rtl ? (l[0].f7NavbarLeftOffset = -(y - l[0].offsetWidth) / 2 * k, l[0].f7NavbarRightOffset = f * k) : (l[0].f7NavbarLeftOffset = -f + x, l[0].f7NavbarRightOffset = (y - l[0].offsetWidth) / 2 - C, n && n.params.iosAnimateNavbarBackIcon && 0 < l.find(".back .icon").length && (l[0].f7NavbarRightOffset -= l.find(".back .icon")[0].offsetWidth))), h || !p.hasClass("sliding") && !$ || (a.rtl ? (p[0].f7NavbarLeftOffset = -m * k, p[0].f7NavbarRightOffset = (y - p[0].offsetWidth) / 2 * k) : (p[0].f7NavbarLeftOffset = -(y - p[0].offsetWidth) / 2 + x, p[0].f7NavbarRightOffset = m - C)), d.length && (d.hasClass("sliding") || $) && (d[0].f7NavbarLeftOffset = a.rtl ? d[0].offsetWidth : -d[0].offsetWidth + x, d[0].f7NavbarRightOffset = -d[0].f7NavbarLeftOffset - C + x)
						}
						if(a.params.navbar.iosCenterTitle) {
							var P = o;
							a.rtl && u && h && 0 < c.length && (P = -P), c.css({
								left: P + "px"
							})
						}
					}
			...
			getElByPage: function(e) {
				var t, a, n;
				if(e.$navbarEl || e.$el ? t = (n = e).$el : 0 < (t = $$1(e)).length && (n = t[0].f7Page), n && n.$navbarEl && 0 < n.$navbarEl.length ? a = n.$navbarEl : t && (a = t.children(".navbar").children(".navbar-inner")), a && (!a || 0 !== a.length)) return a[0]
			},
			getPageByEl: function(e) {
				var t = $$1(e);
				if(!(t.hasClass("navbar") && 1 < (t = t.find(".navbar-inner")).length)) return t[0].f7Page
			},
			initHideNavbarOnScroll: function(e, t) {
				...
				function u() {
					c.hasClass("page-previous") || (n = this.scrollTop, r = this.scrollHeight, i = this.offsetHeight, o = r <= n + i, l = d.hasClass("navbar-hidden"), o ? p.params.navbar.showOnPageScrollEnd && (s = "show") : s = n < a ? p.params.navbar.showOnPageScrollTop || n <= 44 ? "show" : "hide" : 44 < n ? "hide" : "show", "show" === s && l ? (p.navbar.show(d), l = !1) : "hide" !== s || l || (p.navbar.hide(d), l = !0), a = n)
				}
		...
		Navbar$1 = {
			...
			on: {
				"panelBreakpoint resize": function() {
					var a = this;
					"ios" === a.theme && $$1(".navbar").each(function(e, t) {
						a.navbar.size(t)
					})
				},
				...
				pageBeforeIn: function(e) {
					if("ios" === this.theme) {
						...
						if(t = n ? $$1(n).parents(".navbar") : e.$el.parents(".view").children(".navbar"), e.$el.hasClass("no-navbar") || a.router.dynamicNavbar && !n) {
				...
				tabShow: function(e) {
					var a = this;
					$$1(e).find(".navbar:not(.navbar-previous):not(.stacked)").each(function(e, t) {
						a.navbar.size(t)
					})
				}
			},
		...
		Toolbar = {
			setHighlight: function(e) {
				if("md" === this.theme) {
					...
					if(0 !== t.length && (t.hasClass("tabbar") || t.hasClass("tabbar-labels"))) {
						...
						var a, n, r = t.find(".tab-link-highlight"),
							i = t.find(".tab-link-active");
						if(t.hasClass("tabbar-scrollable") && i && i[0]) a = i[0].offsetWidth + "px", n = i[0].offsetLeft + "px";
						else {
							var o = i.index();
			...
			initHideToolbarOnScroll: function(e) {
				...
				function d() {
					p.hasClass("page-previous") || (a = this.scrollTop, n = this.scrollHeight, r = this.offsetHeight, i = n <= a + r, s = c.hasClass("toolbar-hidden"), i ? l.params.toolbar.showOnPageScrollEnd && (o = "show") : o = a < t ? l.params.toolbar.showOnPageScrollTop || a <= 44 ? "show" : "hide" : 44 < a ? "hide" : "show", "show" === o && s ? (l.toolbar.show(c), s = !1) : "hide" !== o || s || (l.toolbar.hide(c), s = !0), t = a)
				}
			}
		},
		Toolbar$1 = {
	...
	var Modal = function(n) {
			function e(e, t) {
				n.call(this, t, [e]);
				var a = {};
				return this.useModulesParams(a), this.params = Utils.extend(a, t), this.opened = !1, this.useModules(), this
			}
			return n && (e.__proto__ = n), ((e.prototype = Object.create(n && n.prototype)).constructor = e).prototype.onOpen = function() {
				var e = this;
				e.opened = !0, openedModals.push(e), $$1("html").addClass("with-modal-" + e.type.toLowerCase()), e.$el.trigger("modal:open " + e.type.toLowerCase() + ":open", e), e.emit("local::open modalOpen " + e.type + "Open", e)
				...
				var e = this;
				e.opened = !1, e.type && e.$el && (openedModals.splice(openedModals.indexOf(e), 1), $$1("html").removeClass("with-modal-" + e.type.toLowerCase()), e.$el.trigger("modal:close " + e.type.toLowerCase() + ":close", e), e.emit("local::close modalClose " + e.type + "Close", e))
				...
				if("dialog" === o && n.params.modal.queueDialogs && (0 < $$1(".dialog.modal-in").length ? t = !0 : 0 < openedModals.length && openedModals.forEach(function(e) {
						"dialog" === e.type && (t = !0)
				...
				})), r.show(), "dialog" === o && r.css({
					marginTop: -Math.round(r.outerHeight() / 2) + "px"
				}), a._clientLeft = r[0].clientLeft, i && (i[s ? "removeClass" : "addClass"]("not-animated"), i.addClass("backdrop-in")), s ? (r.animationEnd(function() {
					c()
		...
		CustomModal = function(s) {
			function e(e, t) {
				...
				s.call(this, e, a);
				var n, r, i = this;
				if(i.params = a, (n = i.params.el ? $$1(i.params.el) : $$1(i.params.content)) && 0 < n.length && n[0].f7Modal) return n[0].f7Modal;
				if(0 === n.length) return i.destroy();

				function o(e) {
					i && !i.destroyed && r && e.target === r[0] && i.close()
				}
				return i.params.backdrop && 0 === (r = e.root.children(".custom-modal-backdrop")).length && (r = $$1('<div class="custom-modal-backdrop"></div>'), e.root.append(r)), i.on("customModalOpened", function() {
		...
		Dialog = function(y) {
			function e(a, e) {
				...
				var n, r = this,
					...
					p = t.verticalButtons,
					c = t.cssClass;
				if(r.params = t, r.params.el) n = $$1(r.params.el);
				else {
					var d = ["dialog"];
				...
				function g(a) {
					...
					l.forEach(function(e, t) {
						e.keyCodes && 0 <= e.keyCodes.indexOf(n) && (doc.activeElement && doc.activeElement.blur(), e.onClick && e.onClick(r, a), r.params.onClick && r.params.onClick(r, t), !1 !== e.close && r.close())
					})
				}

				function b(e) {
					var t = e.target;
					0 === $$1(t).closest(r.el).length && r.params.closeByBackdropClick && r.backdropEl && r.backdropEl === t && r.close()
				}
				return 0 === m.length && (m = $$1('<div class="dialog-backdrop"></div>'), a.root.append(m)), l && 0 < l.length && (r.on("open", function() {
					n.find(".dialog-button").each(function(e, t) {
						l[e].keyCodes && (f = !0), $$1(t).on("click", v)
					}), !f || a.device.ios || a.device.android || a.device.cordova || $$1(doc).on("keydown", g)
				}), r.on("close", function() {
					n.find(".dialog-button").each(function(e, t) {
						$$1(t).off("click", v)
					}), !f || a.device.ios || a.device.android || a.device.cordova || $$1(doc).off("keydown", g), f = !1
				})), Utils.extend(r, {
					app: a,
					$el: n,
					el: n[0],
					...
					setProgress: function(e, t) {
						return a.progressbar.set(n.find(".progressbar"), e, t), r
					},
					setText: function(e) {
						var t = n.find(".dialog-text");
						return 0 === t.length && (t = $$1('<div class="dialog-text"></div>'), void 0 !== i ? t.insertAfter(n.find(".dialog-title")) : n.find(".dialog-inner").prepend(t)), t.html(e), r.params.text = e, r
					},
					setTitle: function(e) {
						var t = n.find(".dialog-title");
						return 0 === t.length && (t = $$1('<div class="dialog-title"></div>'), n.find(".dialog-inner").prepend(t)), t.html(e), r.params.title = e, r
					}
	...
	function ConstructorMethods(e) {
		...
		var i = e.defaultSelector,
			...
			o = {
				...
				get: function(e) {
					if(void 0 === e && (e = i), e instanceof a) return e;
					var t = $$1(e);
	...
	var Dialog$1 = {
			...
			create: function() {
				var c = this,
					s = c.params.dialog.title || c.name,
					d = c.params.dialog.destroyPredefinedDialogs,
				...
				c.dialog = Utils.extend(ModalMethods({
					...
					alert: function() {
						...
						var n = t[0],
							r = t[1],
							i = t[2];
						return 2 === t.length && "function" == typeof t[1] && (n = (e = t)[0], i = e[1], r = e[2]), new Dialog(c, {
							title: void 0 === r ? s : r,
							text: n,
							buttons: [{
		...
		Popup = function(s) {
			function e(e, t) {
				...
				function o(e) {
					var t = e.target;
					0 === $$1(t).closest(i.el).length && i.params && i.params.closeByBackdropClick && i.params.backdrop && i.backdropEl && i.backdropEl === t && i.close()
				}
				return i.params.backdrop && 0 === (r = e.root.children(".popup-backdrop")).length && (r = $$1('<div class="popup-backdrop"></div>'), e.root.append(r)), Utils.extend(i, {
					app: e,
					$el: n,
					el: n[0],
					$backdropEl: r,
		...
		LoginScreen = function(i) {
			function e(e, t) {
				...
				i.call(this, e, a);
				var n, r = this;
				return r.params = a, (n = r.params.el ? $$1(r.params.el) : $$1(r.params.content)) && 0 < n.length && n[0].f7Modal ? n[0].f7Modal : 0 === n.length ? r.destroy() : (Utils.extend(r, {
					app: e,
					$el: n,
					el: n[0],
					type: "loginScreen"
		...
		Popover = function(d) {
			function e(e, t) {
				...
				var n, i = this;
				if(i.params = a, (n = i.params.el ? $$1(i.params.el) : $$1(i.params.content)) && 0 < n.length && n[0].f7Modal) return n[0].f7Modal;
				var r, o, s = $$1(i.params.targetEl).eq(0);
				if(0 === n.length) return i.destroy();
				i.params.backdrop && 0 === (r = e.root.children(".popover-backdrop")).length && (r = $$1('<div class="popover-backdrop"></div>'), e.root.append(r)), 0 === n.find(".popover-angle").length ? (o = $$1('<div class="popover-angle"></div>'), n.prepend(o)) : o = n.find(".popover-angle");
				var l = i.open;
				...
				function c(e) {
					var t = e.target;
					0 === $$1(t).closest(i.el).length && (i.params.closeByBackdropClick && i.params.backdrop && i.backdropEl && i.backdropEl === t ? i.close() : i.params.closeByOutsideClick && i.close())
				}
				return Utils.extend(i, {
					...
					open: function() {
						...
						var n = t[0],
							r = t[1];
						return "boolean" == typeof t[0] && (r = (e = t)[0], n = e[1]), n && (i.$targetEl = $$1(n), i.targetEl = i.$targetEl[0]), l.call(i, r)
					}
				}), i.on("popoverOpen", function() {
					i.resize(), e.on("resize", p), i.on("popoverClose popoverBeforeDestroy", function() {
						e.off("resize", p)
					})
			...
			return d && (e.__proto__ = d), ((e.prototype = Object.create(d && d.prototype)).constructor = e).prototype.resize = function() {
				...
				"md" === t.theme ? (v < t.height - h - d ? (E = "bottom", C = h) : v < h ? (C = h - v + d, E = "top") : (E = "bottom", C = h), C <= 0 ? C = 8 : C + v >= t.height && (C = t.height - v - 8), ($ = u + c - m - 8) + m >= t.width - 8 && ($ = u + c - m - 8), $ < 8 && ($ = 8), "top" === E && a.addClass("popover-on-top"), "bottom" === E && a.addClass("popover-on-bottom")) : (v + g < h ? C = h - v - g : v + g < t.height - h - d ? (E = "bottom", C = h + d + g) : (E = "middle", (x = C = d / 2 + h - v / 2) <= 0 ? C = 5 : C + v >= t.height && (C = t.height - v - 5), x -= C), "top" === E || "bottom" === E ? ((x = $ = c / 2 + u - m / 2) < 5 && ($ = 5), $ + m > t.width && ($ = t.width - m - 5), $ < 0 && ($ = 0), "top" === E && r.addClass("on-bottom"), "bottom" === E && r.addClass("on-top"), l = m / 2 - g + (x -= $), l = Math.max(Math.min(l, m - 2 * g - 13), 13), r.css({
					left: l + "px"
				})) : "middle" === E && ($ = u - m - g, r.addClass("on-right"), ($ < 5 || $ + m > t.width) && ($ < 5 && ($ = u + c + g), $ + m > t.width && ($ = t.width - m - 5), r.removeClass("on-right").addClass("on-left")), p = v / 2 - g + x, p = Math.max(Math.min(p, v - 2 * g - 13), 13), r.css({
					top: p + "px"
				}))), a.css({
					top: C + "px",
					left: $ + "px"
		...
		Actions = function(s) {
			function e(l, e) {
				...
				s.call(this, l, t);
				var i, a, n, p = this;
				if(p.params = t, p.params.buttons && (i = p.params.buttons, Array.isArray(i[0]) || (i = [i])), p.groups = i, p.params.el ? a = $$1(p.params.el) : p.params.content ? a = $$1(p.params.content) : p.params.buttons && (p.params.convertToPopover && (p.popoverHtml = p.renderPopover()), p.actionsHtml = p.render()), a && 0 < a.length && a[0].f7Modal) return a[0].f7Modal;
				if(a && 0 === a.length && !p.actionsHtml && !p.popoverHtml) return p.destroy();
				p.params.backdrop && 0 === (n = l.root.children(".actions-backdrop")).length && (n = $$1('<div class="actions-backdrop"></div>'), l.root.append(n));
				var c, d = p.open,
					r = p.close;

				function u(e) {
					var t, a, n = this;
					if($$1(n).hasClass("item-link") ? (t = $$1(n).parents("li").index(), a = $$1(n).parents(".list").index()) : (t = $$1(n).index(), a = $$1(n).parents(".actions-group").index()), void 0 !== i) {
						var r = i[a][t];
				...
				function o(e) {
					var t = e.target;
					0 === $$1(t).closest(p.el).length && (p.params.closeByBackdropClick && p.params.backdrop && p.backdropEl && p.backdropEl === t ? p.close() : p.params.closeByOutsideClick && p.close())
				}
				return p.open = function(e) {
					var t = !1,
						...
						o = a.targetWidth,
						s = a.targetHeight;
					return p.params.convertToPopover && (n || void 0 !== r && void 0 !== i) && (p.params.forceToPopover || l.device.ios && l.device.ipad || 768 <= l.width) && (t = !0), t && p.popoverHtml ? ((c = l.popover.create({
						...
						targetWidth: o,
						targetHeight: s
					})).open(e), c.once("popoverOpened", function() {
					...
					})) : (p.$el = p.actionsHtml ? $$1(p.actionsHtml) : p.$el, (p.$el[0].f7Modal = p).groups && (p.$el.find(".actions-button").each(function(e, t) {
						$$1(t).on("click", u)
					}), p.once("actionsClosed", function() {
						p.$el.find(".actions-button").each(function(e, t) {
							$$1(t).off("click", u)
						})
					})), p.el = p.$el[0], d.call(p, e)), p
				}, p.close = function(e) {
					return c ? c.close(e) : r.call(p, e), p
				}, Utils.extend(p, {
					app: l,
					$el: a,
					el: a ? a[0] : void 0,
		...
		Sheet = function(i) {
			function e(e, t) {
				...
				i.call(this, e, a);
				var p, n, c, d = this;
				if(d.params = a, (p = d.params.el ? $$1(d.params.el) : $$1(d.params.content)) && 0 < p.length && p[0].f7Modal) return p[0].f7Modal;
				if(0 === p.length) return d.destroy();

				function r(e) {
					var t = e.target;
					0 === $$1(t).closest(d.el).length && (d.params.closeByBackdropClick && d.params.backdrop && d.backdropEl && d.backdropEl === t ? d.close() : d.params.closeByOutsideClick && d.close())
				}
				return d.params.backdrop && 0 === (n = e.root.children(".sheet-backdrop")).length && (n = $$1('<div class="sheet-backdrop"></div>'), e.root.append(n)), d.on("sheetOpen", function() {
					d.params.scrollToEl && function() {
						var e = $$1(d.params.scrollToEl).eq(0);
						if(0 !== e.length && 0 !== (c = e.parents(".page-content")).length) {
							...
							if(r < s) {
								var l = o + s - r;
								i < l + r && (t = l + r - i + n, r === i && (t = p.height()), c.css({
									"padding-bottom": t + "px"
								})), c.scrollTop(l, 300)
							}
						}
		...
		Sheet$1 = {
			...
			create: function() {
				var e = this;
				e.passedParams.sheet && void 0 !== e.passedParams.sheet.backdrop || (e.params.sheet.backdrop = "md" === e.theme), e.sheet = Utils.extend({}, ModalMethods({
					app: e,
					constructor: Sheet,
			...
			clicks: {
				".sheet-open": function(e, t) {
					void 0 === t && (t = {});
					0 < $$1(".sheet-modal.modal-in").length && t.sheet && $$1(t.sheet)[0] !== $$1(".sheet-modal.modal-in")[0] && this.sheet.close(".sheet-modal.modal-in"), this.sheet.open(t.sheet, t.animate)
				},
		...
		Toast = function(c) {
			function e(n, e) {
				...
				var a, i, o = r.params,
					s = o.closeButton,
					l = o.closeTimeout;
				if(r.params.el) a = $$1(r.params.el);
				else {
					var p = r.render();
					a = $$1(p)
				}
		...
		Preloader = {
			...
			show: function(e) {
				...
				if(!Preloader.visible) {
					...
					$$1("html").addClass("with-modal-preloader"), this.root.append('\n      <div class="preloader-backdrop"></div>\n      <div class="preloader-modal">\n        <div class="preloader color-' + e + '">' + t + "</div>\n      </div>\n    "), Preloader.visible = !0
				}
			},
			hide: function() {
				Preloader.visible && ($$1("html").removeClass("with-modal-preloader"), this.root.find(".preloader-backdrop, .preloader-modal").remove(), Preloader.visible = !1)
			}
		},
		Preloader$1 = {
			name: "preloader",
		...
		Progressbar = {
			set: function() {
				...
				return 0 === p.length && (p = $$1("<span></span>"), s.append(p)), p.transition(void 0 !== i ? i : "").transform("translate3d(" + (-100 + l) + "%,0,0)"), s[0]
			},
			show: function() {
				...
				var p, c = $$1(i);
				if(0 !== c.length) return c.hasClass("progressbar") || c.hasClass("progressbar-infinite") ? p = c : 0 === (p = c.children(".progressbar:not(.progressbar-out), .progressbar-infinite:not(.progressbar-out)")).length && (p = $$1('\n          <span class="progressbar' + ("infinite" === l ? "-infinite" : "") + (s ? " color-" + s : "") + ' progressbar-in">\n            ' + ("infinite" === l ? "" : "<span></span>") + "\n          </span>"), c.append(p)), void 0 !== o && r.progressbar.set(p, o), p[0]
			},
			hide: function(e, t) {
				void 0 === t && (t = !0);
				var a, n = $$1(e || this.root);
				if(0 !== n.length) return 0 === (a = n.hasClass("progressbar") || n.hasClass("progressbar-infinite") ? n : n.children(".progressbar, .progressbar-infinite")).length || !a.hasClass("progressbar-in") || a.hasClass("progressbar-out") || a.removeClass("progressbar-in").addClass("progressbar-out").animationEnd(function() {
					t && a.remove()
				}), a
			}
		},
		...
		Sortable = {
			init: function() {
				var l, p, c, d, u, h, f, m, v, g, b, y, n, w, $, C, x, E, k, T, r = this;
				var e = !!r.support.passiveListener && {
					passive: !1,
					capture: !1
				};
				$$1(doc).on(r.touchEvents.start, ".list.sortable .sortable-handler", function(e) {
					l = !(p = !1), c = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, u = $$1(this).parent("li"), n = u.index(), f = u.parents(".sortable");
					var t = u.parents(".list-group");
					t.length && t.parents(f).length && (f = t), h = f.children("ul").children("li"), r.panel && (r.panel.allowOpen = !1), r.swipeout && (r.swipeout.allow = !1)
				}, e), r.on("touchmove:active", function(e) {
					if(l && u) {
						var t = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY;
						if(!p) {
							w = u.parents(".page"), $ = u.parents(".page-content");
							var a = parseInt($.css("padding-top"), 10),
								n = parseInt($.css("padding-bottom"), 10);
							T = $[0].scrollTop, x = w.offset().top + a, C = w.height() - a - n, u.addClass("sorting"), f.addClass("sortable-sorting"), E = u[0].offsetTop, v = u[0].offsetTop, g = u.parent().height() - E - u.height(), m = u[0].offsetHeight, k = u.offset().top
						}
						...
						var i, s = !0;
						d + r + 44 < -v && (s = !1), g < d + r - 44 && (s = !1), b = y = void 0, s && (x + C < k + d + m + 44 && (i = k + d + m + 44 - (x + C)), k + d < x + 44 && (i = k + d - x - 44), i && ($[0].scrollTop += i)), h.each(function(e, t) {
							var a = $$1(t);
							if(a[0] !== u[0]) {
								var n = a[0].offsetTop,
									r = a.height(),
				...
				}), r.on("touchend:passive", function() {
					if(!l || !p) return p = l = !1, void(l && !p && (r.panel && (r.panel.allowOpen = !0), r.swipeout && (r.swipeout.allow = !0)));
					var e, t, a;
					r.panel && (r.panel.allowOpen = !0), r.swipeout && (r.swipeout.allow = !0), h.transform(""), u.removeClass("sorting"), f.removeClass("sortable-sorting"), r.params.sortable.moveElements && (b && u.insertAfter(b), y && u.insertBefore(y)), (b || y) && f.hasClass("virtual-list") && (e = f[0].f7VirtualList, t = u[0].f7VirtualListIndex, a = y ? y[0].f7VirtualListIndex : b[0].f7VirtualListIndex, e && e.moveItem(t, a)), u.trigger("sortable:sort", {
						from: n,
						to: u.index()
					}), r.emit("sortableSort", u[0], {
						from: n,
						to: u.index()
					}), b = y = void 0, p = l = !1
				})
		...
		Swipeout = {
			init: function() {
				var l, p, s, c, d, u, h, f, m, v, g, b, y, w, $, C, x, E, k, T, S, M = this,
					P = {};
				var e = !!M.support.passiveListener && {
					passive: !0
				};
				M.on("touchstart", function(e) {
					if(Swipeout.el) {
						var t = $$1(e.target);
						$$1(Swipeout.el).is(t[0]) || t.parents(".swipeout").is(Swipeout.el) || t.hasClass("modal-in") || 0 < (t.attr("class") || "").indexOf("-backdrop") || t.hasClass("actions-modal") || 0 < t.parents(".actions-modal.modal-in, .dialog.modal-in").length || M.swipeout.close(Swipeout.el)
					}
				}), $$1(doc).on(M.touchEvents.start, "li.swipeout", function(e) {
					Swipeout.allow && (l = !(p = !1), s = void 0, P.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, P.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, c = (new Date).getTime(), u = $$1(this))
				}, e), M.on("touchmove:active", function(e) {
					if(l) {
						var t = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX,
							a = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY;
						if(void 0 === s && (s = !!(s || Math.abs(a - P.y) > Math.abs(t - P.x))), s) l = !1;
						else {
							if(!p) {
								if(0 < $$1(".list.sortable-opened").length) return;
								h = u.find(".swipeout-content"), f = u.find(".swipeout-actions-right"), m = u.find(".swipeout-actions-left"), E = k = C = $ = g = v = null, 0 < m.length && (v = m.outerWidth(), $ = m.children("a"), E = m.find(".swipeout-overswipe")), 0 < f.length && (g = f.outerWidth(), C = f.children("a"), k = f.find(".swipeout-overswipe")), (y = u.hasClass("swipeout-opened")) && (w = 0 < u.find(".swipeout-actions-left.swipeout-actions-opened").length ? "left" : "right"), u.removeClass("swipeout-transitioning"), M.params.swipeout.noFollow || (u.find(".swipeout-actions-opened").removeClass("swipeout-actions-opened"), u.removeClass("swipeout-opened"))
							}
							if(p = !0, e.preventDefault(), d = t - P.x, b = d, y && ("right" === w ? b -= g : b += v), 0 < b && 0 === m.length || b < 0 && 0 === f.length) {
								if(!y) return p = l = !1, h.transform(""), C && 0 < C.length && C.transform(""), void($ && 0 < $.length && $.transform(""));
								b = 0
							}
							var n, r;
							if(b < 0 ? x = "to-left" : 0 < b ? x = "to-right" : x || (x = "to-left"), e.f7PreventSwipePanel = !0, M.params.swipeout.noFollow) return y ? ("right" === w && 0 < d && M.swipeout.close(u), "left" === w && d < 0 && M.swipeout.close(u)) : (d < 0 && 0 < f.length && M.swipeout.open(u, "right"), 0 < d && 0 < m.length && M.swipeout.open(u, "left")), void(p = l = !1);
							if(S = T = !1, 0 < f.length) {
								var i = b;
								r = i / g, i < -g && (i = -g - Math.pow(-i - g, .8), b = i, 0 < k.length && (S = !0)), "to-left" !== x && (i = r = 0), C.each(function(e, t) {
									var a = $$1(t);
									void 0 === t.f7SwipeoutButtonOffset && (a[0].f7SwipeoutButtonOffset = t.offsetLeft), n = t.f7SwipeoutButtonOffset, 0 < k.length && a.hasClass("swipeout-overswipe") && "to-left" === x && (a.css({
										left: (S ? -n : 0) + "px"
									}), S ? a.addClass("swipeout-overswipe-active") : a.removeClass("swipeout-overswipe-active")), a.transform("translate3d(" + (i - n * (1 + Math.max(r, -1))) + "px,0,0)")
								})
							}
							if(0 < m.length) {
								var o = b;
								r = o / v, v < o && (o = v + Math.pow(o - v, .8), b = o, 0 < E.length && (T = !0)), "to-right" !== x && (r = o = 0), $.each(function(e, t) {
									var a = $$1(t);
									void 0 === t.f7SwipeoutButtonOffset && (a[0].f7SwipeoutButtonOffset = v - t.offsetLeft - t.offsetWidth), n = t.f7SwipeoutButtonOffset, 0 < E.length && a.hasClass("swipeout-overswipe") && "to-right" === x && (a.css({
										left: (T ? n : 0) + "px"
									}), T ? a.addClass("swipeout-overswipe-active") : a.removeClass("swipeout-overswipe-active")), 1 < $.length && a.css("z-index", $.length - e), a.transform("translate3d(" + (o + n * (1 - Math.min(r, 1))) + "px,0,0)")
								})
							}
							u.trigger("swipeout", r), M.emit("swipeout", u[0], r), h.transform("translate3d(" + b + "px,0,0)")
						}
					}
				}), M.on("touchend:passive", function() {
					if(l && p) {
						p = l = !1;
						var e, t, a, n, r = (new Date).getTime() - c,
							i = "to-left" === x ? f : m,
							o = "to-left" === x ? g : v;
						if(e = r < 300 && (d < -10 && "to-left" === x || 10 < d && "to-right" === x) || 300 <= r && Math.abs(b) > o / 2 ? "open" : "close", r < 300 && (0 === Math.abs(b) && (e = "close"), Math.abs(b) === o && (e = "open")), "open" === e) {
							Swipeout.el = u[0], u.trigger("swipeout:open"), M.emit("swipeoutOpen", u[0]), u.addClass("swipeout-opened swipeout-transitioning");
							var s = "to-left" === x ? -o : o;
							if(h.transform("translate3d(" + s + "px,0,0)"), i.addClass("swipeout-actions-opened"), t = "to-left" === x ? C : $)
								for(a = 0; a < t.length; a += 1) $$1(t[a]).transform("translate3d(" + s + "px,0,0)");
							S && f.find(".swipeout-overswipe")[0].click(), T && m.find(".swipeout-overswipe")[0].click()
						} else u.trigger("swipeout:close"), M.emit("swipeoutClose", u[0]), Swipeout.el = void 0, u.addClass("swipeout-transitioning").removeClass("swipeout-opened"), h.transform(""), i.removeClass("swipeout-actions-opened");
						$ && 0 < $.length && $ !== t && $.each(function(e, t) {
							var a = $$1(t);
							...
							y && "open" === e || !y && "close" === e || (u.trigger("open" === e ? "swipeout:opened" : "swipeout:closed"), M.emit("open" === e ? "swipeoutOpened" : "swipeoutClosed", u[0]), u.removeClass("swipeout-transitioning"), y && "close" === e && (0 < f.length && C.transform(""), 0 < m.length && $.transform("")))
						})
					} else p = l = !1
				})
			},
			...
			delete: function(e, a) {
				var n = this,
					r = $$1(e).eq(0);
				0 !== r.length && (Swipeout.el = void 0, r.trigger("swipeout:delete"), n.emit("swipeoutDelete", r[0]), r.css({
					...
					} else n.params.swipeout.removeElements ? n.params.swipeout.removeElementsWithTimeout ? setTimeout(function() {
						r.remove()
					}, n.params.swipeout.removeElementsTimeout) : r.remove() : r.removeClass("swipeout-deleting swipeout-transitioning")
				}), r[0]._clientLeft = r[0].clientLeft, r.addClass("swipeout-deleting swipeout-transitioning").css({
					height: "0px"
		...
		Accordion = {
			toggleClicked: function(e) {
				...
				t.length || (t = e.parents("li").eq(0)), 1 < e.parents("li").length && e.parents("li")[0] !== t[0] || this.accordion.toggle(t)
			},
			open: function(e) {
				var t = this,
					a = $$1(e),
				...
				if(r.removeAttr("aria-hidden"), 0 === r.length && (r = a.find(".accordion-item-content")), 0 !== r.length) {
					...
					0 < i.length && t.accordion.close(i), r.transitionEnd(function() {
						a.hasClass("accordion-item-opened") ? (r.transition(0), r.css("height", "auto"), r._clientLeft = r[0].clientLeft, r.transition(""), a.trigger("accordion:opened"), t.emit("accordionOpened", a[0])) : (r.css("height", ""), a.trigger("accordion:closed"), t.emit("accordionClosed", a[0]))
			...
			close: function(e) {
				...
				0 === n.length && (n = a.find(".accordion-item-content")), a.removeClass("accordion-item-opened"), n.attr("aria-hidden", !0), n.transition(0), n.css("height", n[0].scrollHeight + "px"), n._clientLeft = n[0].clientLeft, n.transition(""), n.transitionEnd(function() {
					a.hasClass("accordion-item-opened") ? (n.transition(0), n.css("height", "auto"), n._clientLeft = n[0].clientLeft, n.transition(""), a.trigger("accordion:opened"), t.emit("accordionOpened", a[0])) : (n.css("height", ""), a.trigger("accordion:closed"), t.emit("accordionClosed", a[0]))
				}), Utils.nextFrame(function() {
		...
		VirtualList = function(u) {
			function e(e, t) {
				...
				if(a.useModulesParams(n), a.params = Utils.extend(n, t), void 0 !== a.params.height && a.params.height || (a.params.height = "md" === e.theme ? 48 : 44), a.$el = $$1(t.el), a.el = a.$el[0], 0 !== a.$el.length) {
					...
					var r, i = a.params.ul;
					a.$ul = i ? $$1(a.params.ul) : a.$el.children("ul"), 0 === a.$ul.length && a.params.createUl && (a.$el.append("<ul></ul>"), a.$ul = a.$el.children("ul")), a.ul = a.$ul[0], r = a.ul || a.params.createUl ? a.$ul : a.$el, Utils.extend(a, {
						$itemsWrapEl: r,
						itemsWrapEl: r[0],
						domCache: {},
						displayDomCache: {},
					...
					return a.attachEvents = function() {
						o = a.$el.parents(".page").eq(0), s = a.$el.parents(".tab").eq(0), l = a.$el.parents(".panel").eq(0), p = a.$el.parents(".popup").eq(0), a.$pageContentEl.on("scroll", c), o && o.on("page:reinit", d), s && s.on("tab:show", d), l && l.on("panel:open", d), p && p.on("popup:open", d), e.on("resize", d)
					}, a.detachEvents = function() {
						a.$pageContentEl.off("scroll", c), o && o.off("page:reinit", d), s && s.off("tab:show", d), l && l.off("panel:open", d), p && p.off("popup:open", d), e.off("resize", d)
					}, a.init(), a
				}
			}
			return u && (e.__proto__ = u), ((e.prototype = Object.create(u && u.prototype)).constructor = e).prototype.setListSize = function() {
				...
				var a = 0;
				if(t.dynamicHeight)
					for(var n = 0; n < e; n += 1) a += t.heights[n];
		...
		ListIndex = function($) {
			function e(e, t) {
				...
				if((s = $$1(l.params.el))[0].f7ListIndex) return s[0].f7ListIndex;
				if(0 === (r = s.find("ul")).length && (r = $$1("<ul></ul>"), s.append(r)), l.params.listEl && (a = $$1(l.params.listEl)), "auto" === l.params.indexes && !a) return l;
				...
				a ? n = a.parents(".page-content").eq(0) : 0 === (n = s.siblings(".page-content").eq(0)).length && (n = s.parents(".page").eq(0).find(".page-content").eq(0)), s[0].f7ListIndex = l, Utils.extend(l, {
					app: e,
					$el: s,
					el: s && s[0],
					$ul: r,
				...
				function b(e) {
					if(c) {
						!d && l.params.label && (f = $$1('<span class="list-index-label"></span>'), s.append(f)), d = !0;
						var t = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY;
						e.preventDefault();
						var a = (t - u) / (h - u);
				...
				function y() {
					c && (d = c = !1, l.params.label && (f && f.remove(), f = void 0))
				}
				var w = !!e.support.passiveListener && {
					passive: !0
				};
				return l.attachEvents = function() {
					s.parents(".tab").on("tab:show", o), s.parents(".page").on("page:reinit", o), s.parents(".panel").on("panel:open", o), s.parents(".sheet-modal, .actions-modal, .popup, .popover, .login-screen, .dialog, .toast").on("modal:open", o), e.on("resize", o), s.on("click", p), s.on(e.touchEvents.start, g, w), e.on("touchmove:active", b), e.on("touchend:passive", y)
				}, l.detachEvents = function() {
					s.parents(".tab").off("tab:show", o), s.parents(".page").off("page:reinit", o), s.parents(".panel").off("panel:open", o), s.parents(".sheet-modal, .actions-modal, .popup, .popover, .login-screen, .dialog, .toast").off("modal:open", o), e.off("resize", o), s.off("click", p), s.off(e.touchEvents.start, g, w), e.off("touchmove:active", b), e.off("touchend:passive", y)
				}, l.init(), l
			}
			return $ && (e.__proto__ = $), ((e.prototype = Object.create($ && $.prototype)).constructor = e).prototype.scrollListToIndex = function(n, e) {
				var r, t = this.$listEl,
				...
				var n, r = this,
					...
					a = t.map(function(e, t) {
						if(t % i != 0 && 0 < i) return n = !0, "";
						var a = r.renderItem(e, t);
						return n && (a = r.renderSkipPlaceholder() + a), n = !1, a
					}).join("");
				return e.html(a), r
				...
				var e = this;
				e.$el.trigger("listindex:beforedestroy", e), e.emit("local::beforeDestroy listIndexBeforeDestroy", e), e.detachEvents(), e.$el[0].f7ListIndex = null, delete e.$el[0].f7ListIndex, Utils.deleteProps(e), e = null
			}, e
		}(Framework7Class),
		ListIndex$1 = {
			name: "listIndex",
			...
			on: {
				tabMounted: function(e) {
					var n = this;
					$$1(e).find(".list-index-init").each(function(e, t) {
						var a = Utils.extend($$1(t).dataset(), {
							el: t
						});
			...
			show: function() {
				...
				if(u.parent().hasClass("tabs-swipeable-wrap") && p.swiper) {
					...
					b && b.activeIndex !== d.index() ? (m = !0, b.once("slideChangeTransitionEnd", function() {
						f()
					}).slideTo(d.index(), s ? void 0 : 0)) : b && b.animating && (m = !0, b.once("slideChangeTransitionEnd", function() {
						f()
					}))
				}
				var y = u.children(".tab-active");
				if(y.removeClass("tab-active").trigger("tab:hide"), p.emit("tabHide", y[0]), d.addClass("tab-active").trigger("tab:show"), p.emit("tabShow", d[0]), !c && ((!(c = $$1("string" == typeof i ? '.tab-link[href="' + i + '"]' : '.tab-link[href="#' + d.attr("id") + '"]')) || c && 0 === c.length) && $$1("[data-tab]").each(function(e, t) {
						d.is($$1(t).attr("data-tab")) && (c = $$1(t))
					}), l && (!c || c && 0 === c.length) && 0 === (c = $$1('[data-route-tab-id="' + l.route.tab.id + '"]')).length && (c = $$1('.tab-link[href="' + l.url + '"]')), 1 < c.length && d.parents(".page").length && (c = c.filter(function(e, t) {
						return $$1(t).parents(".page")[0] === d.parents(".page")[0]
					}), "ios" === p.theme && 0 === c.length && l))) {
					var w = d.parents(".page"),
						$ = $$1(p.navbar.getElByPage(w));
					0 === (c = $.find('[data-route-tab-id="' + l.route.tab.id + '"]')).length && (c = $.find('.tab-link[href="' + l.url + '"]'))
				}
				if(0 < c.length) {
					var C;
					if(y && 0 < y.length) {
						var x = y.attr("id");
						x && (!(C = $$1('.tab-link[href="#' + x + '"]')) || C && 0 === C.length) && (C = $$1('.tab-link[data-route-tab-id="' + x + '"]')), (!C || C && 0 === C.length) && $$1("[data-tab]").each(function(e, t) {
							y.is($$1(t).attr("data-tab")) && (C = $$1(t))
						}), (!C || C && 0 === C.length) && (C = c.siblings(".tab-link-active"))
					} else l && (C = c.siblings(".tab-link-active"));
					if(C && 1 < C.length && y && y.parents(".page").length && (C = C.filter(function(e, t) {
							return $$1(t).parents(".page")[0] === y.parents(".page")[0]
						})), C && 0 < C.length && C.removeClass("tab-link-active"), c && 0 < c.length && (c.addClass("tab-link-active"), "md" === p.theme && p.toolbar)) {
						var E = c.parents(".tabbar, .tabbar-labels");
						0 < E.length && p.toolbar.setHighlight(E)
					}
				}
				return {
					$newTabEl: d,
	...
	function swipePanel(i) {
		...
		var t, o, s, l, p, c, d, u, h, f, m, v = r.params.panel,
			g = i.$el,
			b = i.$backdropEl,
			y = i.side,
			w = i.effect,
		...
		function e(e) {
			if(i.swipeable && r.panel.allowOpen && (v.swipe || v.swipeOnlyClose) && !o && !(0 < $$1(".modal-in, .photo-browser-in").length) && (t = r.panel["left" === y ? "right" : "left"] || {}, (i.opened || !t.opened) && (v.swipeCloseOpposite || v.swipeOnlyClose || !t.opened) && (!e.target || "input" !== e.target.nodeName.toLowerCase() || "range" !== e.target.type) && !(0 < $$1(e.target).closest(".range-slider, .tabs-swipeable-wrap, .calendar-months, .no-swipe-panel").length) && ($.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, $.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, (!v.swipeOnlyClose || i.opened) && ("both" === v.swipe || !v.swipeCloseOpposite || v.swipe === y || i.opened)))) {
				if(v.swipeActiveArea && !i.opened) {
					if("left" === y && $.x > v.swipeActiveArea) return;
					if("right" === y && $.x < r.width - v.swipeActiveArea) return
				}
				if(v.swipeCloseActiveAreaSide && i.opened) {
					if("left" === y && $.x < g[0].offsetWidth - v.swipeCloseActiveAreaSide) return;
					if("right" === y && $.x > r.width - g[0].offsetWidth + v.swipeCloseActiveAreaSide) return
				}
				C = 0, m = $$1(i.getViewEl()), o = !(s = !1), l = void 0, p = Utils.now(), f = void 0
			}
		}

		function a(e) {
			if(o && !((C += 1) < 2))
				if(e.f7PreventSwipePanel || r.preventSwipePanelBySwipeBack || r.preventSwipePanel) o = !1;
				else {
					var t = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX,
						a = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY;
					if(void 0 === l && (l = !!(l || Math.abs(a - $.y) > Math.abs(t - $.x))), l) o = !1;
					else {
						if(!f) {
							if(f = t > $.x ? "to-right" : "to-left", "both" === v.swipe && 0 < v.swipeActiveArea && !i.opened) {
								if("left" === y && $.x > v.swipeActiveArea) return void(o = !1);
								if("right" === y && $.x < r.width - v.swipeActiveArea) return void(o = !1)
							}
							if(g.hasClass("panel-visible-by-breakpoint")) return void(o = !1);
							if("left" === y && "to-left" === f && !g.hasClass("panel-active") || "right" === y && "to-right" === f && !g.hasClass("panel-active")) return void(o = !1)
						}
						if(v.swipeNoFollow) return(new Date).getTime() - p < 300 && ("to-left" === f && ("right" === y && r.panel.open(y), "left" === y && g.hasClass("panel-active") && r.panel.close()), "to-right" === f && ("left" === y && r.panel.open(y), "right" === y && g.hasClass("panel-active") && r.panel.close())), void(s = o = !1);
						s || (i.opened || (g.show(), b.show(), g.trigger("panel:swipeopen", i), i.emit("local::swipeOpen panelSwipeOpen", i)), h = g[0].offsetWidth, g.transition(0)), s = !0, e.preventDefault();
						var n = i.opened ? 0 : -v.swipeThreshold;
						"right" === y && (n = -n), c = t - $.x + n, "right" === y ? "cover" === w ? ((d = c + (i.opened ? 0 : h)) < 0 && (d = 0), h < d && (d = h)) : (0 < (d = c - (i.opened ? h : 0)) && (d = 0), d < -h && (d = -h)) : ((d = c + (i.opened ? h : 0)) < 0 && (d = 0), h < d && (d = h)), "reveal" === w ? (m.transform("translate3d(" + d + "px,0,0)").transition(0), b.transform("translate3d(" + d + "px,0,0)").transition(0)) : ("left" === y && (d -= h), g.transform("translate3d(" + d + "px,0,0)").transition(0), b.transition(0), u = 1 - Math.abs(d / h), b.css({
							opacity: u
						})), g.trigger("panel:swipe", i, Math.abs(d / h)), i.emit("local::swipe panelSwipe", i, Math.abs(d / h))
					}
				}
		}
		...
		function n() {
			if(o && s) {
				s = o = !1;
				var e, t = (new Date).getTime() - p,
					a = 0 === d || Math.abs(d) === h,
					n = v.swipeThreshold || 0;
				if("swap" === (e = i.opened ? "cover" === w ? 0 === d ? "reset" : t < 300 && 0 < Math.abs(d) ? "swap" : 300 <= t && Math.abs(d) < h / 2 ? "reset" : "swap" : d === -h ? "reset" : t < 300 && 0 <= Math.abs(d) || 300 <= t && Math.abs(d) <= h / 2 ? "left" === y && d === h ? "reset" : "swap" : "reset" : Math.abs(c) < n ? "reset" : "cover" === w ? 0 === d ? "swap" : t < 300 && 0 < Math.abs(d) ? "swap" : 300 <= t && Math.abs(d) < h / 2 ? "swap" : "reset" : 0 === d ? "reset" : t < 300 && 0 < Math.abs(d) || 300 <= t && Math.abs(d) >= h / 2 ? "swap" : "reset") && (i.opened ? i.close(!a) : i.open(!a)), "reset" === e && !i.opened)
					if(a) g.css({
						...
						var r = "reveal" === w ? m : g;
						$$1("html").addClass("with-panel-transitioning"), r.transitionEnd(function() {
				...
				"reveal" === w && Utils.nextFrame(function() {
					m.transition(""), m.transform("")
				}), g.transition("").transform(""), b.css({
					display: ""
				}).transform("").transition("").css("opacity", "")
			} else s = o = !1
		}
		r.on("touchstart:passive", e), r.on("touchmove:active", a), r.on("touchend:passive", n), i.on("panelDestroy", function() {
			r.off("touchstart:passive", e), r.off("touchmove:active", a), r.off("touchend:passive", n)
		})
	}
	var Panel = function(l) {
			function e(e, t) {
				var a;
				void 0 === t && (t = {}), l.call(this, t, [e]);
				var n = $$1(t.el);
				if(0 === n.length) return this;
				if(n[0].f7Panel) return n[0].f7Panel;
				n[0].f7Panel = this;
				var r = t.opened,
					i = t.side,
					o = t.effect;
				void 0 === r && (r = n.hasClass("panel-active")), void 0 === i && (i = n.hasClass("panel-left") ? "left" : "right"), void 0 === o && (o = n.hasClass("panel-cover") ? "cover" : "reveal"), e.panel[i] || Utils.extend(e.panel, ((a = {})[i] = this, a));
				var s = $$1(".panel-backdrop");
				return 0 === s.length && (s = $$1('<div class="panel-backdrop"></div>')).insertBefore(n), Utils.extend(this, {
					app: e,
					side: i,
					effect: o,
					$el: n,
			...
			return l && (e.__proto__ = l), ((e.prototype = Object.create(l && l.prototype)).constructor = e).prototype.init = function() {
				var e = this.app;
				...
				var n = a.side,
					...
					i = a.$el,
					o = a.$backdropEl;
				if(a.opened || i.hasClass("panel-visible-by-breakpoint") || i.hasClass("panel-active")) return !1;
				t.panel.close("left" === n ? "right" : "left", e), t.panel.allowOpen = !1, i[e ? "removeClass" : "addClass"]("not-animated"), i.css({
					display: "block"
				}).addClass("panel-active"), o[e ? "removeClass" : "addClass"]("not-animated"), o.show(), a._clientLeft = i[0].clientLeft, $$1("html").addClass("with-panel with-panel-" + n + "-" + r), a.onOpen();
				var s = "reveal" === r ? i.nextAll(".view, .views").eq(0) : i;
				return e ? function t() {
					s.transitionEnd(function(e) {
						$$1(e.target).is(s) ? (i.hasClass("panel-active") ? a.onOpened() : a.onClosed(), o.css({
							display: ""
						})) : t()
					})
				}() : (a.onOpened(), o.css({
				...
				return t.onClose(), a.panel.allowOpen = !1, e ? (s.transitionEnd(function() {
					i.hasClass("panel-active") || (i.css({
						display: ""
					}), $$1("html").removeClass("with-panel-transitioning"), t.onClosed())
				}), $$1("html").removeClass("with-panel with-panel-" + n + "-" + r).addClass("with-panel-transitioning")) : (i.css({
					display: ""
				}), i.removeClass("not-animated"), $$1("html").removeClass("with-panel with-panel-transitioning with-panel-" + n + "-" + r), t.onClosed()), !0
		...
		Panel$1 = {
			...
			create: function() {
				...
				Utils.extend(r.panel, {
					disableSwipe: function(e) {
						...
						void 0 === e && (e = "both");
						var a = [];
						"string" == typeof e ? "both" === e ? (t = "both", a = [r.panel.left, r.panel.right]) : (t = e, a.push(r.panel[t])) : a = [e], a.forEach(function(e) {
							e && Utils.extend(e, {
								swipeable: !1
							})
						})
					...
					enableSwipe: function(e) {
						void 0 === e && (e = "both");
						var t, a = [];
						"string" == typeof e ? (t = e, "left" === r.params.panel.swipe && "right" === t || "right" === r.params.panel.swipe && "left" === t || "both" === t ? (t = "both", r.params.panel.swipe = t, a = [r.panel.left, r.panel.right]) : (r.params.panel.swipe = t, a.push(r.panel[t]))) : e && a.push(e), a.length && a.forEach(function(e) {
					...
					close: function(e, t) {
						var a, n;
						return n ? a = $$1(".panel-" + (n = e)) : n = (a = $$1(".panel.panel-active")).hasClass("panel-left") ? "left" : "right", !!n && (r.panel[n] ? r.panel[n].close(t) : 0 < a.length && r.panel.create({
							el: a
						}).close(t))
					},
					get: function(e) {
						var t = e;
						if(!t) {
							if(1 < $$1(".panel").length) return;
							t = $$1(".panel").hasClass("panel-left") ? "left" : "right"
						}
						if(t) {
							if(r.panel[t]) return r.panel[t];
							var a = $$1(".panel-" + t);
			...
			on: {
				init: function() {
					var n = this;
					$$1(".panel").each(function(e, t) {
						var a = $$1(t).hasClass("panel-left") ? "left" : "right";
			...
			clicks: {
				".panel-open": function(e, t) {
					void 0 === t && (t = {});
					var a = "left";
					("right" === t.panel || 1 === $$1(".panel").length && $$1(".panel").hasClass("panel-right")) && (a = "right"), this.panel.open(a, t.animate)
				},
			...
			return o.find("input, select, textarea").each(function(e, t) {
				...
				if(!a.hasClass("ignore-store-data") && !a.hasClass("no-store-data")) {
					...
					if(!(0 <= l.indexOf(r)) && !(0 <= p.indexOf(n)) && n)
						if("select" === i && a.prop("multiple")) p.push(n), s[n] = [], o.find('select[name="' + n + '"] option').each(function(e, t) {
							t.selected && s[n].push(t.value)
						});
						else switch(r) {
							case "checkbox":
								p.push(n), s[n] = [], o.find('input[name="' + n + '"]').each(function(e, t) {
	...
	function initAjaxForm() {
		var l = this;
		$$1(doc).on("submit change", "form.form-ajax-submit, form.form-ajax-submit-onchange", function(e, t) {
			var a = $$1(this);
			if(("change" !== e.type || a.hasClass("form-ajax-submit-onchange")) && ("submit" === e.type && e.preventDefault(), "change" !== e.type || "fromdata" !== t)) {
				var n = (a.attr("method") || "GET").toUpperCase(),
					r = a.prop("enctype") || a.attr("enctype"),
					i = a.attr("action");
				if(i) {
					var o;
					o = "POST" === n ? "application/x-www-form-urlencoded" === r ? l.form.convertToData(a[0]) : new win.FormData(a[0]) : Utils.serializeObject(l.form.convertToData(a[0]));
					var s = l.request({
						method: n,
						url: i,
						contentType: r,
						data: o,
						beforeSend: function() {
							a.trigger("formajax:beforesend", o, s), l.emit("formAjaxBeforeSend", a[0], o, s)
						},
						error: function() {
							a.trigger("formajax:error", o, s), l.emit("formAjaxError", a[0], o, s)
						},
						complete: function() {
							a.trigger("formajax:complete", o, s), l.emit("formAjaxComplete", a[0], o, s)
						},
						success: function() {
							a.trigger("formajax:success", o, s), l.emit("formAjaxSuccess", a[0], o, s)
						}
					})
				}
			}
	...
	var Form = {
			...
			on: {
				...
				tabBeforeRemove: function(e) {
					var a = this;
					$$1(e).find(".form-store-data").each(function(e, t) {
		...
		Input = {
			...
			resizeTextarea: function(e) {
				...
				if(t.length && t.hasClass("resizable")) {
					...
					r !== o && (i < o ? (t.css("height", o + "px"), t.trigger("textarea:resize", {
						initialHeight: i,
						currentHeight: r,
						scrollHeight: o
				...
				if(t.length) {
					...
					if(r)
						if(r.valid) a.removeClass("item-input-invalid item-input-with-error-message"), n.removeClass("input-invalid input-with-error-message"), t.removeClass("input-invalid");
							...
							i && (0 === o.length && (o = $$1('<div class="' + (n.length ? "input-error-message" : "item-input-error-message") + '"></div>')).insertAfter(t), o.text(i)), 0 < o.length && (a.addClass("item-input-with-error-message"), n.addClass("input-with-eror-message")), a.addClass("item-input-invalid"), n.addClass("input-invalid"), t.addClass("input-invalid")
						}
				}
			},
			validateInputs: function(e) {
				var a = this;
				$$1(e).find("input, textarea, select").each(function(e, t) {
					a.input.validate(t)
				})
			},
			focus: function(e) {
			...
			init: function() {
				var n = this;
				Input.createTextareaResizableShadow(), $$1(doc).on("click", ".input-clear-button", function() {
					var e = $$1(this).siblings("input, textarea").eq(0),
						t = e.val();
					e.val("").trigger("change input").focus().trigger("input:clear", t)
				}), $$1(doc).on("change input", "input, textarea, select", function() {
					var e = $$1(this),
						t = e.attr("type"),
				...
				}, !0), $$1(doc).on("focus", "input, textarea, select", function() {
					var e = this;
					n.params.input.scrollIntoViewOnFocus && (Device.android ? $$1(win).once("resize", function() {
					...
					}) : n.input.scrollIntoView(e, n.params.input.scrollIntoViewDuration, n.params.input.scrollIntoViewCentered, n.params.input.scrollIntoViewAlways)), n.input.focus(e)
				}, !0), $$1(doc).on("blur", "input, textarea, select", function() {
					var e = $$1(this),
				...
				}, !0), $$1(doc).on("invalid", "input, textarea, select", function(e) {
					var t = $$1(this);
			...
			on: {
				...
				tabMounted: function(e) {
					...
					t.find(".item-input, .input").each(function(e, t) {
						$$1(t).find("input, select, textarea").each(function(e, t) {
							var a = $$1(t);
		...
		Toggle = function(b) {
			function e(i, e) {
				...
				Utils.extend(o, {
					...
					configurable: !0,
					set: function(e) {
						o && void 0 !== o.$inputEl && o.checked !== e && (r[0].checked = e, o.$inputEl.trigger("change"))
					},
					get: function() {
						return r[0].checked
					}
				...
				function f(e) {
					s || o.disabled || (h.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, h.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, s = !(p = 0), l = void 0, d = Utils.now(), u = o.checked, c = n[0].offsetWidth, Utils.nextTick(function() {
				...
				function g() {
					o.$el.trigger("toggle:change", o), o.emit("local::change toggleChange", o)
				}
			...
			return b && (e.__proto__ = b), ((e.prototype = Object.create(b && b.prototype)).constructor = e).prototype.toggle = function() {
		...
		Toggle$1 = {
			...
			on: {
				tabMounted: function(e) {
					var a = this;
					$$1(e).find(".toggle-init").each(function(e, t) {
		...
		Range = function(I) {
			function e(t, a) {
				...
				}), o.params.value || (void 0 !== s.value && (o.params.value = s.value), void 0 !== s.valueLeft && void 0 !== s.valueRight && (o.params.value = [parseFloat(s.valueLeft), parseFloat(s.valueRight)])), o.params.dual || (o.params.inputEl ? i = $$1(o.params.inputEl) : r.find('input[type="range"]').length && (i = r.find('input[type="range"]').eq(0)));
				var l = o.params,
					p = l.dual,
					c = l.step,
					d = l.label,
				...
				Utils.extend(o, {
					...
					!a[e] && i.attr(e) && (o.params[e] = parseFloat(i.attr(e)), o[e] = parseFloat(i.attr(e)))
				}), void 0 !== i.val() && (o.params.value = parseFloat(i.val()), o.value = parseFloat(i.val()))), o.dual && r.addClass("range-slider-dual"), o.label && r.addClass("range-slider-label");
				var m = $$1('<div class="range-bar"></div>'),
					v = $$1('<div class="range-bar-active"></div>');
				m.append(v);
				var g, b = '\n      <div class="range-knob-wrap">\n        <div class="range-knob"></div>\n        ' + (o.label ? '<div class="range-knob-label"></div>' : "") + "\n      </div>\n    ",
					y = [$$1(b)],
					w = [];
				o.dual && y.push($$1(b)), r.append(m), y.forEach(function(e) {
					r.append(e)
				}), o.label && (w.push(y[0].find(".range-knob-label")), o.dual && w.push(y[1].find(".range-knob-label"))), Utils.extend(o, {
					app: t,
					knobs: y,
					labels: w,
					$barEl: m,
				...
				function M(e) {
					if(!g && (o.params.draggableBar || 0 !== $$1(e.target).closest(".range-knob").length)) {
						var t;
						k = !1, T.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, T.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, g = !0, $ = void 0, C = r.offset().left;
						var a = (t = o.app.rtl ? (C + o.rangeWidth - T.x) / o.rangeWidth : (T.x - C) / o.rangeWidth) * (o.max - o.min) + o.min;
						o.dual ? Math.abs(o.value[0] - a) < Math.abs(o.value[1] - a) ? (E = 0, x = o.knobs[0], a = [a, o.value[1]]) : (E = 1, x = o.knobs[1], a = [o.value[0], a]) : (x = o.knobs[0], a = t * (o.max - o.min) + o.min), Utils.nextTick(function() {
							g && x.addClass("range-knob-active-state")
						}, 70), o.on("change", S), o.setValue(a, !0)
					}
				}
				...
				function P(e) {
					if(g) {
						var t = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX,
							a = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY;
						if(void 0 === $ && ($ = !!($ || Math.abs(a - T.y) > Math.abs(t - T.x))), $) g = !1;
						else {
							e.preventDefault();
							var n, r, i = (o.app.rtl ? (C + o.rangeWidth - t) / o.rangeWidth : (t - C) / o.rangeWidth) * (o.max - o.min) + o.min;
							if(o.dual) 0 === E ? (n = i, (r = o.value[1]) < n && (r = n)) : (r = i) < (n = o.value[0]) && (n = r), i = [n, r];
							o.setValue(i, !0)
						}
					}
				}
				...
				function O() {
					if(!g) return $ && x.removeClass("range-knob-active-state"), void(g = !1);
					o.off("change", S), g = !1, x.removeClass("range-knob-active-state"), k && o.$inputEl && !o.dual && o.$inputEl.trigger("change"), k = !1, void 0 !== o.previousValue && (o.dual && (o.previousValue[0] !== o.value[0] || o.previousValue[1] !== o.value[1]) || !o.dual && o.previousValue !== o.value) && (o.$el.trigger("range:changed", o, o.value), o.emit("local::changed rangeChanged", o, o.value))
				}
				...
				return o.attachEvents = function() {
					...
					o.$el.on(t.touchEvents.start, M, e), t.on("touchmove", P), t.on("touchend:passive", O), t.on("tabShow", D), t.on("resize", D), o.$el.parents(".sheet-modal, .actions-modal, .popup, .popover, .login-screen, .dialog, .toast").on("modal:open", D), o.$el.parents(".panel").on("panel:open", D)
				}, o.detachEvents = function() {
					var e = !!Support.passiveListener && {
						passive: !0
					};
					o.$el.off(t.touchEvents.start, M, e), t.off("touchmove", P), t.off("touchend:passive", O), t.off("tabShow", D), t.off("resize", D), o.$el.parents(".sheet-modal, .actions-modal, .popup, .popover, .login-screen, .dialog, .toast").off("modal:open", D), o.$el.parents(".panel").off("panel:open", D)
				}, o.useModules(), o.init(), o
			}
			return I && (e.__proto__ = I), ((e.prototype = Object.create(I && I.prototype)).constructor = e).prototype.calcSize = function() {
				...
				if(r.dual) {
					...
					if(Array.isArray(l) || (l = [e, e]), e[0] > e[1] && (l = [l[0], l[0]]), (l = l.map(function(e) {
						...
						}))[0] === r.value[0] && l[1] === r.value[1]) return r;
					l.forEach(function(e, t) {
						r.value[t] = e
					}), a = n[0] !== l[0] || n[1] !== l[1], r.layout()
				} else {
					n = r.value;
		...
		Range$1 = {
			...
			on: {
				tabMounted: function(e) {
					var a = this;
					$$1(e).find(".range-slider-init").each(function(e, t) {
						return new Range(a, {
							el: t
						})
					})
		...
		Stepper = function(B) {
			function e(e, t) {
				...
				if(a.params.inputEl ? i = $$1(a.params.inputEl) : s.find(".stepper-input-wrap").find("input, textarea").length && (i = s.find(".stepper-input-wrap").find("input, textarea").eq(0)), i && i.length) {
				...
				a.params.valueEl ? o = $$1(a.params.valueEl) : s.find(".stepper-value").length && (o = s.find(".stepper-value").eq(0));
				...
				function S(e) {
					b || (T || ($$1(e.target).closest(c).length ? E = "increment" : $$1(e.target).closest(d).length && (E = "decrement"), E && (x.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, x.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, b = !0, y = void 0, function e(t, a, n, r, i, o) {
						clearTimeout(C), C = setTimeout(function() {
							1 === t && (k = w = !0), clearInterval($), o(), $ = setInterval(function() {
								o()
							}, i), t < a && e(t + 1, a, n, r, i / 2, o)
						}, 1 === t ? n : r)
				...
				function M(e) {
					if(b && !T) {
						var t = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX,
							a = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY;
						void 0 !== y || k || (y = !!(y || Math.abs(a - x.y) > Math.abs(t - x.x)));
						var n = Math.pow(Math.pow(t - x.x, 2) + Math.pow(a - x.y, 2), .5);
						(y || 20 < n) && (b = !1, clearTimeout(C), clearInterval($))
					}
				}

				function P() {
					clearTimeout(C), clearInterval($), E = null, b = k = !1
				}

				function O() {
					T ? a.params.buttonsEndInputMode && (T = !1, a.endTypeMode(!0)) : w ? w = !1 : a.decrement(!0)
				}

				function D() {
					T ? a.params.buttonsEndInputMode && (T = !1, a.endTypeMode(!0)) : w ? w = !1 : a.increment(!0)
				}

				function I(e) {
					!e.target.readOnly && a.params.manualInputMode && (T = !0, "number" == typeof e.target.selectionStart && (e.target.selectionStart = e.target.value.length, e.target.selectionEnd = e.target.value.length))
				}

				function L(e) {
					13 !== e.keyCode && 13 !== e.which || (e.preventDefault(), T = !1, a.endTypeMode())
				}
				...
				return a.attachEvents = function() {
					d.on("click", O), c.on("click", D), a.params.watchInput && i && i.length && (i.on("input", z), i.on("click", I), i.on("blur", A), i.on("keyup", L)), a.params.autorepeat && (e.on("touchstart:passive", S), e.on("touchmove:active", M), e.on("touchend:passive", P))
				}, a.detachEvents = function() {
					d.off("click", O), c.off("click", D), a.params.watchInput && i && i.length && (i.off("input", z), i.off("click", I), i.off("blur", A), i.off("keyup", L))
				}, a.useModules(), a.init(), a
			}
			return B && (e.__proto__ = B), ((e.prototype = Object.create(B && B.prototype)).constructor = e).prototype.minus = function() {
				...
				return t.$inputEl && t.$inputEl.length && (t.$inputEl.val(i), t.$inputEl.trigger("input change", {
					sentByF7Stepper: !0
				}), e || t.$inputEl.blur()), t.$valueEl && t.$valueEl.length && t.$valueEl.html(i), t.emit("local::change stepperChange", t, t.value), t
				...
				return a.lastIndexOf(".") !== a.indexOf(".") || a.lastIndexOf(",") !== a.indexOf(",") ? (a = a.slice(0, -1), t.value = a, t.$inputEl.val(t.value)) : (t.value = a, t.$inputEl.val(a)), t
			}, e.prototype.getValue = function() {
				return this.value
		...
		Stepper$1 = {
			...
			on: {
				tabMounted: function(e) {
					var n = this;
					$$1(e).find(".stepper-init").each(function(e, t) {
						var a = $$1(t).dataset();
		...
		SmartSelect = function(m) {
			function e(e, t) {
				void 0 === t && (t = {}), m.call(this, t, [e]);
				var o = this;
				o.app = e;
				var a = Utils.extend({
						on: {}
				...
				if(0 === r.length) return o;
				var i = $$1(t.valueEl);
				0 === i.length && (i = n.find(".item-after")), 0 === i.length && (i = $$1('<div class="item-after"></div>')).insertAfter(n.find(".item-title")), o.useModulesParams(a);
				var s = t.view;
				if(s || (s = n.parents(".view").length && n.parents(".view")[0].f7View), !s && ("page" === t.openIn || "page" !== t.openIn && !0 === t.routableModals)) throw Error("Smart Select requires initialized View");
				var l = t.url;
				l || (l = n.attr("href") && "#" !== n.attr("href") ? n.attr("href") : r.attr("name").toLowerCase() + "-select/"), l || (l = o.params.url);
				var p = r[0].multiple,
					c = p ? "checkbox" : "radio",
					d = Utils.now();
				...
				function f() {
					...
					if("checkbox" === this.type) {
						for(var i = 0; i < o.selectEl.options.length; i += 1)(e = o.selectEl.options[i]).value === n && (e.selected = this.checked), e.selected && (t = (a = e.dataset ? e.dataset.displayAs : $$1(e).data("display-value-as")) && void 0 !== a ? a : e.textContent, r.push(t.trim()));
						o.maxLength && o.checkMaxLength()
					} else r = [t = (a = (e = o.$selectEl.find('option[value="' + n + '"]')[0]).dataset ? e.dataset.displayAs : $$1(e).data("display-as")) && void 0 !== a ? a : e.textContent], o.selectEl.value = n;
					o.$selectEl.trigger("change"), o.$valueEl.text(r.join(", ")), o.params.closeOnSelect && "radio" === o.inputType && o.close()
				}
				return Utils.extend(o, {
					params: Utils.extend(a, t),
					$el: n,
					el: n[0],
					$selectEl: r,
					selectEl: r[0],
					...
					n.on("click", u), n.on("change", "select", h)
				}, o.detachEvents = function() {
					n.off("click", u), n.off("change", "select", h)
				}, o.attachInputsEvents = function() {
					o.$containerEl.on("change", 'input[type="checkbox"], input[type="radio"]', f)
				}, o.detachInputsEvents = function() {
					o.$containerEl.off("change", 'input[type="checkbox"], input[type="radio"]', f)
				}, o.useModules(), o.init(), o
			}
			return m && (e.__proto__ = m), ((e.prototype = Object.create(m && m.prototype)).constructor = e).prototype.checkMaxLength = function() {
				var e = this.$containerEl;
				this.selectEl.selectedOptions.length >= this.maxLength ? e.find('input[type="checkbox"]').each(function(e, t) {
					t.checked ? $$1(t).parents("li").removeClass("disabled") : $$1(t).parents("li").addClass("disabled")
				...
				var a = this,
					n = a.app,
					r = $$1(t);
				if(a.$containerEl = r, a.openedIn = e, a.opened = !0, a.params.virtualList && (a.vl = n.virtualList.create({
					...
					"page" === e && "ios" === n.theme && (i = $$1(n.navbar.getElByPage(r)).find(".searchbar")), a.searchbar = n.searchbar.create({
						el: i,
				...
				}) : t.modal = t.app.popup.create(e).open(), t
				...
				}) : t.modal = t.app.sheet.create(e).open(), t
				...
				}) : t.modal = t.app.popover.create(e).open(), t
			}, e.prototype.open = function(e) {
		...
		SmartSelect$1 = {
			...
			on: {
				tabMounted: function(e) {
					var a = this;
					$$1(e).find(".smart-select-init").each(function(e, t) {
	...
	function jalCal(e) {
		...
		return c = c + 8 * div(i = e - d, 33) + div(mod(i, 33) + 3, 4), 4 === mod(a, 33) && a - i == 4 && (c += 1), r = 20 + c - (div(p, 4) - div(3 * (div(p, 100) + 1), 4) - 150), a - i < 6 && (i = i - a + 33 * div(a + 4, 33)), -1 === (n = mod(mod(i + 1, 33) - 1, 4)) && (n = 4), {
			leap: n,
			gy: p,
			march: r
		}
	...
	function d2g(e) {
		var t, a, n, r;
		return n = div(mod(a = 5 * div(mod(t = (t = 4 * e + 139361631) + 4 * div(3 * div(4 * e + 183187720, 146097), 4) - 3908, 1461), 4) + 308, 153), 5) + 1, r = mod(div(a, 153), 12) + 1, {
	...
	function fixDate(e, t, a) {
		for(11 < t && (e += Math.floor(t / 12), t %= 12); t < 0;) e -= 1, t += 12;
	...
	var methods = ["getHours", "getMilliseconds", "getMinutes", "getSeconds", "getTime", "getTimezoneOffset", "getUTCDate", "getUTCDay", "getUTCFullYear", "getUTCHours", "getUTCMilliseconds", "getUTCMinutes", "getUTCMonth", "getUTCSeconds", "now", "parse", "setHours", "setMilliseconds", "setMinutes", "setSeconds", "setTime", "setUTCDate", "setUTCFullYear", "setUTCHours", "setUTCMilliseconds", "setUTCMinutes", "setUTCMonth", "setUTCSeconds", "toDateString", "toISOString", "toJSON", "toLocaleDateString", "toLocaleTimeString", "toLocaleString", "toTimeString", "toUTCString", "UTC", "valueOf"],
		...
		IDate = function(i) {
			function o() {
				...
				this.jdate = [r.jy, r.jm - 1, r.jd], methods.forEach(function(t) {
			...
			return i && (o.__proto__ = i), ((o.prototype = Object.create(i && i.prototype)).constructor = o).prototype.getFullYear = function() {
				return this.jdate[0]
		...
		Calendar = function(p) {
			function e(k, t) {
				void 0 === t && (t = {}), p.call(this, t, [k]);
				var e, a, n, T = this;
				if(T.params = Utils.extend({}, k.params.calendar, t), "jalali" === T.params.calendarType && Object.keys(T.params.jalali).forEach(function(e) {
						t[e] || (T.params[e] = T.params.jalali[e])
					}), "jalali" === T.params.calendarType ? T.DateHandleClass = IDate : T.DateHandleClass = Date, T.params.containerEl && 0 === (e = $$1(T.params.containerEl)).length) return T;
				T.params.inputEl && (a = $$1(T.params.inputEl)), a && (n = a.parents(".view").length && a.parents(".view")[0].f7View), n || (n = k.views.main);
				...
				function l(e) {
					var t = $$1(e.target);
					T.isPopover() || T.opened && !T.closing && (t.closest('[class*="backdrop"]').length || (a && 0 < a.length ? t[0] !== a[0] && 0 === t.closest(".sheet-modal, .calendar-modal").length && T.close() : 0 === $$1(e.target).closest(".sheet-modal, .calendar-modal").length && T.close()))
				}
				return r && (i = k.rtl ? -1 : 1), Utils.extend(T, {
					app: k,
					$containerEl: e,
					containerEl: e && e[0],
					inline: e && 0 < e.length,
					...
					attachInputEvents: function() {
						T.$inputEl.on("click", o), T.params.inputReadOnly && T.$inputEl.on("focus mousedown", s)
					},
					detachInputEvents: function() {
						T.$inputEl.off("click", o), T.params.inputReadOnly && T.$inputEl.off("focus mousedown", s)
					},
					...
					function v(e) {
						n || a || (a = !0, r = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, o = r, i = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, s = i, t = (new T.DateHandleClass).getTime(), f = !(d = 0), h = void 0, l = T.monthsTranslate)
					}
					...
					function b() {
						a && n ? (n = a = !1, (new T.DateHandleClass).getTime() - t < 300 ? Math.abs(u) < 10 ? T.resetMonth() : 10 <= u ? k.rtl ? T.nextMonth() : T.prevMonth() : k.rtl ? T.prevMonth() : T.nextMonth() : d <= -.5 ? k.rtl ? T.prevMonth() : T.nextMonth() : .5 <= d ? k.rtl ? T.nextMonth() : T.prevMonth() : T.resetMonth(), setTimeout(function() {
							f = !0
						}, 100)) : n = a = !1
					}
					...
					function y(e) {
						if(f) {
							...
							if(0 === t.length && $$1(e.target).hasClass("calendar-day") && (t = $$1(e.target)), 0 !== t.length && !t.hasClass("calendar-day-disabled")) {
					...
					var E = !("touchstart" !== k.touchEvents.start || !k.support.passiveListener) && {
						passive: !0,
						capture: !1
					};
					e.find(".calendar-prev-month-button").on("click", $), e.find(".calendar-next-month-button").on("click", w), e.find(".calendar-prev-year-button").on("click", x), e.find(".calendar-next-year-button").on("click", C), m.on("click", y), T.params.touchMove && (m.on(k.touchEvents.start, v, E), k.on("touchmove:active", g), k.on("touchend:passive", b)), T.detachCalendarEvents = function() {
						e.find(".calendar-prev-month-button").off("click", $), e.find(".calendar-next-month-button").off("click", w), e.find(".calendar-prev-year-button").off("click", x), e.find(".calendar-next-year-button").off("click", C), m.off("click", y), T.params.touchMove && (m.off(k.touchEvents.start, v, E), k.off("touchmove:active", g), k.off("touchend:passive", b))
					}
				}, T.init(), T
			}
			return p && (e.__proto__ = p), ((e.prototype = Object.create(p && p.prototype)).constructor = e).prototype.normalizeDate = function(e) {
				...
				} else r ? (t.value || (t.value = []), 2 !== t.value.length && 0 !== t.value.length || (t.value = []), 0 === t.value.length || Math.abs(t.value[0].getTime() - e.getTime()) >= 60 * (i - 1) * 60 * 24 * 1e3 && (0 === o || Math.abs(t.value[0].getTime() - e.getTime()) <= 60 * (o - 1) * 60 * 24 * 1e3) ? t.value.push(e) : t.value = [], t.value.sort(function(e, t) {
					return e - t
				...
				n.transition(0).html("" + i + o + s).transform("translate3d(0,0,0)"), a.$months = n.find(".calendar-month"), a.monthsTranslate = 0, a.setMonthsTranslate(), a.$months.each(function(e, t) {
				...
				if(a.maxDate && l > new t.DateHandleClass(a.maxDate).getTime()) t.resetMonth();
					...
					if(t.monthsTranslate -= 1, o === t.currentMonth) {
						var c = 100 * -t.monthsTranslate * r,
							d = $$1(t.renderMonth(l, "next")).transform("translate3d(" + (i ? c : 0) + "%, " + (i ? 0 : c) + "%, 0)").addClass("calendar-month-next");
				...
				if(t.monthsTranslate += 1, o === t.currentMonth) {
					var d = 100 * -t.monthsTranslate * r,
						u = $$1(t.renderMonth(l, "prev")).transform("translate3d(" + (i ? d : 0) + "%, " + (i ? 0 : d) + "%, 0)").addClass("calendar-month-prev");
				...
				n.transition(e).transform("translate3d(" + (i ? h : 0) + "%, " + (i ? 0 : h) + "%, 0)"), p && n.transitionEnd(function() {
				...
				if(i.minDate) {
					...
					if(n < (p = new r.DateHandleClass(p.getFullYear(), p.getMonth(), 1)).getTime()) return !1
				}
				...
				s.transition(a).transform("translate3d(" + (o ? v : 0) + "%, " + (o ? 0 : v) + "%, 0)"), m && s.transitionEnd(function() {
				...
				for(var k = 1; k <= 6; k += 1) {
					for(var T = "", o = function(e) {
							var a = void 0,
								t = (x += 1) - E,
								n = "";
							1 === k && 1 === e && C < t && 1 !== d.firstDay && (t = (x -= 7) - E);
					...
					r += '<div class="calendar-row">' + T + "</div>"
				}
				...
				var l = !o && s.value;
				e ? o && a.setValue(o, 0) : o ? a.setValue(o, 0) : s.value && a.setValue(a.normalizeValues(s.value), 0), a.updateCurrentMonthYear(), a.monthsTranslate = 0, a.setMonthsTranslate(), l ? a.updateValue() : s.header && o && a.updateValue(!0), !i && r.length && "md" === n.theme && r.trigger("focus"), a.initialized = !0, a.$months.each(function(e, t) {
					a.emit("local::monthAdd calendarMonthAdd", t)
				}), t && t.trigger("calendar:open", a), r && r.trigger("calendar:open", a), a.emit("local::open calendarOpen", a)
			}, e.prototype.onOpened = function() {
				...
				var e, t = this,
					...
					o = t.params;
				if(!n) {
					if(r) return t.$el = $$1(t.render()), (t.$el[0].f7Calendar = t).$wrapperEl = t.$el.find(".calendar-months-wrapper"), t.$months = t.$wrapperEl.find(".calendar-month"), t.$containerEl.append(t.$el), t.onOpen(), void t.onOpened();
					var s = o.openIn;
					...
					var l = t.render(),
						p = {
							...
							on: {
								open: function() {
									t.modal = this, t.$el = "popover" === s ? this.$el.find(".calendar") : this.$el, t.$wrapperEl = t.$el.find(".calendar-months-wrapper"), t.$months = t.$wrapperEl.find(".calendar-month"), t.$el[0].f7Calendar = t, "customModal" === s && $$1(t.$el).find(".calendar-close").once("click", function() {
										t.close()
									}), t.onOpen()
								},
								opened: function() {
	...
	function pickerColumn(e, t) {
		...
		if(!l.divider) {
			var p, i, o, c, d;
			l.$el = n, l.el = n[0], l.$itemsEl = l.$el.find(".picker-items"), l.items = l.$itemsEl.find(".picker-item"), l.replaceValues = function(e, t) {
				l.detachEvents(), l.values = e, l.displayValues = t, l.$itemsEl.html(s.renderColumn(l, !0)), l.items = l.$itemsEl.find(".picker-item"), l.calcSize(), l.setValue(l.values[0], 0, !0), l.attachEvents()
			}, l.calcSize = function() {
				s.params.rotateEffect && (l.$el.removeClass("picker-column-absolute"), l.width || l.$el.css({
					width: ""
				}));
				var n = 0,
					e = l.$el[0].offsetHeight;
				p = l.items[0].offsetHeight, i = p * l.items.length, o = e / 2 - i + p / 2, c = e / 2 - p / 2, l.width && (n = l.width, parseInt(n, 10) === n && (n += "px"), l.$el.css({
					width: n
				})), s.params.rotateEffect && (l.width || (l.items.each(function(e, t) {
					var a = $$1(t).children("span");
				...
				if(void 0 !== n && -1 !== n) {
					var r = -n * p + c;
					l.$itemsEl.transition(t), l.$itemsEl.transform("translate3d(0," + r + "px,0)"), s.params.updateValuesOnMomentum && l.activeIndex && l.activeIndex !== n && (Utils.cancelAnimationFrame(d), l.$itemsEl.transitionEnd(function() {
						Utils.cancelAnimationFrame(d)
					}), E()), l.updateItems(n, r, t, a)
				}
			...
			var u, h, f, m, v, g, b, y, w, $, C = !0,
				x = !!a.support.passiveListener && {
					passive: !1,
					capture: !1
				};
			l.attachEvents = function() {
				l.$el.on(a.touchEvents.start, k, x), a.on("touchmove:active", T), a.on("touchend:passive", S), l.items.on("click", M)
			}, l.detachEvents = function() {
				l.$el.off(a.touchEvents.start, k, x), a.off("touchmove:active", T), a.off("touchend:passive", S), l.items.off("click", M)
			}, l.init = function() {
				l.calcSize(), l.$itemsEl.transform("translate3d(0," + c + "px,0)").transition(0), 0 === r && l.$el.addClass("picker-column-first"), r === s.cols.length - 1 && l.$el.addClass("picker-column-last"), t && l.updateItems(0, c, 0), l.attachEvents()
			}, l.destroy = function() {
				l.detachEvents()
			}, l.init()
		}
		...
		function E() {
			d = Utils.requestAnimationFrame(function() {
				l.updateItems(void 0, void 0, 0), E()
			})
		}

		function k(e) {
			h || u || (e.preventDefault(), u = !0, f = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, m = f, v = (new Date).getTime(), C = !0, g = Utils.getTranslate(l.$itemsEl[0], "y"), y = g)
		}

		function T(e) {
			u && (e.preventDefault(), C = !1, m = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, h || (Utils.cancelAnimationFrame(d), h = !0, g = Utils.getTranslate(l.$itemsEl[0], "y"), y = g, l.$itemsEl.transition(0)), b = void 0, (y = g + (m - f)) < o && (y = o - Math.pow(o - y, .8), b = "min"), c < y && (y = c + Math.pow(y - c, .8), b = "max"), l.$itemsEl.transform("translate3d(0," + y + "px,0)"), l.updateItems(void 0, y, 0, s.params.updateValuesOnTouchmove), $ = y - w || y, w = y)
		}

		function S() {
			if(u && h) {
				var e;
				h = u = !1, l.$itemsEl.transition(""), b && ("min" === b ? l.$itemsEl.transform("translate3d(0," + o + "px,0)") : l.$itemsEl.transform("translate3d(0," + c + "px,0)")), e = 300 < (new Date).getTime() - v ? y : y + $ * s.params.momentumRatio, e = Math.max(Math.min(e, c), o);
				var t = -Math.floor((e - c) / p);
				s.params.freeMode || (e = -t * p + c), l.$itemsEl.transform("translate3d(0," + parseInt(e, 10) + "px,0)"), l.updateItems(t, e, "", !0), s.params.updateValuesOnMomentum && (E(), l.$itemsEl.transitionEnd(function() {
					Utils.cancelAnimationFrame(d)
				})), setTimeout(function() {
					C = !0
				}, 100)
		...
		function M() {
			if(C) {
				Utils.cancelAnimationFrame(d);
				var e = $$1(this).attr("data-picker-value");
				l.setValue(e)
			}
		}
	}
	var Picker = function(c) {
			function e(e, t) {
				...
				var a, n, r, i = this;
				if(i.params = Utils.extend({}, e.params.picker, t), i.params.containerEl && 0 === (a = $$1(i.params.containerEl)).length) return i;
				...
				function p(e) {
					var t = $$1(e.target);
					i.isPopover() || i.opened && (t.closest('[class*="backdrop"]').length || (n && 0 < n.length ? t[0] !== n[0] && 0 === t.closest(".sheet-modal").length && i.close() : 0 === $$1(e.target).closest(".sheet-modal").length && i.close()))
				}
				return i.params.inputEl && (n = $$1(i.params.inputEl)), n && (r = n.parents(".view").length && n.parents(".view")[0].f7View), r || (r = e.views.main), Utils.extend(i, {
					app: e,
					$containerEl: a,
					containerEl: a && a[0],
					inline: a && 0 < a.length,
					...
					attachInputEvents: function() {
						i.$inputEl.on("click", s), i.params.inputReadOnly && i.$inputEl.on("focus mousedown", l)
					},
					detachInputEvents: function() {
						i.$inputEl.off("click", s), i.params.inputReadOnly && i.$inputEl.off("focus mousedown", l)
					},
					attachHtmlEvents: function() {
						e.on("click", p)
					},
			...
			return c && (e.__proto__ = c), ((e.prototype = Object.create(c && c.prototype)).constructor = e).prototype.initInput = function() {
				this.$inputEl && this.params.inputReadOnly && this.$inputEl.prop("readOnly", !0)
				...
				if(0 === a.cols.length)
					for(var i = a.params.cols.filter(function(e) {
							return !e.divider
						}), o = 0; o < i.length; o += 1) void 0 !== (t = i[o]).displayValues && void 0 !== t.values && -1 !== t.values.indexOf(n[o]) ? r.push(t.displayValues[t.values.indexOf(n[o])]) : r.push(n[o]);
				else
				...
				var n = this,
					...
					o = n.value,
					s = n.params;
				n.opened = !0, n.attachResizeEvent(), e.find(".picker-column").each(function(e, t) {
					var a = !0;
				...
				if(!n) {
					if(0 === t.cols.length && t.params.cols.length && t.params.cols.forEach(function(e) {
							t.cols.push(e)
						}), r) return t.$el = $$1(t.render()), (t.$el[0].f7Picker = t).$containerEl.append(t.$el), t.onOpen(), void t.onOpened();
					var o = t.isPopover(),
						s = o ? "popover" : "sheet",
						l = {
							targetEl: i,
							...
							on: {
								open: function() {
									t.modal = this, t.$el = o ? this.$el.find(".picker") : this.$el, (t.$el[0].f7Picker = t).onOpen()
								},
								opened: function() {
									t.onOpened()
								},
		...
		InfiniteScroll$1 = {
			...
			on: {
				tabMounted: function(e) {
					var a = this;
					$$1(e).find(".infinite-scroll-content").each(function(e, t) {
		...
		PullToRefresh = function(T) {
			function e(t, e) {
				...
				i.$el = o, i.el = o[0], i.app = t, i.useModulesParams({});
				var l, p, c, d = "md" === t.theme;
				i.done = function() {
					return(d ? s : o).transitionEnd(function() {
						o.removeClass("ptr-transitioning ptr-pull-up ptr-pull-down"), o.trigger("ptr:done"), i.emit("local::done ptrDone", o[0])
					}), o.removeClass("ptr-refreshing").addClass("ptr-transitioning"), i
				}, i.refresh = function() {
					return o.hasClass("ptr-refreshing") || (o.addClass("ptr-transitioning ptr-refreshing"), o.trigger("ptr:refresh", i.done), i.emit("local::refresh ptrRefresh", o[0], i.done)), i
				};
				var u, h, f, m, v, g, b, y, w = {},
					$ = !1,
					C = !1,
					x = 0,
					a = !1,
				...
				function r(e) {
					if(p) {
						...
						if("targetTouches" in e && 1 < e.targetTouches.length) return
					}
					o.hasClass("ptr-refreshing") || $$1(e.target).closest(".sortable-handler").length || (p = !(y = c = !1), v = u = void 0, "touchstart" === e.type && (l = e.targetTouches[0].identifier), w.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, w.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY)
				}
				...
				function E(e) {
					if(p) {
						...
						if("touchmove" === e.type) {
							if(l && e.touches)
								for(var r = 0; r < e.touches.length; r += 1) e.touches[r].identifier === l && (n = e.touches[r]);
							n || (n = e.targetTouches[0]), t = n.pageX, a = n.pageY
						} else t = e.pageX, a = e.pageY;
						if(t && a)
							if(void 0 === u && (u = !!(u || Math.abs(a - w.y) > Math.abs(t - w.x))), u) {
								if(m = o[0].scrollTop, void 0 === v && 0 !== m && (v = !0), !c) {
									if(o.removeClass("ptr-transitioning"), m > o[0].offsetHeight) return void(p = !1);
									b && 0 <= (g = o.attr("data-ptr-distance")).indexOf("%") && (g = o[0].offsetHeight * parseInt(g, 10) / 100), x = o.hasClass("ptr-refreshing") ? g : 0, C = !(o[0].scrollHeight !== o[0].offsetHeight && "ios" === Device.os && !d)
								}
								c = !0, 0 < (h = a - w.y) && m <= 0 || m < 0 ? ("ios" === Device.os && 7 < parseInt(Device.osVersion.split(".")[0], 10) && 0 === m && !v && (C = !0), C && (e.preventDefault(), f = Math.pow(h, .85) + x, d ? s.transform("translate3d(0," + f + "px,0)").find(".ptr-arrow").transform("rotate(" + (h / 66 * 180 + 100) + "deg)") : o.transform("translate3d(0," + f + "px,0)")), C && Math.pow(h, .85) > g || !C && 2 * g <= h ? ($ = !0, o.addClass("ptr-pull-up").removeClass("ptr-pull-down")) : ($ = !1, o.removeClass("ptr-pull-up").addClass("ptr-pull-down")), y || (o.trigger("ptr:pullstart"), i.emit("local::pullStart ptrPullStart", o[0]), y = !0), o.trigger("ptr:pullmove", {
									event: e,
									scrollTop: m,
									translate: f,
									touchesDiff: h
									...
									translate: f,
									touchesDiff: h
								})) : (y = !1, o.removeClass("ptr-pull-up ptr-pull-down"), $ = !1)
							} else p = !1
					}
				}

				function k(e) {
					if("touchend" === e.type && e.changedTouches && 0 < e.changedTouches.length && l && e.changedTouches[0].identifier !== l) return c = u = p = !1, void(l = null);
					p && c ? (f && (o.addClass("ptr-transitioning"), f = 0), d ? s.transform("").find(".ptr-arrow").transform("") : o.transform(""), $ ? (o.addClass("ptr-refreshing"), o.trigger("ptr:refresh", i.done), i.emit("local::refresh ptrRefresh", o[0], i.done)) : o.removeClass("ptr-pull-down"), c = p = !1, y && (o.trigger("ptr:pullend"), i.emit("local::pullEnd ptrPullEnd", o[0]))) : c = p = !1
				}
				return(0 < n.find(".navbar").length || 0 < n.parents(".view").children(".navbar").length) && (a = !0), n.hasClass("no-navbar") && (a = !1), a || o.addClass("ptr-no-navbar"), o.attr("data-ptr-distance") ? b = !0 : g = d ? 66 : 44, n.length && o.length && ((o[0].f7PullToRefresh = i).attachEvents = function() {
					var e = !!Support.passiveListener && {
						passive: !0
					};
					o.on(t.touchEvents.start, r, e), t.on("touchmove", E), t.on("touchend:passive", k)
				}, i.detachEvents = function() {
					var e = !!Support.passiveListener && {
						passive: !0
					};
					o.off(t.touchEvents.start, r, e), t.off("touchmove", E), t.off("touchend:passive", k)
				}, i.useModules(), i.init()), i
			}
			return T && (e.__proto__ = T), ((e.prototype = Object.create(T && T.prototype)).constructor = e).prototype.init = function() {
				this.attachEvents()
			}, e.prototype.destroy = function() {
				var e = this;
		...
		PullToRefresh$1 = {
			...
			on: {
				tabMounted: function(e) {
					var a = this;
					$$1(e).find(".ptr-content").each(function(e, t) {
						a.ptr.create(t)
					})
				},
				tabBeforeRemove: function(e) {
		...
		Lazy = {
			...
			create: function(e) {
				...
				if(0 !== n.length || a.hasClass("lazy")) {
					...
					!1 !== r && n.each(function(e, t) {
						$$1(t).attr("data-src") && !$$1(t).attr("src") && $$1(t).attr("src", r)
					});
					var i = [],
						o = !1;
				...
				function s(e) {
					0 <= i.indexOf(e) && i.splice(i.indexOf(e), 1), o = !1, t.params.lazy.sequential && 0 < i.length && (o = !0, t.lazy.loadImage(i[0], s))
				}
			...
			load: function(e, a) {
				var n = this,
					t = $$1(e);
				t.hasClass("page") || (t = t.parents(".page").eq(0)), 0 !== t.length && t.find(".lazy").each(function(e, t) {
					0 < $$1(t).parents(".tab:not(.tab-active)").length || n.lazy.isInViewport(t) && (a ? a(t) : n.lazy.loadImage(t))
				})
			}
		},
		Lazy$1 = {
			...
			function e(e, t) {
				...
				if(0 !== i.length) {
					...
					return r.$el[0].f7DataTable = r, Utils.extend(r, {
						...
						r.$el.on("change", '.checkbox-cell input[type="checkbox"]', o), r.$el.find("thead .sortable-cell").on("click", s)
					}, r.detachEvents = function() {
						r.$el.off("change", '.checkbox-cell input[type="checkbox"]', o), r.$el.find("thead .sortable-cell").off("click", s)
				...
				function o(e) {
					if(!e.detail || !e.detail.sentByF7DataTable) {
						...
						0 < t.parents("thead").length ? (0 === n && i.find("tbody tr")[a ? "addClass" : "removeClass"]("data-table-row-selected"), i.find("tbody tr td:nth-child(" + (n + 1) + ") input").prop("checked", a).trigger("change", {
							sentByF7DataTable: !0
		...
		DataTable$1 = {
			...
			on: {
				tabBeforeRemove: function(e) {
					var a = this;
					$$1(e).find(".data-table-init").each(function(e, t) {
		...
		Fab = {
			morphOpen: function(e, t) {
				...
				if(0 !== i.length) {
					...
					}, i.css("opacity", 0).transform("scale(" + 1 / p + ", " + 1 / c + ")"), r.addClass("fab-opened").css("z-index", o.zIndex - 1).transform("translate3d(" + -n + "px, " + -l + "px, 0)"), r.transitionEnd(function() {
						i.transition(""), Utils.nextTick(function() {
							i.css("opacity", 1).transform("scale(1,1)")
						}), r.transform("translate3d(" + -n + "px, " + -l + "px, 0) scale(" + p + ", " + c + ")").css("border-radius", d + "px").css("box-shadow", "none"), a.on("resize", r[0].f7FabMorphResizeHandler), 0 < i.parents(".page-content").length && i.parents(".page-content").on("scroll", r[0].f7FabMorphResizeHandler)
					})
				}
			},
				...
				if(a) {
					...
					if(0 !== n.length) {
						var o = i.offset.left + i.width / 2 - (r.offset.left + r.width / 2) - i.translateX,
							...
							l = r.width / i.width,
							p = r.height / i.height;
						this.off("resize", t[0].f7FabMorphResizeHandler), 0 < n.parents(".page-content").length && n.parents(".page-content").off("scroll", t[0].f7FabMorphResizeHandler), n.css("opacity", 0).transform("scale(" + 1 / l + ", " + 1 / p + ")"), t.transition("").css("box-shadow", "").css("border-radius", "").transform("translate3d(" + -o + "px, " + -s + "px, 0)"), t.transitionEnd(function() {
		...
		Searchbar = function(E) {
			function e(e, t) {
				...
				var r, i, o, s, l, p, c, d, u, h, f = $$1(a.params.el);
				...
				function g(e) {
					a.enable(e), a.$el.addClass("searchbar-focused")
				}
				...
				function w(e, t) {
					a.$el.trigger("searchbar:clear", t), a.emit("local::clear searchbarClear", a, t)
				}
				...
				return t.foundEl ? o = $$1(t.foundEl) : "string" == typeof a.params.foundEl && r && (o = r.find(a.params.foundEl)), t.notFoundEl ? s = $$1(t.notFoundEl) : "string" == typeof a.params.notFoundEl && r && (s = r.find(a.params.notFoundEl)), t.hideOnEnableEl ? l = $$1(t.hideOnEnableEl) : "string" == typeof a.params.hideOnEnableEl && r && (l = r.find(a.params.hideOnEnableEl)), t.hideOnSearchEl ? p = $$1(t.hideOnSearchEl) : "string" == typeof a.params.hideOnSearchEl && r && (p = r.find(a.params.hideOnSearchEl)), a.params.backdrop && 0 === (c = a.params.backdropEl ? $$1(a.params.backdropEl) : r && 0 < r.length ? r.find(".searchbar-backdrop") : f.siblings(".searchbar-backdrop")).length && (c = $$1('<div class="searchbar-backdrop"></div>'), r && r.length ? 0 < f.parents(r).length && i && 0 === f.parents(i).length ? c.insertBefore(f) : c.insertBefore(r.find(".page-content").eq(0)) : c.insertBefore(f)), a.params.searchContainer && (d = $$1(a.params.searchContainer)), u = a.params.inputEl ? $$1(a.params.inputEl) : f.find('input[type="search"]').eq(0), a.params.disableButton && (h = a.params.disableButtonEl ? $$1(a.params.disableButtonEl) : f.find(".searchbar-disable-button")), Utils.extend(a, {
					app: e,
					...
					f.on("submit", v), a.params.disableButton && a.$disableButtonEl.on("click", $), a.params.disableOnBackdropClick && a.$backdropEl && a.$backdropEl.on("click", $), a.expandable && "ios" === e.theme && a.view && i && a.$pageEl && (a.$pageEl.on("page:beforeout", C), a.$pageEl.on("page:beforein", x)), a.$inputEl.on("focus", g), a.$inputEl.on("blur", b), a.$inputEl.on("change input compositionend", y), a.$inputEl.on("input:clear", w)
				}, a.detachEvents = function() {
					f.off("submit", v), a.params.disableButton && a.$disableButtonEl.off("click", $), a.params.disableOnBackdropClick && a.$backdropEl && a.$backdropEl.off("click", $), a.expandable && "ios" === e.theme && a.view && i && a.$pageEl && (a.$pageEl.off("page:beforeout", C), a.$pageEl.off("page:beforein", x)), a.$inputEl.off("focus", g), a.$inputEl.off("blur", b), a.$inputEl.off("change input compositionend", y), a.$inputEl.off("input:clear", w)
				}, a.useModules(), a.init(), a
			}
			return E && (e.__proto__ = E), ((e.prototype = Object.create(E && E.prototype)).constructor = e).prototype.clear = function(e) {
				if(!this.query && e && $$1(e.target).hasClass("searchbar-clear")) return this.disable(), this;
				var t = this.value;
				...
				var r = !(t.enabled = !0);
				return !0 === e && doc.activeElement !== t.inputEl && (r = !0), a.device.ios && "ios" === a.theme ? t.expandable ? (r && t.$inputEl.focus(), n()) : (r && t.$inputEl.focus(), !e || "focus" !== e.type && !0 !== e ? n() : Utils.nextTick(function() {
					n()
				}, 400)) : (r && t.$inputEl.focus(), "md" === a.theme && t.expandable && t.$el.parents(".page, .view, .navbar-inner").scrollLeft(0), n()), t
			}, e.prototype.disable = function() {
				var e = this;
				if(!e.enabled) return e;
				var t = e.app;
				return e.$inputEl.val("").trigger("change"), e.$el.removeClass("searchbar-enabled"), e.$el.removeClass("searchbar-focused"), !e.expandable && e.$disableButtonEl && 0 < e.$disableButtonEl.length && "ios" === t.theme && e.$disableButtonEl.css("margin-" + (t.rtl ? "left" : "right"), -e.disableButtonEl.offsetWidth + "px"), e.$backdropEl && (e.$searchContainer && e.$searchContainer.length || e.params.customSearch) && e.backdropHide(), e.enabled = !1, e.$inputEl.blur(), e.$hideOnEnableEl && e.$hideOnEnableEl.removeClass("hidden-by-searchbar"), e.$el.trigger("searchbar:disable"), e.emit("local::disable searchbarDisable", e), e
				...
				t || (l.enabled || l.enable(), l.$inputEl.val(e)), l.query = e, l.value = e;
				...
				if(s) {
					...
					u = l.params.removeDiacritics ? Utils.removeDiacritics(e.trim().toLowerCase()).split(" ") : e.trim().toLowerCase().split(" "), a.find(l.params.searchItem).removeClass("hidden-by-searchbar").each(function(e, t) {
						...
						l.params.searchIn === l.params.searchItem && (r = a), r.each(function(e, t) {
							var a = $$1(t).text().trim().toLowerCase();
						...
						for(var a = $$1(t), n = a.nextAll("li"), r = !0, i = 0; i < n.length; i += 1) {
							var o = n.eq(i);
							if(o.hasClass("list-group-title") || o.hasClass("item-divider")) break;
		...
		Searchbar$1 = {
			...
			on: {
				tabMounted: function(e) {
					var n = this;
					$$1(e).find(".searchbar-init").each(function(e, t) {
						var a = $$1(t);
		...
		Messages = function(i) {
			...
			return i && (e.__proto__ = i), ((e.prototype = Object.create(i && i.prototype)).constructor = e).prototype.getMessageData = function(e) {
				...
				l.$el.find(".message, .messages-title").each(function(e, t) {
					...
					s && s.length && ("string" == typeof s && (s = s.split(" ")), s.forEach(function(e) {
						n.push(e)
					})), a.removeClass("message-first message-last message-tail message-same-name message-same-header message-same-footer message-same-avatar"), n.forEach(function(e) {
						a.addClass(e)
					})
				})
				...
				void 0 === t && (t = !0);
				var a, n, r = this;
				return "number" == typeof e ? (a = e, n = r.$el.find(".message, .messages-title").eq(a)) : r.messages && 0 <= r.messages.indexOf(e) ? (a = r.messages.indexOf(e), n = r.$el.children().eq(a)) : a = (n = $$1(e)).index(), 0 === n.length || (n.remove(), r.messages.splice(a, 1), r.params.autoLayout && t && r.layout()), r
				...
				if(this.messages.forEach(function(e, t) {
						e.isTyping && (a = t)
					}), void 0 !== a && this.$el.find(".message").eq(a).hasClass("message-typing") && (e = !0, this.removeMessage(a)), !e) {
		...
		Messages$1 = {
			...
			on: {
				tabBeforeRemove: function(e) {
					var a = this;
					$$1(e).find(".messages-init").each(function(e, t) {
		...
		Messagebar = function(g) {
			function e(e, t) {
				...
				i = a.params.textareaEl ? $$1(a.params.textareaEl) : r.find("textarea");
				...
				function h(e) {
					var t = $$1(this).index();
					$$1(e.target).closest(".messagebar-attachment-delete").length ? ($$1(this).trigger("messagebar:attachmentdelete", t), a.emit("local::attachmentDelete messagebarAttachmentDelete", a, this, t)) : ($$1(this).trigger("messagebar:attachmentclick", t), a.emit("local::attachmentClick messagebarAttachmentClick", a, this, t))
				}

				function f() {
					a.checkEmptyState(), a.$el.trigger("messagebar:change"), a.emit("local::change messagebarChange", a)
				}

				function m() {
					a.sheetHide(), a.$el.addClass("messagebar-focused"), a.$el.trigger("messagebar:focus"), a.emit("local::focus messagebarFocus", a)
				}

				function v() {
					a.$el.removeClass("messagebar-focused"), a.$el.trigger("messagebar:blur"), a.emit("local::blur messagebarBlur", a)
				}
				return a.params.top && r.addClass("messagebar-top"), Utils.extend(a, {
					$el: r,
					el: r[0],
					$areaEl: l,
					areaEl: l[0],
					...
					r.on("textarea:resize", d), r.on("submit", u), r.on("click", ".messagebar-attachment", h), i.on("change input", f), i.on("focus", m), i.on("blur", v), e.on("resize", d)
				}, a.detachEvents = function() {
					r.off("textarea:resize", d), r.off("submit", u), r.off("click", ".messagebar-attachment", h), i.off("change input", f), i.off("focus", m), i.off("blur", v), e.off("resize", d)
				}, a.useModules(), a.init(), a
			}
			return g && (e.__proto__ = g), ((e.prototype = Object.create(g && g.prototype)).constructor = e).prototype.focus = function() {
		...
		Messagebar$1 = {
			...
			on: {
				tabBeforeRemove: function(e) {
					var a = this;
					$$1(e).find(".messagebar-init").each(function(e, t) {
	...
	function updateSlides() {
		...
		if(void 0 !== n) {
			...
			"string" == typeof g && 0 <= g.indexOf("%") && (g = parseFloat(g.replace("%", "")) / 100 * n), e.virtualSize = -g, r ? l.css({
				...
				marginRight: "",
				marginBottom: ""
			}), 1 < t.slidesPerColumn && ($ = Math.floor(p / t.slidesPerColumn) === p / e.params.slidesPerColumn ? p : Math.ceil(p / t.slidesPerColumn) * t.slidesPerColumn, "auto" !== t.slidesPerView && "row" === t.slidesPerColumnFill && ($ = Math.max($, t.slidesPerView * t.slidesPerColumn)));
			for(var x, E = t.slidesPerColumn, k = $ / E, T = k - (t.slidesPerColumn * k - p), S = 0; S < p; S += 1) {
				C = 0;
				var M = l.eq(S);
				if(1 < t.slidesPerColumn) {
					var P = void 0,
						O = void 0,
						D = void 0;
					"column" === t.slidesPerColumnFill ? (D = S - (O = Math.floor(S / E)) * E, (T < O || O === T && D === E - 1) && E <= (D += 1) && (D = 0, O += 1), P = O + D * $ / E, M.css({
						"-webkit-box-ordinal-group": P,
						"-moz-box-ordinal-group": P,
						"-ms-flex-order": P,
						"-webkit-order": P,
						order: P
					})) : O = S - (D = Math.floor(S / k)) * k, M.css("margin-" + (e.isHorizontal() ? "top" : "left"), 0 !== D && t.spaceBetween && t.spaceBetween + "px").attr("data-swiper-column", O).attr("data-swiper-row", D)
				}
				if("none" !== M.css("display")) {
					if("auto" === t.slidesPerView) {
						...
						L && (M[0].style.transform = "none"), A && (M[0].style.webkitTransform = "none"), C = e.isHorizontal() ? M[0].getBoundingClientRect().width + parseFloat(I.getPropertyValue("margin-left")) + parseFloat(I.getPropertyValue("margin-right")) : M[0].getBoundingClientRect().height + parseFloat(I.getPropertyValue("margin-top")) + parseFloat(I.getPropertyValue("margin-bottom")), L && (M[0].style.transform = L), A && (M[0].style.webkitTransform = A), t.roundLengths && (C = Math.floor(C))
					} else C = (n - (t.slidesPerView - 1) * g) / t.slidesPerView, t.roundLengths && (C = Math.floor(C)), l[S] && (e.isHorizontal() ? l[S].style.width = C + "px" : l[S].style.height = C + "px");
					l[S] && (l[S].swiperSlideSize = C), u.push(C), t.centeredSlides ? (b = b + C / 2 + y / 2 + g, 0 === y && 0 !== S && (b = b - n / 2 - g), 0 === S && (b = b - n / 2 - g), Math.abs(b) < .001 && (b = 0), t.roundLengths && (b = Math.floor(b)), w % t.slidesPerGroup == 0 && c.push(b), d.push(b)) : (t.roundLengths && (b = Math.floor(b)), w % t.slidesPerGroup == 0 && c.push(b), d.push(b), b = b + C + g), e.virtualSize += C + g, y = C, w += 1
				}
			}
			if(e.virtualSize = Math.max(e.virtualSize, n) + f, r && i && ("slide" === t.effect || "coverflow" === t.effect) && a.css({
					width: e.virtualSize + t.spaceBetween + "px"
				}), Support.flexbox && !t.setWrapperSize || (e.isHorizontal() ? a.css({
					width: e.virtualSize + t.spaceBetween + "px"
				}) : a.css({
					height: e.virtualSize + t.spaceBetween + "px"
				})), 1 < t.slidesPerColumn && (e.virtualSize = (C + t.spaceBetween) * $, e.virtualSize = Math.ceil(e.virtualSize / t.slidesPerColumn) - t.spaceBetween, e.isHorizontal() ? a.css({
					width: e.virtualSize + t.spaceBetween + "px"
				}) : a.css({
					height: e.virtualSize + t.spaceBetween + "px"
				}), t.centeredSlides)) {
				...
				for(var z = 0; z < c.length; z += 1) {
					var B = c[z];
					t.roundLengths && (B = Math.floor(B)), c[z] < e.virtualSize + c[0] && x.push(B)
				}
				c = x
			}
			if(!t.centeredSlides) {
				...
				for(var R = 0; R < c.length; R += 1) {
					var H = c[R];
					t.roundLengths && (H = Math.floor(H)), c[R] <= e.virtualSize - n && x.push(H)
				}
				c = x, 1 < Math.floor(e.virtualSize - n) - Math.floor(c[c.length - 1]) && c.push(e.virtualSize - n)
			}
			0 === c.length && (c = [0]), 0 !== t.spaceBetween && (e.isHorizontal() ? r ? l.css({
				marginLeft: g + "px"
			}) : l.css({
				marginRight: g + "px"
			}) : l.css({
				...
				slidesGrid: d,
				slidesSizesGrid: u
			}), p !== s && e.emit("slidesLengthChange"), c.length !== m && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), d.length !== v && e.emit("slidesGridLengthChange"), (t.watchSlidesProgress || t.watchSlidesVisibility) && e.updateSlidesOffset()
		}
	}
		...
		if(0 !== a.length) {
			...
			for(var i = 0; i < a.length; i += 1) {
				...
				if(t.watchSlidesVisibility) {
					...
					(0 <= l && l < this.size || 0 < p && p <= this.size || l <= 0 && p >= this.size) && a.eq(i).addClass(t.slideVisibleClass)
				}
				o.progress = n ? -s : s
			}
		}
	...
	function updateProgress(e) {
		...
		var t = this,
			...
			s = i,
			l = o;
		0 === n ? o = i = !(r = 0) : (i = (r = (e - t.minTranslate()) / n) <= 0, o = 1 <= r), Utils.extend(t, {
			progress: r,
			isBeginning: i,
			isEnd: o
	...
	function updateClickedSlide(e) {
		...
		t.clickedSlide = n, t.virtual && t.params.virtual.enabled ? t.clickedIndex = parseInt($$1(n).attr("data-swiper-slide-index"), 10) : t.clickedIndex = $$1(n).index(), a.slideToClickedSlide && void 0 !== t.clickedIndex && t.clickedIndex !== t.activeIndex && t.slideToClickedSlide()
	}
	var update = {
	...
	function slideTo(e, t, a, n) {
		...
		if(r.initialized && i !== c) {
			...
			if(!r.allowSlidePrev && f > r.translate && f > r.maxTranslate() && (c || 0) !== i) return !1
		}
		return h = c < i ? "next" : i < c ? "prev" : "reset", d && -f === r.translate || !d && f === r.translate ? (r.updateActiveIndex(i), o.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== o.effect && r.setTranslate(f), "reset" !== h && (r.transitionStart(a, h), r.transitionEnd(a, h)), !1) : (0 !== t && Support.transition ? (r.setTransition(t), r.setTranslate(f), r.updateActiveIndex(i), r.updateSlidesClasses(), r.emit("beforeTransitionStart", t, n), r.transitionStart(a, h), r.animating || (r.animating = !0, r.onSlideToWrapperTransitionEnd || (r.onSlideToWrapperTransitionEnd = function(e) {
			r && !r.destroyed && e.target === this && (r.$wrapperEl[0].removeEventListener("transitionend", r.onSlideToWrapperTransitionEnd), r.$wrapperEl[0].removeEventListener("webkitTransitionEnd", r.onSlideToWrapperTransitionEnd), r.onSlideToWrapperTransitionEnd = null, delete r.onSlideToWrapperTransitionEnd, r.transitionEnd(a, h))
	...
	function slideToClickedSlide() {
		...
		if(a.loop) {
			...
			e = parseInt($$1(t.clickedSlide).attr("data-swiper-slide-index"), 10), a.centeredSlides ? i < t.loopedSlides - r / 2 || i > t.slides.length - t.loopedSlides + r / 2 ? (t.loopFix(), i = n.children("." + a.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + a.slideDuplicateClass + ")").eq(0).index(), Utils.nextTick(function() {
				t.slideTo(i)
	...
	function loopCreate() {
		...
		if(e.loopFillGroupWithBlank) {
			...
			if(a !== e.slidesPerGroup) {
				for(var i = 0; i < a; i += 1) {
					var o = $$1(doc.createElement("div")).addClass(e.slideClass + " " + e.slideBlankClass);
					t.append(o)
				}
		...
		for(var p = 0; p < l.length; p += 1) t.append($$1(l[p].cloneNode(!0)).addClass(e.slideDuplicateClass));
		for(var c = s.length - 1; 0 <= c; c -= 1) t.prepend($$1(s[c].cloneNode(!0)).addClass(e.slideDuplicateClass))
	}
	...
	function onTouchStart(e) {
		...
		if(!t.animating || !n.preventInteractionOnTransition) {
			var i = e;
			if(i.originalEvent && (i = i.originalEvent), a.isTouchEvent = "touchstart" === i.type, (a.isTouchEvent || !("which" in i) || 3 !== i.which) && (!a.isTouched || !a.isMoved))
				if(n.noSwiping && $$1(i.target).closest(n.noSwipingSelector ? n.noSwipingSelector : "." + n.noSwipingClass)[0]) t.allowClick = !0;
				...
				if(!l || !(o <= p || o >= win.screen.width - p)) {
					if(Utils.extend(a, {
							...
							isScrolling: void 0,
							startMoving: void 0
						}), r.startX = o, r.startY = s, a.touchStartTime = Utils.now(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, 0 < n.threshold && (a.allowThresholdMove = !1), "touchstart" !== i.type) {
						var c = !0;
						$$1(i.target).is(a.formElements) && (c = !1), doc.activeElement && $$1(doc.activeElement).is(a.formElements) && doc.activeElement !== i.target && doc.activeElement.blur(), c && t.allowTouchMove && i.preventDefault()
					}
					t.emit("touchStart", i)
				}
			}
	...
	function onTouchMove(e) {
		...
		if(o.originalEvent && (o = o.originalEvent), a.isTouched) {
			if(!a.isTouchEvent || "mousemove" !== o.type) {
				...
				if(a.isTouchEvent && doc.activeElement && o.target === doc.activeElement && $$1(o.target).is(a.formElements)) return a.isMoved = !0, void(t.allowClick = !1);
	...
	function onTouchEnd(e) {
		...
		if(t.allowClick && (t.updateClickedSlide(p), t.emit("tap", p), u < 300 && 300 < d - a.lastClickTime && (a.clickTimeout && clearTimeout(a.clickTimeout), a.clickTimeout = Utils.nextTick(function() {
		...
		if(a.isTouched = !1, a.isMoved = !1, a.startMoving = !1, c = n.followFinger ? i ? t.translate : -t.translate : -a.currentTranslate, n.freeMode) {
			...
			if(n.freeModeMomentum) {
				...
				if(y < t.maxTranslate()) n.freeModeMomentumBounce ? (y + t.maxTranslate() < -x && (y = t.maxTranslate() - x), w = t.maxTranslate(), C = !0, a.allowMomentumBounce = !0) : y = t.maxTranslate(), n.loop && n.centeredSlides && ($ = !0);
				else if(y > t.minTranslate()) n.freeModeMomentumBounce ? (y - t.minTranslate() > x && (y = t.minTranslate() + x), w = t.minTranslate(), C = !0, a.allowMomentumBounce = !0) : y = t.minTranslate(), n.loop && n.centeredSlides && ($ = !0);
				...
				if($ && t.once("transitionEnd", function() {
						t.loopFix()
					}), 0 !== t.velocity) g = i ? Math.abs((-y - t.translate) / t.velocity) : Math.abs((y - t.translate) / t.velocity);
				else if(n.freeModeSticky) return void t.slideToClosest();
				n.freeModeMomentumBounce && C ? (t.updateProgress(w), t.setTransition(g), t.setTranslate(y), t.transitionStart(!0, t.swipeDirection), t.animating = !0, o.transitionEnd(function() {
					t && !t.destroyed && a.allowMomentumBounce && (t.emit("momentumBounce"), t.setTransition(n.speed), t.setTranslate(w), o.transitionEnd(function() {
			...
			for(var T = 0, S = t.slidesSizesGrid[0], M = 0; M < s.length; M += n.slidesPerGroup) void 0 !== s[M + n.slidesPerGroup] ? c >= s[M] && c < s[M + n.slidesPerGroup] && (S = s[(T = M) + n.slidesPerGroup] - s[M]) : c >= s[M] && (T = M, S = s[s.length - 1] - s[s.length - 2]);
			var P = (c - s[T]) / S;
			if(u > n.longSwipesMs) {
	...
	function setBreakpoint() {
		...
		if(i && (!i || 0 !== Object.keys(i).length)) {
			...
			if(o && e.currentBreakpoint !== o) {
				...
				Utils.extend(e.params, s), Utils.extend(e, {
					allowTouchMove: e.params.allowTouchMove,
					allowSlideNext: e.params.allowSlideNext,
					allowSlidePrev: e.params.allowSlidePrev
				}), e.currentBreakpoint = o, l && a && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - n + e.loopedSlides, 0, !1)), e.emit("breakpoint", s)
			}
		}
	}
	...
	var breakpoints = {
		...
		Browser = {
			...
			isSafari: (c0a = win.navigator.userAgent.toLowerCase(), 0 <= c0a.indexOf("safari") && c0a.indexOf("chrome") < 0 && c0a.indexOf("android") < 0),
	...
	var checkOverflow$1 = {
		...
		Swiper = function(u) {
			function h() {
				...
				1 === a.length && a[0].constructor && a[0].constructor === Object ? r = a[0] : (t = (e = a)[0], r = e[1]), r || (r = {}), r = Utils.extend({}, r), t && !r.el && (r.el = t), u.call(this, r), Object.keys(prototypes).forEach(function(t) {
				...
				if(t = s[0]) {
					...
					return Utils.extend(i, {
						...
						touchEvents: (p = ["touchstart", "touchmove", "touchend"], c = ["mousedown", "mousemove", "mouseup"], Support.pointerEvents ? c = ["pointerdown", "pointermove", "pointerup"] : Support.prefixedPointerEvents && (c = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), i.touchEventsTouch = {
							start: p[0],
							move: p[1],
							end: p[2]
			...
			return((h.prototype = Object.create(u && u.prototype)).constructor = h).prototype.slidesPerViewDynamic = function() {
				var e = this.params,
					...
					i = 1;
				if(e.centeredSlides) {
					for(var o, s = t[r].swiperSlideSize, l = r + 1; l < t.length; l += 1) t[l] && !o && (i += 1, n < (s += t[l].swiperSlideSize) && (o = !0));
					for(var p = r - 1; 0 <= p; p -= 1) t[p] && !o && (i += 1, n < (s += t[p].swiperSlideSize) && (o = !0))
				} else
		...
		Virtual = {
			update: function(e) {
				...
				h = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top", i ? (f = Math.floor(n / 2) + r, m = Math.floor(n / 2) + r) : (f = n + (r - 1), m = r);
				...
				if(Utils.extend(t.virtual, {
					...
					}), s === g && l === b && !e) return t.slidesGrid !== c && y !== u && t.slides.css(h, y + "px"), void t.updateProgress();
				...
				if(e) t.$wrapperEl.find("." + t.params.slideClass).remove();
					...
					for(var x = s; x <= l; x += 1)(x < g || b < x) && t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-index="' + x + '"]').remove();
				for(var E = 0; E < p.length; E += 1) g <= E && E <= b && (void 0 === l || e ? C.push(E) : (l < E && C.push(E), E < s && $.push(E)));
				C.forEach(function(e) {
				...
				}), t.$wrapperEl.children(".swiper-slide").css(h, y + "px"), w()
			},
			renderSlide: function(e, t) {
				var a = this.params.virtual;
				if(a.cache && this.virtual.cache[t]) return this.virtual.cache[t];
				var n = a.renderSlide ? $$1(a.renderSlide.call(this, e, t)) : $$1('<div class="' + this.params.slideClass + '" data-swiper-slide-index="' + t + '">' + e + "</div>");
		...
		Navigation = {
			...
			init: function() {
				...
				(n.nextEl || n.prevEl) && (n.nextEl && (e = $$1(n.nextEl), a.params.uniqueNavElements && "string" == typeof n.nextEl && 1 < e.length && 1 === a.$el.find(n.nextEl).length && (e = a.$el.find(n.nextEl))), n.prevEl && (t = $$1(n.prevEl), a.params.uniqueNavElements && "string" == typeof n.prevEl && 1 < t.length && 1 === a.$el.find(n.prevEl).length && (t = a.$el.find(n.prevEl))), e && 0 < e.length && e.on("click", function(e) {
			...
			on: {
				...
				click: function(e) {
					var t = this.navigation,
						a = t.$nextEl,
						n = t.$prevEl;
					!this.params.navigation.hideOnClick || $$1(e.target).is(n) || $$1(e.target).is(a) || (a && a.toggleClass(this.params.navigation.hiddenClass), n && n.toggleClass(this.params.navigation.hiddenClass))
				}
			}
		},
		Pagination = {
			...
			init: function() {
				...
				if(e.el) {
					...
					0 !== t.length && (a.params.uniqueNavElements && "string" == typeof e.el && 1 < t.length && 1 === a.$el.find(e.el).length && (t = a.$el.find(e.el)), "bullets" === e.type && e.clickable && t.addClass(e.clickableClass), t.addClass(e.modifierClass + e.type), "bullets" === e.type && e.dynamicBullets && (t.addClass("" + e.modifierClass + e.type + "-dynamic"), a.pagination.dynamicBulletIndex = 0, e.dynamicMainBullets < 1 && (e.dynamicMainBullets = 1)), "progressbar" === e.type && e.progressbarOpposite && t.addClass(e.progressbarOppositeClass), e.clickable && t.on("click", "." + e.bulletClass, function(e) {
						e.preventDefault();
						var t = $$1(this).index() * a.params.slidesPerGroup;
		...
		Pagination$1 = {
			...
			on: {
				...
				click: function(e) {
					this.params.pagination.el && this.params.pagination.hideOnClick && 0 < this.pagination.$el.length && !$$1(e.target).hasClass(this.params.pagination.bulletClass) && this.pagination.$el.toggleClass(this.params.pagination.hiddenClass)
				}
			}
		},
		Scrollbar = {
			...
			updateSize: function() {
				...
				if(e.params.scrollbar.el && e.scrollbar.el) {
					...
					var r, i = e.isHorizontal() ? n[0].offsetWidth : n[0].offsetHeight,
						...
						s = o * (i / e.size);
					r = "auto" === e.params.scrollbar.dragSize ? i * o : parseInt(e.params.scrollbar.dragSize, 10), e.isHorizontal() ? a[0].style.width = r + "px" : a[0].style.height = r + "px", n[0].style.display = 1 <= o ? "none" : "", e.params.scrollbarHide && (n[0].style.opacity = 0), Utils.extend(t, {
						trackSize: i,
						divider: o,
						moveDivider: s,
						dragSize: r
			...
			init: function() {
				if(this.params.scrollbar.el) {
					...
					0 === r.length && (r = $$1('<div class="' + this.params.scrollbar.dragClass + '"></div>'), n.append(r)), Utils.extend(e, {
						$el: n,
						el: n[0],
						$dragEl: r,
						dragEl: r[0]
		...
		Parallax = {
			...
			setTranslate: function() {
				...
				e.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function(e, t) {
					...
					var a = t.progress;
					1 < n.params.slidesPerGroup && "auto" !== n.params.slidesPerView && (a += Math.ceil(e / 2) - r * (i.length - 1)), a = Math.min(Math.max(a, -1), 1), $$1(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function(e, t) {
		...
		Zoom = {
			...
			onGestureStart: function(e) {
				...
				n.$slideEl && n.$slideEl.length || (n.$slideEl = $$1(e.target).closest(".swiper-slide"), 0 === n.$slideEl.length && (n.$slideEl = this.slides.eq(this.activeIndex)), n.$imageEl = n.$slideEl.find("img, svg, canvas"), n.$imageWrapEl = n.$imageEl.parent("." + t.containerClass), n.maxRatio = n.$imageWrapEl.attr("data-swiper-zoom") || t.maxRatio, 0 !== n.$imageWrapEl.length) ? (n.$imageEl.transition(0), this.zoom.isScaling = !0) : n.$imageEl = void 0
			},
		...
		Lazy$2 = {
			...
			load: function() {
				...
				if("auto" === s && (s = 0), n.lazy.initialImageLoaded || (n.lazy.initialImageLoaded = !0), n.params.watchSlidesVisibility) t.children("." + a.slideVisibleClass).each(function(e, t) {
					var a = i ? $$1(t).attr("data-swiper-slide-index") : $$1(t).index();
				...
				if(o.loadPrevNext)
					if(1 < s || o.loadPrevNextAmount && 1 < o.loadPrevNextAmount) {
						for(var d = o.loadPrevNextAmount, u = s, h = Math.min(e + u + Math.max(d, u), r.length), f = Math.max(e - Math.max(u, d), 0), m = e + s; m < h; m += 1) l(m) && n.lazy.loadInSlide(m);
		...
		Controller = {
			...
			setTransition: function(t, e) {
				...
				function i(e) {
					e.setTransition(t, n), 0 !== t && (e.transitionStart(), e.params.autoHeight && Utils.nextTick(function() {
						e.updateAutoHeight()
		...
		A11y = {
			...
			create: function() {
				...
				Utils.extend(t, {
					a11y: {
						liveRegion: $$1('<span class="' + t.params.a11y.notificationClass + '" aria-live="assertive" aria-atomic="true"></span>')
					}
		...
		Cube = {
			setTranslate: function() {
				var e, t = this,
					...
					u = 0;
				p.shadow && (c ? (0 === (e = n.find(".swiper-cube-shadow")).length && (e = $$1('<div class="swiper-cube-shadow"></div>'), n.append(e)), e.css({
					height: i + "px"
				})) : 0 === (e = a.find(".swiper-cube-shadow")).length && (e = $$1('<div class="swiper-cube-shadow"></div>'), a.append(e)));
				for(var h = 0; h < r.length; h += 1) {
					...
					var b = Math.max(Math.min(f[0].progress, 1), -1),
						...
						w = 0,
						$ = 0;
					m % 4 == 0 ? (y = 4 * -g * l, $ = 0) : (m - 1) % 4 == 0 ? (y = 0, $ = 4 * -g * l) : (m - 2) % 4 == 0 ? (y = l + 4 * g * l, $ = l) : (m - 3) % 4 == 0 && (y = -l, $ = 3 * l + 4 * l * g), s && (y = -y), c || (w = y, y = 0);
					var C = "rotateX(" + (c ? 0 : -v) + "deg) rotateY(" + (c ? v : 0) + "deg) translate3d(" + y + "px, " + w + "px, " + $ + "px)";
					if(b <= 1 && -1 < b && (u = 90 * m + 90 * b, s && (u = 90 * -m - 90 * b)), f.transform(C), p.slideShadows) {
						...
						0 === x.length && (x = $$1('<div class="swiper-slide-shadow-' + (c ? "left" : "top") + '"></div>'), f.append(x)), 0 === E.length && (E = $$1('<div class="swiper-slide-shadow-' + (c ? "right" : "bottom") + '"></div>'), f.append(E)), x.length && (x[0].style.opacity = Math.max(-b, 0)), E.length && (E[0].style.opacity = Math.max(b, 0))
					}
				}
				if(n.css({
					...
					if(c) e.transform("translate3d(0px, " + (i / 2 + p.shadowOffset) + "px, " + -i / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + p.shadowScale + ")");
						...
						var k = Math.abs(u) - 90 * Math.floor(Math.abs(u) / 90),
							...
							M = p.shadowScale / T,
							P = p.shadowOffset;
						e.transform("scale3d(" + S + ", 1, " + M + ") translate3d(0px, " + (o / 2 + P) + "px, " + -o / 2 / M + "px) rotateX(-90deg)")
					}
			...
			setTranslate: function() {
				for(var e = this.slides, t = this.rtlTranslate, a = 0; a < e.length; a += 1) {
					...
					if(this.isHorizontal() ? t && (i = -i) : (l = s, o = -i, i = s = 0), n[0].style.zIndex = -Math.abs(Math.round(r)) + e.length, this.params.flipEffect.slideShadows) {
						...
						0 === p.length && (p = $$1('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "left" : "top") + '"></div>'), n.append(p)), 0 === c.length && (c = $$1('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "right" : "bottom") + '"></div>'), n.append(c)), p.length && (p[0].style.opacity = Math.max(-r, 0)), c.length && (c[0].style.opacity = Math.max(r, 0))
					}
		...
		Coverflow = {
			setTranslate: function() {
				for(var e = this.width, t = this.height, a = this.slides, n = this.$wrapperEl, r = this.slidesSizesGrid, i = this.params.coverflowEffect, o = this.isHorizontal(), s = this.translate, l = o ? e / 2 - s : t / 2 - s, p = o ? i.rotate : -i.rotate, c = i.depth, d = 0, u = a.length; d < u; d += 1) {
					...
					var $ = "translate3d(" + w + "px," + y + "px," + b + "px)  rotateX(" + g + "deg) rotateY(" + v + "deg)";
					if(h.transform($), h[0].style.zIndex = 1 - Math.abs(Math.round(m)), i.slideShadows) {
						...
						0 === C.length && (C = $$1('<div class="swiper-slide-shadow-' + (o ? "left" : "top") + '"></div>'), h.append(C)), 0 === x.length && (x = $$1('<div class="swiper-slide-shadow-' + (o ? "right" : "bottom") + '"></div>'), h.append(x)), C.length && (C[0].style.opacity = 0 < m ? m : 0), x.length && (x[0].style.opacity = 0 < -m ? -m : 0)
					}
	...
	function initSwiper(e) {
		...
		if(0 !== r.length && !r[0].swiper) {
			var t, a, i, o = {};
			r.hasClass("tabs-swipeable-wrap") && (r.addClass("swiper-container").children(".tabs").addClass("swiper-wrapper").children(".tab").addClass("swiper-slide"), t = r.children(".tabs").children(".tab-active").index(), a = !0, i = 0 < r.find(".tabs-routable").length), r.attr("data-swiper") ? o = JSON.parse(r.attr("data-swiper")) : (o = r.dataset(), Object.keys(o).forEach(function(e) {
				var t = o[e];
				if("string" == typeof t && 0 === t.indexOf("{") && 0 < t.indexOf("}")) try {
					o[e] = JSON.parse(t)
				} catch(e) {}
	...
	Swiper.use([Device$1, Browser$1, Support$1, Resize, Observer$1, Virtual$1, Navigation$1, Pagination$1, Scrollbar$1, Parallax$1, Zoom$1, Lazy$3, Controller$1, A11y, Autoplay$1, EffectFade, EffectCube, EffectFlip, EffectCoverflow]), window.Swiper || (window.Swiper = Swiper);
	var Swiper$1 = {
			name: "swiper",
			static: {
				Swiper: Swiper
			...
			on: {
				...
				tabMounted: function(e) {
					var a = this;
					$$1(e).find(".swiper-init, .tabs-swipeable-wrap").each(function(e, t) {
						initSwiper.call(a, t)
					})
				},
				tabShow: function(e) {
		...
		PhotoBrowser = function(n) {
			function e(e, t) {
				...
				this.useModulesParams(a), this.params = Utils.extend(a, t), Utils.extend(this, {
					exposed: !1,
					opened: !1,
			...
			return n && (e.__proto__ = n), ((e.prototype = Object.create(n && n.prototype)).constructor = e).prototype.onSlideChange = function(e) {
				...
				if("page" === t.params.type && t.params.navbar && 0 === o.length && "ios" === t.app.theme) {
					...
					l && (o = $$1(l).find(".photo-browser-current"), s = $$1(l).find(".photo-browser-total"))
				}
				...
				var i = Utils.extend({}, a.params.swiper, {
					...
					on: {
						...
						lazyImageReady: function() {
							for(var e = [], t = arguments.length; t--;) e[t] = arguments[t];
							$$1(e[0]).removeClass("photo-browser-slide-lazy"), a.emit.apply(a, ["local::lazyImageReady"].concat(e))
						}
					}
				});
				...
				return a.view.router.navigate({
					...
					route: {
						...
						on: {
							pageBeforeIn: function(e, t) {
								a.view.$el.addClass("with-photo-browser-page with-photo-browser-page-" + a.params.theme), a.onOpen("page", t.el)
							},
							pageAfterIn: function(e, t) {
								a.onOpened("page", t.el)
							},
							pageBeforeOut: function(e, t) {
								a.view.$el.removeClass("with-photo-browser-page with-photo-browser-page-exposed with-photo-browser-page-" + a.params.theme), a.onClose("page", t.el)
							},
							pageAfterOut: function(e, t) {
								a.onClosed("page", t.el)
							}
		...
		Notification = function(S) {
			function e(n, e) {
				...
				Utils.extend(r, {
					...
					el: a[0],
					type: "notification"
				}), a[0].f7Modal = r, g && a.find(".notification-close-button").on("click", function() {
					r.close()
				}), a.on("click", function(e) {
					g && $$1(e.target).closest(".notification-close-button").length || (r.emit("local::click notificationClick", r), w && r.close())
				}), r.on("beforeDestroy", function() {
					a.off("click")
				});
				var C, x = {};
				...
				function E(e) {
					i || (o = !(i = !0), s = void 0, p = Utils.now(), x.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, x.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY)
				}
				...
				function k(e) {
					if(i) {
						var t = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX,
							a = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY;
						if(void 0 === s && (s = !!(s || Math.abs(a - x.y) < Math.abs(t - x.x))), s) i = !1;
						else {
				...
				return r.on("open", function() {
					r.params.swipeToClose && (r.$el.on(n.touchEvents.start, E, {
						passive: !0
					}), n.on("touchmove:active", k), n.on("touchend:passive", T)), $$1(".notification.modal-in").each(function(e, t) {
						var a = n.notification.get(t);
						t !== r.el && a && a.close()
					}), b && function e() {
						C = Utils.nextTick(function() {
							i && o ? e() : r.close()
						}, b)
					}()
				}), r.on("close beforeDestroy", function() {
					r.params.swipeToClose && (r.$el.off(n.touchEvents.start, E, {
						passive: !0
					}), n.off("touchmove:active", k), n.off("touchend:passive", T)), win.clearTimeout(C)
				}), r
			}
			return S && (e.__proto__ = S), ((e.prototype = Object.create(S && S.prototype)).constructor = e).prototype.render = function() {
		...
		Autocomplete = function(w) {
			function e(e, t) {
				...
				d.useModulesParams(r), d.params = Utils.extend(r, t), d.params.openerEl && (a = $$1(d.params.openerEl)).length && (a[0].f7Autocomplete = d), d.params.inputEl && (u = $$1(d.params.inputEl)).length && (u[0].f7Autocomplete = d), d.params.view ? n = d.params.view : (a || u) && (n = e.views.get(a || u)), n || (n = e.views.main);
				var i = Utils.now(),
					o = t.url;
				...
				function l() {
					...
					d.params.source && d.params.source.call(d, c, function(e) {
						...
						for(var o = 0; o < i; o += 1) {
							...
							0 === o && (a = s, n = d.items[o]), r += d.renderItem({
								value: s,
						...
						if("" === r && "" === c && d.params.dropdownPlaceholderText && (r += d.renderItem({
							...
							})), d.$dropdownEl.find("ul").html(r), d.params.typeahead) {
							if(!a || !n) return;
				...
				function p() {
					var e, t, a, n = this.value;
					if(0 < $$1(this).parents(".autocomplete-values").length) {
				...
				function b(e) {
					d.opened && 13 === e.keyCode && (e.preventDefault(), d.$inputEl.blur())
				}

				function y() {
					for(var e, t = $$1(this), a = 0; a < d.items.length; a += 1) {
				...
				return d.attachEvents = function() {
					"dropdown" !== d.params.openIn && d.$openerEl && d.$openerEl.on("click", f), "dropdown" === d.params.openIn && d.$inputEl && (d.$inputEl.on("focus", m), d.$inputEl.on(d.params.inputEvents, l), e.device.android ? $$1("html").on("click", c) : d.$inputEl.on("blur", v), d.params.typeahead && d.$inputEl.on("keydown", b))
				}, d.detachEvents = function() {
					"dropdown" !== d.params.openIn && d.$openerEl && d.$openerEl.off("click", f), "dropdown" === d.params.openIn && d.$inputEl && (d.$inputEl.off("focus", m), d.$inputEl.off(d.params.inputEvents, l), e.device.android ? $$1("html").off("click", c) : d.$inputEl.off("blur", v), d.params.typeahead && d.$inputEl.off("keydown", b))
				}, d.attachDropdownEvents = function() {
					d.$dropdownEl.on("click", "label", y), e.on("resize", g)
				}, d.detachDropdownEvents = function() {
					d.$dropdownEl.off("click", "label", y), e.off("resize", g)
				}, d.attachPageEvents = function() {
					d.$el.on("change", 'input[type="radio"], input[type="checkbox"]', p), d.params.closeOnSelect && !d.params.multiple && d.$el.once("click", ".list label", function() {
						Utils.nextTick(function() {
							d.close()
						})
					})
			...
			return w && (e.__proto__ = w), ((e.prototype = Object.create(w && w.prototype)).constructor = e).prototype.positionDropdown = function() {
				...
				if(0 !== r.length) {
					...
					p.length && !this.params.expandInput && (c = (a.rtl ? p[0].offsetWidth - f - s : f) - ("md" === a.theme ? 16 : 15)), n.css({
						...
						maxHeight: v + "px"
					})[g] = 0 < p.length && !this.params.expandInput ? c + "px" : "", e))
				}
				...
				"dropdown" === this.params.openIn && this.$dropdownEl ? this.$dropdownEl.find(".autocomplete-preloader").removeClass("autocomplete-preloader-visible") : $$1(".autocomplete-preloader").removeClass("autocomplete-preloader-visible")
			}, e.prototype.preloaderShow = function() {
				"dropdown" === this.params.openIn && this.$dropdownEl ? this.$dropdownEl.find(".autocomplete-preloader").addClass("autocomplete-preloader-visible") : $$1(".autocomplete-preloader").addClass("autocomplete-preloader-visible")
				...
				if(a.$el = r, a.el = r[0], a.openedIn = e, a.opened = !0, "dropdown" === a.params.openIn) a.attachDropdownEvents(), a.$dropdownEl.addClass("autocomplete-dropdown-in"), a.$inputEl.trigger("input");
					...
					var i = r.find(".searchbar");
					"page" === a.params.openIn && "ios" === n.theme && 0 === i.length && (i = $$1(n.navbar.getElByPage(r)).find(".searchbar")), a.searchbar = n.searchbar.create({
						el: i,
						backdropEl: r.find(".searchbar-backdrop"),
						customSearch: !0,
						on: {
				...
				}) : t.modal = t.app.popup.create(e).open(t.params.animate), t
			}, e.prototype.openDropdown = function() {
				var e = this;
				e.$dropdownEl || (e.$dropdownEl = $$1(e.renderDropdown())), e.$inputEl.parents(".list").length && 0 < e.$inputEl.parents(".item-content").length && e.params.expandInput && e.$inputEl.parents(".item-content").addClass("item-content-dropdown-expanded");
				var t = e.$inputEl.parents(".page-content");
				e.params.dropdownContainerEl ? $$1(e.params.dropdownContainerEl).append(e.$dropdownEl) : 0 === t.length ? e.$dropdownEl.insertAfter(e.$inputEl) : (e.positionDropdown(), t.append(e.$dropdownEl)), e.onOpen("dropdown", e.$dropdownEl), e.onOpened("dropdown", e.$dropdownEl)
			}, e.prototype.open = function() {
		...
		Tooltip = function(m) {
			function e(t, e) {
				...
				function p(e) {
					s || (s = !0, l.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, l.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, n.show(this))
				}
			...
			return m && (e.__proto__ = m), ((e.prototype = Object.create(m && m.prototype)).constructor = e).prototype.position = function(e) {
				...
				var h = [0, 0, 0],
					...
					m = h[1],
					v = "top";
				c < o ? m = o - c : c < a.height - o - r ? (v = "bottom", m = o + r) : (v = "middle", (m = r / 2 + o - c / 2) <= 0 ? m = 8 : m + c >= a.height && (m = a.height - c - 8)), "top" === v || "bottom" === v ? ((f = n / 2 + i - p / 2) < 8 && (f = 8), f + p > a.width && (f = a.width - p - 8), f < 0 && (f = 0)) : "middle" === v && ((f = i - p) < 8 || f + p > a.width) && (f < 8 && (f = i + n), f + p > a.width && (f = a.width - p - 8)), t.css({
					top: m + "px",
					left: f + "px"
				})
				...
				return void 0 === e || (this.params.text = e, this.text = e, this.$el && this.$el.children(".tooltip-content").html(e), this.opened && this.position()), this
			}, e.prototype.init = function() {
				this.attachEvents()
			}, e.prototype.destroy = function() {
				var e = this;
		...
		Tooltip$1 = {
			...
			on: {
				tabMounted: function(e) {
					var n = this;
					$$1(e).find(".tooltip-init").each(function(e, t) {
						var a = $$1(t).attr("data-tooltip");
						a && n.tooltip.create({
							targetEl: t,
							text: a
						})
		...
		Gauge = function(o) {
			function e(e, t) {
				...
				return 0 === i.length ? a : i[0].f7Gauge ? i[0].f7Gauge : (Utils.extend(a, {
					...
					$el: i,
					el: i && i[0]
				}), (i[0].f7Gauge = a).useModules(), a.init(), a)
			}
			return o && (e.__proto__ = o), ((e.prototype = Object.create(o && o.prototype)).constructor = e).prototype.calcRadius = function() {
				var e = this.params;
				...
				if(Object.keys($).forEach(function(e) {
						n.attr(e, $[e])
					}), w) {
					var C = {
					...
					Object.keys(C).forEach(function(e) {
						n.find(".gauge-back-semi").attr(e, C[e])
					}), Object.keys(x).forEach(function(e) {
						n.find(".gauge-front-semi").attr(e, x[e])
					})
				} else {
					var E = {
							stroke: o,
				...
				if(p) {
					...
					Object.keys(T).forEach(function(e) {
						n.find(".gauge-value-text").attr(e, T[e])
		...
		Gauge$1 = {
			...
			on: {
				tabMounted: function(e) {
					var a = this;
					$$1(e).find(".gauge-init").each(function(e, t) {
		...
		ViAd = function(p) {
			function e(r, e) {
				...
				function l() {
					i.$overlayEl && (i.$overlayEl.off("click touchstart"), i.$overlayEl.remove())
				}
				i.ad = new win.vi.Ad(n), Utils.extend(i.ad, {
					onAdReady: function() {
						r.on("resize", s), i.emit("local::ready"), i.params.autoplay && i.start()
					},
					...
					onAdStopped: function(e) {
						r.off("resize", s), l(), i.emit("local::stopped", e), "complete" === e && (i.emit("local::complete"), i.emit("local::completed")), "userexit" === e && i.emit("local::userexit"), i.destroyed = !0
					},
					onAutoPlayFailed: function(e, t) {
						var a, n;
						i.emit("local::autoplayFailed", e, t), e && e.name && -1 !== e.name.indexOf("NotAllowedError") && i.params.fallbackOverlay && (a = t) && (i.$overlayEl = $$1(('\n        <div class="vi-overlay no-fastclick">\n          ' + (i.params.fallbackOverlayText ? '<div class="vi-overlay-text">' + i.params.fallbackOverlayText + "</div>" : "") + '\n          <div class="vi-overlay-play-button"></div>\n        </div>\n      ').trim()), i.$overlayEl.on("touchstart", function() {
							n = Utils.now()
					...
					onAdError: function(e) {
						l(), r.off("resize", s), i.emit("local::error", e), i.destroyed = !0
					}
				}), i.init(), Utils.extend(i, {
					app: r
				})
			}
			return p && (e.__proto__ = p), ((e.prototype = Object.create(p && p.prototype)).constructor = e).prototype.start = function() {
				...
				t.vi = {
					...
					loadSdk: function() {
						if(!t.vi.sdkReady) {
							...
							e.onload = function() {
								t.emit("viSdkReady"), t.vi.sdkReady = !0
							}, e.src = "https://c.vi-serve.com/viadshtml/vi.min.js", $$1("head").append(e)
						}
					}
				}
			},
